...
_PUBLIC_ enum ndr_err_code ndr_push_dns_operation(struct ndr_push *ndr, ndr_flags_type ndr_flags, uint16_t r)
{
	NDR_CHECK(ndr_push_uint16(ndr, NDR_SCALARS, r));
	return NDR_ERR_SUCCESS;
}

_PUBLIC_ enum ndr_err_code ndr_pull_dns_operation(struct ndr_pull *ndr, ndr_flags_type ndr_flags, uint16_t *r)
{
	uint16_t v;
...
_PUBLIC_ enum ndr_err_code ndr_push_dns_opcode(struct ndr_push *ndr, ndr_flags_type ndr_flags, enum dns_opcode r)
{
	NDR_CHECK(ndr_push_enum_uint1632(ndr, NDR_SCALARS, r));
	return NDR_ERR_SUCCESS;
}

_PUBLIC_ enum ndr_err_code ndr_pull_dns_opcode(struct ndr_pull *ndr, ndr_flags_type ndr_flags, enum dns_opcode *r)
{
	uint16_t v;
...
_PUBLIC_ enum ndr_err_code ndr_push_dns_rcode(struct ndr_push *ndr, ndr_flags_type ndr_flags, enum dns_rcode r)
{
	NDR_CHECK(ndr_push_enum_uint1632(ndr, NDR_SCALARS, r));
	return NDR_ERR_SUCCESS;
}

_PUBLIC_ enum ndr_err_code ndr_pull_dns_rcode(struct ndr_pull *ndr, ndr_flags_type ndr_flags, enum dns_rcode *r)
{
	uint16_t v;
	NDR_CHECK(ndr_pull_enum_uint1632(ndr, NDR_SCALARS, &v));
	*r = v;
...
_PUBLIC_ enum ndr_err_code ndr_push_dns_qclass(struct ndr_push *ndr, ndr_flags_type ndr_flags, enum dns_qclass r)
{
	NDR_CHECK(ndr_push_enum_uint16(ndr, NDR_SCALARS, r));
	return NDR_ERR_SUCCESS;
}

_PUBLIC_ enum ndr_err_code ndr_pull_dns_qclass(struct ndr_pull *ndr, ndr_flags_type ndr_flags, enum dns_qclass *r)
{
	uint16_t v;
...
_PUBLIC_ enum ndr_err_code ndr_push_dns_qtype(struct ndr_push *ndr, ndr_flags_type ndr_flags, enum dns_qtype r)
{
	NDR_CHECK(ndr_push_enum_uint16(ndr, NDR_SCALARS, r));
	return NDR_ERR_SUCCESS;
}

_PUBLIC_ enum ndr_err_code ndr_pull_dns_qtype(struct ndr_pull *ndr, ndr_flags_type ndr_flags, enum dns_qtype *r)
{
	uint16_t v;
	NDR_CHECK(ndr_pull_enum_uint16(ndr, NDR_SCALARS, &v));
	*r = v;
...
_PUBLIC_ void ndr_print_dns_qtype(struct ndr_print *ndr, const char *name, enum dns_qtype r)
{
	...
	switch (r) {
		...
		case DNS_QTYPE_CERT: val = "DNS_QTYPE_CERT"; break;
		...
		case DNS_QTYPE_SSHFP: val = "DNS_QTYPE_SSHFP"; break;
		case DNS_QTYPE_IPSECKEY: val = "DNS_QTYPE_IPSECKEY"; break;
		...
		case DNS_QTYPE_NSEC3: val = "DNS_QTYPE_NSEC3"; break;
		case DNS_QTYPE_NSEC3PARAM: val = "DNS_QTYPE_NSEC3PARAM"; break;
		case DNS_QTYPE_TLSA: val = "DNS_QTYPE_TLSA"; break;
		case DNS_QTYPE_CDS: val = "DNS_QTYPE_CDS"; break;
		case DNS_QTYPE_CDNSKEY: val = "DNS_QTYPE_CDNSKEY"; break;
		case DNS_QTYPE_SVCB: val = "DNS_QTYPE_SVCB"; break;
		case DNS_QTYPE_HTTPS: val = "DNS_QTYPE_HTTPS"; break;
		case DNS_QTYPE_TKEY: val = "DNS_QTYPE_TKEY"; break;
		case DNS_QTYPE_TSIG: val = "DNS_QTYPE_TSIG"; break;
		case DNS_QTYPE_IXFR: val = "DNS_QTYPE_IXFR"; break;
		...
		case DNS_QTYPE_URI: val = "DNS_QTYPE_URI"; break;
		case DNS_QTYPE_CAA: val = "DNS_QTYPE_CAA"; break;
	}
	ndr_print_enum(ndr, name, "ENUM", val, r);
}

_PUBLIC_ enum ndr_err_code ndr_push_dns_tkey_mode(struct ndr_push *ndr, ndr_flags_type ndr_flags, enum dns_tkey_mode r)
{
	NDR_CHECK(ndr_push_enum_uint16(ndr, NDR_SCALARS, r));
	return NDR_ERR_SUCCESS;
}

_PUBLIC_ enum ndr_err_code ndr_pull_dns_tkey_mode(struct ndr_pull *ndr, ndr_flags_type ndr_flags, enum dns_tkey_mode *r)
{
	uint16_t v;
	NDR_CHECK(ndr_pull_enum_uint16(ndr, NDR_SCALARS, &v));
	*r = v;
...
_PUBLIC_ enum ndr_err_code ndr_push_dns_name_question(struct ndr_push *ndr, ndr_flags_type ndr_flags, const struct dns_name_question *r)
{
...
_PUBLIC_ enum ndr_err_code ndr_pull_dns_name_question(struct ndr_pull *ndr, ndr_flags_type ndr_flags, struct dns_name_question *r)
{
...
static void ndr_print_flags_dns_name_question(struct ndr_print *ndr, const char *name, ndr_flags_type unused, const struct dns_name_question *r)
{
	ndr_print_dns_name_question(ndr, name, r);
}
...
_PUBLIC_ enum ndr_err_code ndr_push_dns_rdata_data(struct ndr_push *ndr, ndr_flags_type ndr_flags, const struct dns_rdata_data *r)
{
	NDR_PUSH_CHECK_FLAGS(ndr, ndr_flags);
	if (ndr_flags & NDR_SCALARS) {
...
_PUBLIC_ enum ndr_err_code ndr_pull_dns_rdata_data(struct ndr_pull *ndr, ndr_flags_type ndr_flags, struct dns_rdata_data *r)
{
...
static void ndr_print_flags_dns_rdata_data(struct ndr_print *ndr, const char *name, ndr_flags_type unused, const struct dns_rdata_data *r)
{
	ndr_print_dns_rdata_data(ndr, name, r);
}
...
static enum ndr_err_code ndr_push_dns_soa_record(struct ndr_push *ndr, ndr_flags_type ndr_flags, const struct dns_soa_record *r)
{
	NDR_PUSH_CHECK_FLAGS(ndr, ndr_flags);
	if (ndr_flags & NDR_SCALARS) {
		NDR_CHECK(ndr_push_align(ndr, 4));
...
static enum ndr_err_code ndr_pull_dns_soa_record(struct ndr_pull *ndr, ndr_flags_type ndr_flags, struct dns_soa_record *r)
{
	NDR_PULL_CHECK_FLAGS(ndr, ndr_flags);
	if (ndr_flags & NDR_SCALARS) {
		NDR_CHECK(ndr_pull_align(ndr, 4));
...
_PUBLIC_ enum ndr_err_code ndr_push_dns_mx_record(struct ndr_push *ndr, ndr_flags_type ndr_flags, const struct dns_mx_record *r)
{
	NDR_PUSH_CHECK_FLAGS(ndr, ndr_flags);
	if (ndr_flags & NDR_SCALARS) {
		NDR_CHECK(ndr_push_align(ndr, 4));
...
_PUBLIC_ enum ndr_err_code ndr_pull_dns_mx_record(struct ndr_pull *ndr, ndr_flags_type ndr_flags, struct dns_mx_record *r)
{
	NDR_PULL_CHECK_FLAGS(ndr, ndr_flags);
	if (ndr_flags & NDR_SCALARS) {
		NDR_CHECK(ndr_pull_align(ndr, 4));
...
static void ndr_print_flags_dns_mx_record(struct ndr_print *ndr, const char *name, ndr_flags_type unused, const struct dns_mx_record *r)
{
	ndr_print_dns_mx_record(ndr, name, r);
}
...
_PUBLIC_ enum ndr_err_code ndr_push_dns_txt_record(struct ndr_push *ndr, ndr_flags_type ndr_flags, const struct dns_txt_record *r)
{
	NDR_PUSH_CHECK_FLAGS(ndr, ndr_flags);
	if (ndr_flags & NDR_SCALARS) {
...
static void ndr_print_flags_dns_txt_record(struct ndr_print *ndr, const char *name, ndr_flags_type unused, const struct dns_txt_record *r)
{
	ndr_print_dns_txt_record(ndr, name, r);
}
...
_PUBLIC_ enum ndr_err_code ndr_push_dns_rp_record(struct ndr_push *ndr, ndr_flags_type ndr_flags, const struct dns_rp_record *r)
{
	NDR_PUSH_CHECK_FLAGS(ndr, ndr_flags);
	if (ndr_flags & NDR_SCALARS) {
		NDR_CHECK(ndr_push_align(ndr, 4));
		NDR_CHECK(ndr_push_dns_string(ndr, NDR_SCALARS, r->mbox));
		NDR_CHECK(ndr_push_dns_string(ndr, NDR_SCALARS, r->txt));
		NDR_CHECK(ndr_push_trailer_align(ndr, 4));
	}
	if (ndr_flags & NDR_BUFFERS) {
	}
...
_PUBLIC_ enum ndr_err_code ndr_pull_dns_rp_record(struct ndr_pull *ndr, ndr_flags_type ndr_flags, struct dns_rp_record *r)
{
	NDR_PULL_CHECK_FLAGS(ndr, ndr_flags);
	if (ndr_flags & NDR_SCALARS) {
		NDR_CHECK(ndr_pull_align(ndr, 4));
		NDR_CHECK(ndr_pull_dns_string(ndr, NDR_SCALARS, &r->mbox));
		NDR_CHECK(ndr_pull_dns_string(ndr, NDR_SCALARS, &r->txt));
		NDR_CHECK(ndr_pull_trailer_align(ndr, 4));
	}
	if (ndr_flags & NDR_BUFFERS) {
	}
...
static void ndr_print_flags_dns_rp_record(struct ndr_print *ndr, const char *name, ndr_flags_type unused, const struct dns_rp_record *r)
{
	ndr_print_dns_rp_record(ndr, name, r);
}

_PUBLIC_ void ndr_print_dns_rp_record(struct ndr_print *ndr, const char *name, const struct dns_rp_record *r)
{
	ndr_print_struct(ndr, name, "dns_rp_record");
	if (r == NULL) { ndr_print_null(ndr); return; }
	ndr->depth++;
	ndr_print_dns_string(ndr, "mbox", r->mbox);
	ndr_print_dns_string(ndr, "txt", r->txt);
	ndr->depth--;
}

_PUBLIC_ enum ndr_err_code ndr_push_dns_srv_record(struct ndr_push *ndr, ndr_flags_type ndr_flags, const struct dns_srv_record *r)
{
	NDR_PUSH_CHECK_FLAGS(ndr, ndr_flags);
	if (ndr_flags & NDR_SCALARS) {
		NDR_CHECK(ndr_push_align(ndr, 4));
...
_PUBLIC_ enum ndr_err_code ndr_pull_dns_srv_record(struct ndr_pull *ndr, ndr_flags_type ndr_flags, struct dns_srv_record *r)
{
	NDR_PULL_CHECK_FLAGS(ndr, ndr_flags);
	if (ndr_flags & NDR_SCALARS) {
		NDR_CHECK(ndr_pull_align(ndr, 4));
...
static void ndr_print_flags_dns_srv_record(struct ndr_print *ndr, const char *name, ndr_flags_type unused, const struct dns_srv_record *r)
{
	ndr_print_dns_srv_record(ndr, name, r);
}
...
_PUBLIC_ enum ndr_err_code ndr_push_dns_opt_record(struct ndr_push *ndr, ndr_flags_type ndr_flags, const struct dns_opt_record *r)
{
	NDR_PUSH_CHECK_FLAGS(ndr, ndr_flags);
	if (ndr_flags & NDR_SCALARS) {
		NDR_CHECK(ndr_push_align(ndr, 2));
...
_PUBLIC_ enum ndr_err_code ndr_pull_dns_opt_record(struct ndr_pull *ndr, ndr_flags_type ndr_flags, struct dns_opt_record *r)
{
...
static void ndr_print_flags_dns_opt_record(struct ndr_print *ndr, const char *name, ndr_flags_type unused, const struct dns_opt_record *r)
{
	ndr_print_dns_opt_record(ndr, name, r);
}
...
_PUBLIC_ enum ndr_err_code ndr_push_dns_tkey_record(struct ndr_push *ndr, ndr_flags_type ndr_flags, const struct dns_tkey_record *r)
{
	{
...
_PUBLIC_ enum ndr_err_code ndr_pull_dns_tkey_record(struct ndr_pull *ndr, ndr_flags_type ndr_flags, struct dns_tkey_record *r)
{
...
static void ndr_print_flags_dns_tkey_record(struct ndr_print *ndr, const char *name, ndr_flags_type unused, const struct dns_tkey_record *r)
{
	ndr_print_dns_tkey_record(ndr, name, r);
}
...
_PUBLIC_ enum ndr_err_code ndr_push_dns_tsig_record(struct ndr_push *ndr, ndr_flags_type ndr_flags, const struct dns_tsig_record *r)
{
	{
		libndr_flags _flags_save_STRUCT = ndr->flags;
		ndr_set_flags(&ndr->flags, LIBNDR_FLAG_NO_COMPRESSION);
...
_PUBLIC_ enum ndr_err_code ndr_pull_dns_tsig_record(struct ndr_pull *ndr, ndr_flags_type ndr_flags, struct dns_tsig_record *r)
{
...
static void ndr_print_flags_dns_tsig_record(struct ndr_print *ndr, const char *name, ndr_flags_type unused, const struct dns_tsig_record *r)
{
	ndr_print_dns_tsig_record(ndr, name, r);
}
...
_PUBLIC_ enum ndr_err_code ndr_push_dns_fake_tsig_rec(struct ndr_push *ndr, ndr_flags_type ndr_flags, const struct dns_fake_tsig_rec *r)
{
	{
		libndr_flags _flags_save_STRUCT = ndr->flags;
		ndr_set_flags(&ndr->flags, LIBNDR_FLAG_NO_COMPRESSION|LIBNDR_FLAG_NOALIGN|LIBNDR_FLAG_BIGENDIAN|LIBNDR_PRINT_ARRAY_HEX);
		NDR_PUSH_CHECK_FLAGS(ndr, ndr_flags);
		if (ndr_flags & NDR_SCALARS) {
			NDR_CHECK(ndr_push_align(ndr, 4));
			NDR_CHECK(ndr_push_dns_string(ndr, NDR_SCALARS, r->name));
...
_PUBLIC_ enum ndr_err_code ndr_pull_dns_fake_tsig_rec(struct ndr_pull *ndr, ndr_flags_type ndr_flags, struct dns_fake_tsig_rec *r)
{
	uint32_t size_other_data_0 = 0;
	{
		libndr_flags _flags_save_STRUCT = ndr->flags;
...
static void ndr_print_flags_dns_fake_tsig_rec(struct ndr_print *ndr, const char *name, ndr_flags_type unused, const struct dns_fake_tsig_rec *r)
{
	ndr_print_dns_fake_tsig_rec(ndr, name, r);
}
...
_PUBLIC_ enum ndr_err_code ndr_push_dns_rdata(struct ndr_push *ndr, ndr_flags_type ndr_flags, const union dns_rdata *r)
{
	uint32_t level;
	{
		...
		if (ndr_flags & NDR_SCALARS) {
			...
			switch (level) {
				...
				case DNS_QTYPE_HINFO: {
					NDR_CHECK(ndr_push_dnsp_hinfo(ndr, NDR_SCALARS, &r->hinfo_record));
				break; }
				...
				case DNS_QTYPE_RP: {
					NDR_CHECK(ndr_push_dns_rp_record(ndr, NDR_SCALARS, &r->rp_record));
				break; }
...
_PUBLIC_ enum ndr_err_code ndr_pull_dns_rdata(struct ndr_pull *ndr, ndr_flags_type ndr_flags, union dns_rdata *r)
{
	uint32_t level;
	{
		libndr_flags _flags_save_UNION = ndr->flags;
		...
		if (ndr_flags & NDR_SCALARS) {
			...
			switch (level) {
				...
				case DNS_QTYPE_HINFO: {
					NDR_CHECK(ndr_pull_dnsp_hinfo(ndr, NDR_SCALARS, &r->hinfo_record));
				break; }
				...
				case DNS_QTYPE_RP: {
					NDR_CHECK(ndr_pull_dns_rp_record(ndr, NDR_SCALARS, &r->rp_record));
				break; }
...
_PUBLIC_ void ndr_print_dns_rdata(struct ndr_print *ndr, const char *name, const union dns_rdata *r)
{
	uint32_t level;
	{
		...
		switch (level) {
			...
			case DNS_QTYPE_HINFO:
				ndr_print_dnsp_hinfo(ndr, "hinfo_record", &r->hinfo_record);
			break;
			...
			case DNS_QTYPE_RP:
				ndr_print_dns_rp_record(ndr, "rp_record", &r->rp_record);
			break;
...
_PUBLIC_ void ndr_print_dns_res_rec(struct ndr_print *ndr, const char *name, const struct dns_res_rec *r)
{
	...
	if (r == NULL) { ndr_print_null(ndr); return; }
	{
		...
		ndr->depth++;
		ndr_print_uint32(ndr, "start_ndr_offset", r->start_ndr_offset);
		ndr_print_dns_string(ndr, "name", r->name);
...
_PUBLIC_ enum ndr_err_code ndr_push_dns_name_packet(struct ndr_push *ndr, ndr_flags_type ndr_flags, const struct dns_name_packet *r)
{
...
_PUBLIC_ enum ndr_err_code ndr_pull_dns_name_packet(struct ndr_pull *ndr, ndr_flags_type ndr_flags, struct dns_name_packet *r)
{
...
static void ndr_print_flags_dns_name_packet(struct ndr_print *ndr, const char *name, ndr_flags_type unused, const struct dns_name_packet *r)
{
	ndr_print_dns_name_packet(ndr, name, r);
}
...
static enum ndr_err_code ndr_push_decode_dns_name_packet(struct ndr_push *ndr, ndr_flags_type flags, const struct decode_dns_name_packet *r)
{
...
static enum ndr_err_code ndr_pull_decode_dns_name_packet(struct ndr_pull *ndr, ndr_flags_type flags, struct decode_dns_name_packet *r)
{
...
_PUBLIC_ void ndr_print_decode_dns_name_packet(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct decode_dns_name_packet *r)
{
...
#ifndef SKIP_NDR_TABLE_dns
static const struct ndr_interface_public_struct dns_public_structs[] = {
	{
		.name = "dns_name_question",
		.struct_size = sizeof(struct dns_name_question ),
		.ndr_push = (ndr_push_flags_fn_t) ndr_push_dns_name_question,
		.ndr_pull = (ndr_pull_flags_fn_t) ndr_pull_dns_name_question,
		.ndr_print = (ndr_print_function_t) ndr_print_flags_dns_name_question,
	},
	{
		.name = "dns_rdata_data",
		.struct_size = sizeof(struct dns_rdata_data ),
		.ndr_push = (ndr_push_flags_fn_t) ndr_push_dns_rdata_data,
		.ndr_pull = (ndr_pull_flags_fn_t) ndr_pull_dns_rdata_data,
		.ndr_print = (ndr_print_function_t) ndr_print_flags_dns_rdata_data,
	},
	{
		.name = "dns_mx_record",
		.struct_size = sizeof(struct dns_mx_record ),
		.ndr_push = (ndr_push_flags_fn_t) ndr_push_dns_mx_record,
		.ndr_pull = (ndr_pull_flags_fn_t) ndr_pull_dns_mx_record,
		.ndr_print = (ndr_print_function_t) ndr_print_flags_dns_mx_record,
	},
	{
		.name = "dns_txt_record",
		.struct_size = sizeof(struct dns_txt_record ),
		.ndr_push = (ndr_push_flags_fn_t) ndr_push_dns_txt_record,
		.ndr_pull = (ndr_pull_flags_fn_t) ndr_pull_dns_txt_record,
		.ndr_print = (ndr_print_function_t) ndr_print_flags_dns_txt_record,
	},
	{
		.name = "dns_rp_record",
		.struct_size = sizeof(struct dns_rp_record ),
		.ndr_push = (ndr_push_flags_fn_t) ndr_push_dns_rp_record,
		.ndr_pull = (ndr_pull_flags_fn_t) ndr_pull_dns_rp_record,
		.ndr_print = (ndr_print_function_t) ndr_print_flags_dns_rp_record,
	},
	{
		.name = "dns_srv_record",
		.struct_size = sizeof(struct dns_srv_record ),
		.ndr_push = (ndr_push_flags_fn_t) ndr_push_dns_srv_record,
		.ndr_pull = (ndr_pull_flags_fn_t) ndr_pull_dns_srv_record,
		.ndr_print = (ndr_print_function_t) ndr_print_flags_dns_srv_record,
	},
	{
		.name = "dns_opt_record",
		.struct_size = sizeof(struct dns_opt_record ),
		.ndr_push = (ndr_push_flags_fn_t) ndr_push_dns_opt_record,
		.ndr_pull = (ndr_pull_flags_fn_t) ndr_pull_dns_opt_record,
		.ndr_print = (ndr_print_function_t) ndr_print_flags_dns_opt_record,
	},
	{
		.name = "dns_tkey_record",
		.struct_size = sizeof(struct dns_tkey_record ),
		.ndr_push = (ndr_push_flags_fn_t) ndr_push_dns_tkey_record,
		.ndr_pull = (ndr_pull_flags_fn_t) ndr_pull_dns_tkey_record,
		.ndr_print = (ndr_print_function_t) ndr_print_flags_dns_tkey_record,
	},
	{
		.name = "dns_tsig_record",
		.struct_size = sizeof(struct dns_tsig_record ),
		.ndr_push = (ndr_push_flags_fn_t) ndr_push_dns_tsig_record,
		.ndr_pull = (ndr_pull_flags_fn_t) ndr_pull_dns_tsig_record,
		.ndr_print = (ndr_print_function_t) ndr_print_flags_dns_tsig_record,
	},
	{
		.name = "dns_fake_tsig_rec",
		.struct_size = sizeof(struct dns_fake_tsig_rec ),
		.ndr_push = (ndr_push_flags_fn_t) ndr_push_dns_fake_tsig_rec,
		.ndr_pull = (ndr_pull_flags_fn_t) ndr_pull_dns_fake_tsig_rec,
		.ndr_print = (ndr_print_function_t) ndr_print_flags_dns_fake_tsig_rec,
	},
	{
		.name = "dns_name_packet",
		.struct_size = sizeof(struct dns_name_packet ),
		.ndr_push = (ndr_push_flags_fn_t) ndr_push_dns_name_packet,
		.ndr_pull = (ndr_pull_flags_fn_t) ndr_pull_dns_name_packet,
		.ndr_print = (ndr_print_function_t) ndr_print_flags_dns_name_packet,
	},
	{ .name = NULL }
};
...
const struct ndr_interface_table ndr_table_dns = {
	...
	.num_calls	= 1,
	.calls		= dns_calls,
	.num_public_structs	= 11,
	.public_structs		= dns_public_structs,
	.endpoints	= &dns_endpoints,
	.authservices	= &dns_authservices
};

#endif /* SKIP_NDR_TABLE_dns */
