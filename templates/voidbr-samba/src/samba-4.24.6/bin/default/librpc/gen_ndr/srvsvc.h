...
union srvsvc_NetSessCtr {
	...
	struct srvsvc_NetSessCtr1 *ctr1;/* [case,unique] */
	struct srvsvc_NetSessCtr2 *ctr2;/* [case(2),unique] */
	struct srvsvc_NetSessCtr10 *ctr10;/* [case(10),unique] */
	struct srvsvc_NetSessCtr502 *ctr502;/* [case(502),unique] */
};
...
enum srvsvc_ShareType
#ifndef USE_UINT_ENUMS
 {
	...
	STYPE_CLUSTER_FS=(int)(0x02000000),
	STYPE_CLUSTER_FS_TEMPORARY=(int)(STYPE_CLUSTER_FS|STYPE_TEMPORARY),
	STYPE_CLUSTER_FS_HIDDEN=(int)(STYPE_CLUSTER_FS|STYPE_HIDDEN),
	STYPE_CLUSTER_SOFS=(int)(0x04000000),
	STYPE_CLUSTER_SOFS_TEMPORARY=(int)(STYPE_CLUSTER_SOFS|STYPE_TEMPORARY),
	STYPE_CLUSTER_SOFS_HIDDEN=(int)(STYPE_CLUSTER_SOFS|STYPE_HIDDEN),
	STYPE_CLUSTER_DFS=(int)(0x08000000),
	STYPE_CLUSTER_DFS_TEMPORARY=(int)(STYPE_CLUSTER_DFS|STYPE_TEMPORARY),
	STYPE_CLUSTER_DFS_HIDDEN=(int)(STYPE_CLUSTER_DFS|STYPE_HIDDEN)
}
#else
 { __do_not_use_enum_srvsvc_ShareType=INT_MAX}
...
#define SHARE_1005_CSC_CACHE_AUTO_REINT ( 0x00000010 )
#define SHARE_1005_CSC_CACHE_VDO ( 0x00000020 )
#define SHARE_1005_CSC_CACHE_NONE ( 0x00000030 )
#define SHARE_1005_RESTRICT_EXCLUSIVE_OPENS ( 0x00000100 )
#define SHARE_1005_FORCE_SHARED_DELETE ( 0x00000200 )
#define SHARE_1005_ALLOW_NAMESPACE_CACHING ( 0x00000400 )
#define SHARE_1005_ACCESS_BASED_DIRECTORY_ENUM ( 0x00000800 )
#define SHARE_1005_FORCE_LEVELII_OPLOCK ( 0x00001000 )
#define SHARE_1005_ENABLE_HASH ( 0x00002000 )
#define SHARE_1005_ENABLE_CA ( 0x00004000 )
#define SHARE_1005_ENCRYPT_DATA ( 0x00008000 )
...
union srvsvc_NetShareInfo {
	...
	struct srvsvc_NetShareInfo2 *info2;/* [case(2),unique] */
	...
	struct srvsvc_NetShareInfo1006 *info1006;/* [case(1006),unique] */
...
#else
 { __do_not_use_enum_srvsvc_PlatformId=INT_MAX}
...
struct srvsvc_NetSrvInfo102 {
	...
	uint32_t anndelta;
	uint32_t licenses;
	const char *userpath;/* [charset(UTF16),unique] */
};
...
union srvsvc_NetSrvInfo {
	...
	struct srvsvc_NetSrvInfo402 *info402;/* [case(402),unique] */
	...
	struct srvsvc_NetSrvInfo1522 *info1522;/* [case(1522),unique] */
	struct srvsvc_NetSrvInfo1523 *info1523;/* [case(1523),unique] */
	struct srvsvc_NetSrvInfo1524 *info1524;/* [case(1524),unique] */
	...
	struct srvsvc_NetSrvInfo1545 *info1545;/* [case(1545),unique] */
	...
	struct srvsvc_NetSrvInfo1556 *info1556;/* [case(1556),unique] */
};
...
struct srvsvc_NetTransportCtr2 {
	uint32_t count;
	struct srvsvc_NetTransportInfo2 *array;/* [size_is(count),unique] */
};
