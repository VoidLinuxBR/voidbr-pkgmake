...
static enum ndr_err_code ndr_push_trkwks_Unknown0(struct ndr_push *ndr, ndr_flags_type flags, const struct trkwks_Unknown0 *r)
{
...
static enum ndr_err_code ndr_pull_trkwks_Unknown0(struct ndr_pull *ndr, ndr_flags_type flags, struct trkwks_Unknown0 *r)
{
...
_PUBLIC_ void ndr_print_trkwks_Unknown0(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct trkwks_Unknown0 *r)
{
...
#ifndef SKIP_NDR_TABLE_trkwks
static const struct ndr_interface_public_struct trkwks_public_structs[] = {
	{ .name = NULL }
};
...
const struct ndr_interface_table ndr_table_trkwks = {
	...
	.public_structs		= trkwks_public_structs,
	.endpoints	= &trkwks_endpoints,
	.authservices	= &trkwks_authservices
};

#endif /* SKIP_NDR_TABLE_trkwks */
