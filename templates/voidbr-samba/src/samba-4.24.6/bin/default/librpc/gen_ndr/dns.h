...
#else
 { __do_not_use_enum_dns_opcode=INT_MAX}
...
#else
 { __do_not_use_enum_dns_rcode=INT_MAX}
...
#else
 { __do_not_use_enum_dns_qclass=INT_MAX}
...
enum dns_qtype
#ifndef USE_UINT_ENUMS
 {
	...
	DNS_QTYPE_CERT=(int)(0x0025),
	DNS_QTYPE_DNAME=(int)(0x0027),
	DNS_QTYPE_OPT=(int)(0x0029),
	DNS_QTYPE_DS=(int)(0x002B),
	DNS_QTYPE_SSHFP=(int)(0x002C),
	DNS_QTYPE_IPSECKEY=(int)(0x002D),
	DNS_QTYPE_RRSIG=(int)(0x002E),
	DNS_QTYPE_NSEC=(int)(0x002F),
	DNS_QTYPE_DNSKEY=(int)(0x0030),
	DNS_QTYPE_DHCID=(int)(0x0031),
	DNS_QTYPE_NSEC3=(int)(0x0032),
	DNS_QTYPE_NSEC3PARAM=(int)(0x0033),
	DNS_QTYPE_TLSA=(int)(0x0034),
	DNS_QTYPE_CDS=(int)(0x003B),
	DNS_QTYPE_CDNSKEY=(int)(0x003C),
	DNS_QTYPE_SVCB=(int)(0x0040),
	DNS_QTYPE_HTTPS=(int)(0x0041),
	DNS_QTYPE_TKEY=(int)(0x00F9),
	DNS_QTYPE_TSIG=(int)(0x00FA),
	DNS_QTYPE_IXFR=(int)(0x00FB),
	DNS_QTYPE_AXFR=(int)(0x00FC),
	DNS_QTYPE_MAILB=(int)(0x00FD),
	DNS_QTYPE_MAILA=(int)(0x00FE),
	DNS_QTYPE_ALL=(int)(0x00FF),
	DNS_QTYPE_URI=(int)(0x0100),
	DNS_QTYPE_CAA=(int)(0x0101)
}
#else
 { __do_not_use_enum_dns_qtype=INT_MAX}
...
#define DNS_QTYPE_CERT ( 0x0025 )
#define DNS_QTYPE_DNAME ( 0x0027 )
#define DNS_QTYPE_OPT ( 0x0029 )
#define DNS_QTYPE_DS ( 0x002B )
#define DNS_QTYPE_SSHFP ( 0x002C )
#define DNS_QTYPE_IPSECKEY ( 0x002D )
#define DNS_QTYPE_RRSIG ( 0x002E )
#define DNS_QTYPE_NSEC ( 0x002F )
#define DNS_QTYPE_DNSKEY ( 0x0030 )
#define DNS_QTYPE_DHCID ( 0x0031 )
#define DNS_QTYPE_NSEC3 ( 0x0032 )
#define DNS_QTYPE_NSEC3PARAM ( 0x0033 )
#define DNS_QTYPE_TLSA ( 0x0034 )
#define DNS_QTYPE_CDS ( 0x003B )
#define DNS_QTYPE_CDNSKEY ( 0x003C )
#define DNS_QTYPE_SVCB ( 0x0040 )
#define DNS_QTYPE_HTTPS ( 0x0041 )
#define DNS_QTYPE_TKEY ( 0x00F9 )
#define DNS_QTYPE_TSIG ( 0x00FA )
#define DNS_QTYPE_IXFR ( 0x00FB )
#define DNS_QTYPE_AXFR ( 0x00FC )
#define DNS_QTYPE_MAILB ( 0x00FD )
#define DNS_QTYPE_MAILA ( 0x00FE )
#define DNS_QTYPE_ALL ( 0x00FF )
#define DNS_QTYPE_URI ( 0x0100 )
#define DNS_QTYPE_CAA ( 0x0101 )
#endif
;
...
#else
 { __do_not_use_enum_dns_tkey_mode=INT_MAX}
...
struct dns_res_rec {
	uint32_t start_ndr_offset;/* [ignore] */
	const char * name;
