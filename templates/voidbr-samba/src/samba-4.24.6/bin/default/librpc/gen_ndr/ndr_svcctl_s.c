...
NTSTATUS dcerpc_server_svcctl_init(TALLOC_CTX *);
...
static NTSTATUS svcctl__op_dispatch(struct dcesrv_call_state *dce_call, TALLOC_CTX *mem_ctx, void *r)
{
	...
	case 41: {
		...
		r2->out.result = dcesrv_svcctl_EnumServicesStatusExA(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function svcctl_EnumServicesStatusExA will reply async\n"));
		}
		break;
	}
	case 42: {
		...
		r2->out.result = dcesrv_svcctl_EnumServicesStatusExW(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function svcctl_EnumServicesStatusExW will reply async\n"));
		}
		break;
	}
	case 43: {
	...
	case 44: {
		...
		r2->out.result = dcesrv_svcctl_CreateServiceWOW64A(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function svcctl_CreateServiceWOW64A will reply async\n"));
		}
		break;
	}
	case 45: {
		...
		r2->out.result = dcesrv_svcctl_CreateServiceWOW64W(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function svcctl_CreateServiceWOW64W will reply async\n"));
		}
		break;
	}
	case 46: {
		...
		dcesrv_Opnum46NotUsedOnWire(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function Opnum46NotUsedOnWire will reply async\n"));
		}
		break;
	}
	case 47: {
		...
		r2->out.result = dcesrv_svcctl_NotifyServiceStatusChange(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function svcctl_NotifyServiceStatusChange will reply async\n"));
		}
		break;
	}
	case 48: {
		...
		r2->out.result = dcesrv_svcctl_GetNotifyResults(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function svcctl_GetNotifyResults will reply async\n"));
		}
		break;
	}
	case 49: {
		...
		r2->out.result = dcesrv_svcctl_CloseNotifyHandle(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function svcctl_CloseNotifyHandle will reply async\n"));
		}
		break;
	}
	case 50: {
		...
		r2->out.result = dcesrv_svcctl_ControlServiceExA(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function svcctl_ControlServiceExA will reply async\n"));
		}
		break;
	}
	case 51: {
		...
		r2->out.result = dcesrv_svcctl_ControlServiceExW(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function svcctl_ControlServiceExW will reply async\n"));
		}
		break;
	}
	case 52: {
		...
		dcesrv_Opnum52NotUsedOnWire(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function Opnum52NotUsedOnWire will reply async\n"));
		}
		break;
	}
	case 53: {
		...
		dcesrv_Opnum53NotUsedOnWire(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function Opnum53NotUsedOnWire will reply async\n"));
		}
		break;
	}
	case 54: {
		...
		dcesrv_Opnum54NotUsedOnWire(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function Opnum54NotUsedOnWire will reply async\n"));
		}
		break;
	}
	case 55: {
		...
		dcesrv_Opnum55NotUsedOnWire(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function Opnum55NotUsedOnWire will reply async\n"));
		}
		break;
	}
	case 56: {
		...
		r2->out.result = dcesrv_svcctl_QueryServiceConfigEx(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function svcctl_QueryServiceConfigEx will reply async\n"));
		}
		break;
	}
	case 57: {
		...
		dcesrv_Opnum57NotUsedOnWire(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function Opnum57NotUsedOnWire will reply async\n"));
		}
		break;
	}
	case 58: {
		...
		dcesrv_Opnum58NotUsedOnWire(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function Opnum58NotUsedOnWire will reply async\n"));
		}
		break;
	}
	case 59: {
		...
		dcesrv_Opnum59NotUsedOnWire(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function Opnum59NotUsedOnWire will reply async\n"));
		}
		break;
	}
	case 60: {
		...
		r2->out.result = dcesrv_svcctl_CreateWowService(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function svcctl_CreateWowService will reply async\n"));
		}
		break;
	}
	case 61: {
		...
		r2->out.result = dcesrv_svcctl_OpenSCManager2(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function svcctl_OpenSCManager2 will reply async\n"));
		}
		break;
	}
...
static NTSTATUS svcctl__op_reply(struct dcesrv_call_state *dce_call, TALLOC_CTX *mem_ctx, void *r)
{
	...
	case 41: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in svcctl_EnumServicesStatusExA\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 42: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in svcctl_EnumServicesStatusExW\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 43: {
	...
	case 44: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in svcctl_CreateServiceWOW64A\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 45: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in svcctl_CreateServiceWOW64W\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 46: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in Opnum46NotUsedOnWire\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 47: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in svcctl_NotifyServiceStatusChange\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 48: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in svcctl_GetNotifyResults\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 49: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in svcctl_CloseNotifyHandle\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 50: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in svcctl_ControlServiceExA\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 51: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in svcctl_ControlServiceExW\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 52: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in Opnum52NotUsedOnWire\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 53: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in Opnum53NotUsedOnWire\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 54: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in Opnum54NotUsedOnWire\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 55: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in Opnum55NotUsedOnWire\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 56: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in svcctl_QueryServiceConfigEx\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 57: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in Opnum57NotUsedOnWire\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 58: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in Opnum58NotUsedOnWire\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 59: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in Opnum59NotUsedOnWire\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 60: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in svcctl_CreateWowService\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 61: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in svcctl_OpenSCManager2\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
...
static NTSTATUS svcctl__op_init_server(struct dcesrv_context *dce_ctx, const struct dcesrv_endpoint_server *ep_server)
{
	...
	const char *ncacn_np_secondary_endpoint =
		DCESRV_INTERFACE_SVCCTL_NCACN_NP_SECONDARY_ENDPOINT;
#else
...
NTSTATUS dcerpc_server_svcctl_init(TALLOC_CTX *ctx)
{
	NTSTATUS ret;
