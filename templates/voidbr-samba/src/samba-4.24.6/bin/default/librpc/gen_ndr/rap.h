...
#else
 { __do_not_use_enum_rap_status=INT_MAX}
...
#else
 { __do_not_use_enum_rap_PrintJStatusCode=INT_MAX}
...
#else
 { __do_not_use_enum_rap_PrintQStatusCode=INT_MAX}
...
#else
 { __do_not_use_enum_rap_JobInfoParamNum=INT_MAX}
...
#else
 { __do_not_use_enum_rap_UserPriv=INT_MAX}
...
#else
 { __do_not_use_enum_rap_AuthFlags=INT_MAX}
