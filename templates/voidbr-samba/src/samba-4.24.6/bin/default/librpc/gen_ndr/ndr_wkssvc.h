...
void ndr_print_wkssvc_NetWkstaGetInfo(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct wkssvc_NetWkstaGetInfo *r);
void ndr_print_wkssvc_NetWkstaSetInfo(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct wkssvc_NetWkstaSetInfo *r);
void ndr_print_wkssvc_NetWkstaEnumUsers(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct wkssvc_NetWkstaEnumUsers *r);
void ndr_print_wkssvc_NetrWkstaUserGetInfo(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct wkssvc_NetrWkstaUserGetInfo *r);
void ndr_print_wkssvc_NetrWkstaUserSetInfo(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct wkssvc_NetrWkstaUserSetInfo *r);
void ndr_print_wkssvc_NetWkstaTransportEnum(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct wkssvc_NetWkstaTransportEnum *r);
void ndr_print_wkssvc_NetrWkstaTransportAdd(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct wkssvc_NetrWkstaTransportAdd *r);
void ndr_print_wkssvc_NetrWkstaTransportDel(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct wkssvc_NetrWkstaTransportDel *r);
void ndr_print_wkssvc_NetrUseAdd(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct wkssvc_NetrUseAdd *r);
void ndr_print_wkssvc_NetrUseGetInfo(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct wkssvc_NetrUseGetInfo *r);
void ndr_print_wkssvc_NetrUseDel(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct wkssvc_NetrUseDel *r);
void ndr_print_wkssvc_NetrUseEnum(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct wkssvc_NetrUseEnum *r);
void ndr_print_wkssvc_NetrMessageBufferSend(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct wkssvc_NetrMessageBufferSend *r);
void ndr_print_wkssvc_NetrWorkstationStatisticsGet(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct wkssvc_NetrWorkstationStatisticsGet *r);
void ndr_print_wkssvc_NetrLogonDomainNameAdd(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct wkssvc_NetrLogonDomainNameAdd *r);
void ndr_print_wkssvc_NetrLogonDomainNameDel(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct wkssvc_NetrLogonDomainNameDel *r);
void ndr_print_wkssvc_NetrJoinDomain(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct wkssvc_NetrJoinDomain *r);
void ndr_print_wkssvc_NetrUnjoinDomain(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct wkssvc_NetrUnjoinDomain *r);
void ndr_print_wkssvc_NetrRenameMachineInDomain(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct wkssvc_NetrRenameMachineInDomain *r);
void ndr_print_wkssvc_NetrValidateName(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct wkssvc_NetrValidateName *r);
void ndr_print_wkssvc_NetrGetJoinInformation(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct wkssvc_NetrGetJoinInformation *r);
void ndr_print_wkssvc_NetrGetJoinableOus(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct wkssvc_NetrGetJoinableOus *r);
void ndr_print_wkssvc_NetrJoinDomain2(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct wkssvc_NetrJoinDomain2 *r);
void ndr_print_wkssvc_NetrUnjoinDomain2(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct wkssvc_NetrUnjoinDomain2 *r);
void ndr_print_wkssvc_NetrRenameMachineInDomain2(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct wkssvc_NetrRenameMachineInDomain2 *r);
void ndr_print_wkssvc_NetrValidateName2(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct wkssvc_NetrValidateName2 *r);
void ndr_print_wkssvc_NetrGetJoinableOus2(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct wkssvc_NetrGetJoinableOus2 *r);
void ndr_print_wkssvc_NetrAddAlternateComputerName(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct wkssvc_NetrAddAlternateComputerName *r);
void ndr_print_wkssvc_NetrRemoveAlternateComputerName(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct wkssvc_NetrRemoveAlternateComputerName *r);
void ndr_print_wkssvc_NetrSetPrimaryComputername(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct wkssvc_NetrSetPrimaryComputername *r);
void ndr_print_wkssvc_NetrEnumerateComputerNames(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct wkssvc_NetrEnumerateComputerNames *r);
