...
static enum ndr_err_code ndr_push_scerpc_Unknown0(struct ndr_push *ndr, ndr_flags_type flags, const struct scerpc_Unknown0 *r)
{
...
static enum ndr_err_code ndr_pull_scerpc_Unknown0(struct ndr_pull *ndr, ndr_flags_type flags, struct scerpc_Unknown0 *r)
{
...
_PUBLIC_ void ndr_print_scerpc_Unknown0(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct scerpc_Unknown0 *r)
{
...
#ifndef SKIP_NDR_TABLE_scerpc
static const struct ndr_interface_public_struct scerpc_public_structs[] = {
	{ .name = NULL }
};
...
const struct ndr_interface_table ndr_table_scerpc = {
	...
	.public_structs		= scerpc_public_structs,
	.endpoints	= &scerpc_endpoints,
	.authservices	= &scerpc_authservices
};

#endif /* SKIP_NDR_TABLE_scerpc */
