...
NTSTATUS dcerpc_server_netlogon_init(TALLOC_CTX *);
...
static NTSTATUS netlogon__op_dispatch(struct dcesrv_call_state *dce_call, TALLOC_CTX *mem_ctx, void *r)
{
	...
	case 49: {
		...
		dcesrv_netr_Opnum49NotUsedOnWire(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function netr_Opnum49NotUsedOnWire will reply async\n"));
		}
		break;
	}
	case 50: {
		...
		dcesrv_netr_Opnum50NotUsedOnWire(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function netr_Opnum50NotUsedOnWire will reply async\n"));
		}
		break;
	}
	case 51: {
		...
		dcesrv_netr_Opnum51NotUsedOnWire(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function netr_Opnum51NotUsedOnWire will reply async\n"));
		}
		break;
	}
	case 52: {
		...
		dcesrv_netr_Opnum52NotUsedOnWire(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function netr_Opnum52NotUsedOnWire will reply async\n"));
		}
		break;
	}
	case 53: {
		...
		dcesrv_netr_Opnum53NotUsedOnWire(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function netr_Opnum53NotUsedOnWire will reply async\n"));
		}
		break;
	}
	case 54: {
		...
		r2->out.result = dcesrv_netr_ChainSetClientAttributes(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function netr_ChainSetClientAttributes will reply async\n"));
		}
		break;
	}
	case 55: {
		...
		dcesrv_netr_Opnum55NotUsedOnWire(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function netr_Opnum55NotUsedOnWire will reply async\n"));
		}
		break;
	}
	case 56: {
		...
		dcesrv_netr_Opnum56NotUsedOnWire(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function netr_Opnum56NotUsedOnWire will reply async\n"));
		}
		break;
	}
	case 57: {
		...
		dcesrv_netr_Opnum57NotUsedOnWire(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function netr_Opnum57NotUsedOnWire will reply async\n"));
		}
		break;
	}
	case 58: {
		...
		dcesrv_netr_Opnum58NotUsedOnWire(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function netr_Opnum58NotUsedOnWire will reply async\n"));
		}
		break;
	}
	case 59: {
		...
		r2->out.result = dcesrv_netr_ServerAuthenticateKerberos(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function netr_ServerAuthenticateKerberos will reply async\n"));
		}
		break;
	}
...
static NTSTATUS netlogon__op_reply(struct dcesrv_call_state *dce_call, TALLOC_CTX *mem_ctx, void *r)
{
	...
	case 49: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in netr_Opnum49NotUsedOnWire\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 50: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in netr_Opnum50NotUsedOnWire\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 51: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in netr_Opnum51NotUsedOnWire\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 52: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in netr_Opnum52NotUsedOnWire\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 53: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in netr_Opnum53NotUsedOnWire\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 54: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in netr_ChainSetClientAttributes\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 55: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in netr_Opnum55NotUsedOnWire\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 56: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in netr_Opnum56NotUsedOnWire\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 57: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in netr_Opnum57NotUsedOnWire\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 58: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in netr_Opnum58NotUsedOnWire\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 59: {
		...
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in netr_ServerAuthenticateKerberos\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
...
static NTSTATUS netlogon__op_init_server(struct dcesrv_context *dce_ctx, const struct dcesrv_endpoint_server *ep_server)
{
	...
	const char *ncacn_np_secondary_endpoint =
		DCESRV_INTERFACE_NETLOGON_NCACN_NP_SECONDARY_ENDPOINT;
#else
...
NTSTATUS dcerpc_server_netlogon_init(TALLOC_CTX *ctx)
{
	NTSTATUS ret;
