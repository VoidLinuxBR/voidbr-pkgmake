...
static enum ndr_err_code ndr_push_EFS_HASH_BLOB(struct ndr_push *ndr, ndr_flags_type ndr_flags, const struct EFS_HASH_BLOB *r)
{
...
static enum ndr_err_code ndr_pull_EFS_HASH_BLOB(struct ndr_pull *ndr, ndr_flags_type ndr_flags, struct EFS_HASH_BLOB *r)
{
	uint32_t _ptr_pbData;
	uint32_t size_pbData_1 = 0;
	TALLOC_CTX *_mem_save_pbData_0 = NULL;
	...
	if (ndr_flags & NDR_BUFFERS) {
		if (r->pbData) {
			...
			NDR_CHECK(ndr_get_array_size(ndr, (void*)&r->pbData, &size_pbData_1));
		...
		if (r->pbData) {
			NDR_CHECK(ndr_check_steal_array_size(ndr, (void*)&r->pbData, r->cbData));
		}
	}
	return NDR_ERR_SUCCESS;
}
...
static enum ndr_err_code ndr_push_ENCRYPTION_CERTIFICATE_HASH(struct ndr_push *ndr, ndr_flags_type ndr_flags, const struct ENCRYPTION_CERTIFICATE_HASH *r)
{
	NDR_PUSH_CHECK_FLAGS(ndr, ndr_flags);
	if (ndr_flags & NDR_SCALARS) {
		NDR_CHECK(ndr_push_align(ndr, 5));
...
static enum ndr_err_code ndr_pull_ENCRYPTION_CERTIFICATE_HASH(struct ndr_pull *ndr, ndr_flags_type ndr_flags, struct ENCRYPTION_CERTIFICATE_HASH *r)
{
	uint32_t _ptr_pUserSid;
	TALLOC_CTX *_mem_save_pUserSid_0 = NULL;
	uint32_t _ptr_pHash;
	TALLOC_CTX *_mem_save_pHash_0 = NULL;
	uint32_t _ptr_lpDisplayInformation;
	uint32_t size_lpDisplayInformation_1 = 0;
	uint32_t length_lpDisplayInformation_1 = 0;
	TALLOC_CTX *_mem_save_lpDisplayInformation_0 = NULL;
	NDR_PULL_CHECK_FLAGS(ndr, ndr_flags);
	if (ndr_flags & NDR_SCALARS) {
		NDR_CHECK(ndr_pull_align(ndr, 5));
	...
	if (ndr_flags & NDR_BUFFERS) {
		...
		if (r->lpDisplayInformation) {
			...
			NDR_CHECK(ndr_steal_array_size(ndr, (void*)&r->lpDisplayInformation, &size_lpDisplayInformation_1));
			NDR_CHECK(ndr_steal_array_length(ndr, (void*)&r->lpDisplayInformation, &length_lpDisplayInformation_1));
			if (length_lpDisplayInformation_1 > size_lpDisplayInformation_1) {
				return ndr_pull_error(ndr, NDR_ERR_ARRAY_SIZE, "Bad array size %"PRIu32": should exceed array length %"PRIu32"", size_lpDisplayInformation_1, length_lpDisplayInformation_1);
			}
...
static enum ndr_err_code ndr_push_ENCRYPTION_CERTIFICATE_HASH_LIST(struct ndr_push *ndr, ndr_flags_type ndr_flags, const struct ENCRYPTION_CERTIFICATE_HASH_LIST *r)
{
...
static enum ndr_err_code ndr_pull_ENCRYPTION_CERTIFICATE_HASH_LIST(struct ndr_pull *ndr, ndr_flags_type ndr_flags, struct ENCRYPTION_CERTIFICATE_HASH_LIST *r)
{
	uint32_t _ptr_pUsers;
	uint32_t size_pUsers_0 = 0;
	uint32_t cntr_pUsers_0;
	TALLOC_CTX *_mem_save_pUsers_0 = NULL;
	TALLOC_CTX *_mem_save_pUsers_1 = NULL;
	NDR_PULL_CHECK_FLAGS(ndr, ndr_flags);
	if (ndr_flags & NDR_SCALARS) {
		NDR_CHECK(ndr_pull_array_size(ndr, &r->pUsers));
		NDR_CHECK(ndr_pull_align(ndr, 5));
		NDR_CHECK(ndr_pull_uint32(ndr, NDR_SCALARS, &r->nCert_Hash));
		NDR_CHECK(ndr_get_array_size(ndr, (void*)&r->pUsers, &size_pUsers_0));
...
_PUBLIC_ void ndr_print_ENCRYPTION_CERTIFICATE_HASH_LIST(struct ndr_print *ndr, const char *name, const struct ENCRYPTION_CERTIFICATE_HASH_LIST *r)
{
	...
	ndr->print(ndr, "%s: ARRAY(%"PRIu32")", "pUsers", (uint32_t)(r->nCert_Hash));
	ndr->depth++;
	for (cntr_pUsers_0 = 0; cntr_pUsers_0 < (r->nCert_Hash); cntr_pUsers_0++) {
...
static enum ndr_err_code ndr_push_EFS_CERTIFICATE_BLOB(struct ndr_push *ndr, ndr_flags_type ndr_flags, const struct EFS_CERTIFICATE_BLOB *r)
{
	NDR_PUSH_CHECK_FLAGS(ndr, ndr_flags);
	if (ndr_flags & NDR_SCALARS) {
		NDR_CHECK(ndr_push_align(ndr, 5));
...
static enum ndr_err_code ndr_pull_EFS_CERTIFICATE_BLOB(struct ndr_pull *ndr, ndr_flags_type ndr_flags, struct EFS_CERTIFICATE_BLOB *r)
{
	uint32_t _ptr_pbData;
	uint32_t size_pbData_1 = 0;
	TALLOC_CTX *_mem_save_pbData_0 = NULL;
...
static enum ndr_err_code ndr_push_ENCRYPTION_CERTIFICATE(struct ndr_push *ndr, ndr_flags_type ndr_flags, const struct ENCRYPTION_CERTIFICATE *r)
{
	NDR_PUSH_CHECK_FLAGS(ndr, ndr_flags);
	if (ndr_flags & NDR_SCALARS) {
		NDR_CHECK(ndr_push_align(ndr, 5));
...
static enum ndr_err_code ndr_pull_ENCRYPTION_CERTIFICATE(struct ndr_pull *ndr, ndr_flags_type ndr_flags, struct ENCRYPTION_CERTIFICATE *r)
{
	uint32_t _ptr_pUserSid;
	TALLOC_CTX *_mem_save_pUserSid_0 = NULL;
	uint32_t _ptr_pCertBlob;
	TALLOC_CTX *_mem_save_pCertBlob_0 = NULL;
	NDR_PULL_CHECK_FLAGS(ndr, ndr_flags);
	if (ndr_flags & NDR_SCALARS) {
		NDR_CHECK(ndr_pull_align(ndr, 5));
...
static enum ndr_err_code ndr_push_EfsRpcOpenFileRaw(struct ndr_push *ndr, ndr_flags_type flags, const struct EfsRpcOpenFileRaw *r)
{
...
static enum ndr_err_code ndr_pull_EfsRpcOpenFileRaw(struct ndr_pull *ndr, ndr_flags_type flags, struct EfsRpcOpenFileRaw *r)
{
	uint32_t size_FileName_0 = 0;
	uint32_t length_FileName_0 = 0;
	TALLOC_CTX *_mem_save_pvContext_0 = NULL;
	...
	if (flags & NDR_IN) {
		...
		NDR_CHECK(ndr_steal_array_size(ndr, (void*)&r->in.FileName, &size_FileName_0));
		NDR_CHECK(ndr_steal_array_length(ndr, (void*)&r->in.FileName, &length_FileName_0));
		if (length_FileName_0 > size_FileName_0) {
			return ndr_pull_error(ndr, NDR_ERR_ARRAY_SIZE, "Bad array size %"PRIu32": should exceed array length %"PRIu32"", size_FileName_0, length_FileName_0);
		}
		...
		NDR_ZERO_STRUCTP(r->out.pvContext);
	}
	if (flags & NDR_OUT) {
...
_PUBLIC_ void ndr_print_EfsRpcOpenFileRaw(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct EfsRpcOpenFileRaw *r)
{
...
static enum ndr_err_code ndr_push_EfsRpcReadFileRaw(struct ndr_push *ndr, ndr_flags_type flags, const struct EfsRpcReadFileRaw *r)
{
	NDR_PUSH_CHECK_FN_FLAGS(ndr, flags);
	if (flags & NDR_IN) {
...
static enum ndr_err_code ndr_pull_EfsRpcReadFileRaw(struct ndr_pull *ndr, ndr_flags_type flags, struct EfsRpcReadFileRaw *r)
{
	TALLOC_CTX *_mem_save_pvContext_0 = NULL;
	NDR_PULL_CHECK_FN_FLAGS(ndr, flags);
	if (flags & NDR_IN) {
	...
	if (flags & NDR_OUT) {
		...
		if (r->in.pvContext == NULL) {
			NDR_PULL_ALLOC(ndr, r->in.pvContext);
			NDR_ZERO_STRUCTP(r->in.pvContext);
		}
#endif /* FUZZING_BUILD_MODE_UNSAFE_FOR_PRODUCTION */
		NDR_CHECK(ndr_pull_WERROR(ndr, NDR_SCALARS, &r->out.result));
	}
...
_PUBLIC_ void ndr_print_EfsRpcReadFileRaw(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct EfsRpcReadFileRaw *r)
{
...
static enum ndr_err_code ndr_push_EfsRpcWriteFileRaw(struct ndr_push *ndr, ndr_flags_type flags, const struct EfsRpcWriteFileRaw *r)
{
	NDR_PUSH_CHECK_FN_FLAGS(ndr, flags);
	if (flags & NDR_IN) {
		if (r->in.pvContext == NULL) {
...
static enum ndr_err_code ndr_pull_EfsRpcWriteFileRaw(struct ndr_pull *ndr, ndr_flags_type flags, struct EfsRpcWriteFileRaw *r)
{
	TALLOC_CTX *_mem_save_pvContext_0 = NULL;
	NDR_PULL_CHECK_FN_FLAGS(ndr, flags);
	if (flags & NDR_IN) {
...
_PUBLIC_ void ndr_print_EfsRpcWriteFileRaw(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct EfsRpcWriteFileRaw *r)
{
...
static enum ndr_err_code ndr_push_EfsRpcCloseRaw(struct ndr_push *ndr, ndr_flags_type flags, const struct EfsRpcCloseRaw *r)
{
	NDR_PUSH_CHECK_FN_FLAGS(ndr, flags);
	if (flags & NDR_IN) {
		if (r->in.pvContext == NULL) {
...
static enum ndr_err_code ndr_pull_EfsRpcCloseRaw(struct ndr_pull *ndr, ndr_flags_type flags, struct EfsRpcCloseRaw *r)
{
	TALLOC_CTX *_mem_save_pvContext_0 = NULL;
	NDR_PULL_CHECK_FN_FLAGS(ndr, flags);
	if (flags & NDR_IN) {
...
_PUBLIC_ void ndr_print_EfsRpcCloseRaw(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct EfsRpcCloseRaw *r)
{
...
static enum ndr_err_code ndr_push_EfsRpcEncryptFileSrv(struct ndr_push *ndr, ndr_flags_type flags, const struct EfsRpcEncryptFileSrv *r)
{
	NDR_PUSH_CHECK_FN_FLAGS(ndr, flags);
	if (flags & NDR_IN) {
		NDR_CHECK(ndr_push_uint3264(ndr, NDR_SCALARS, ndr_charset_length(r->in.Filename, CH_UTF16)));
...
static enum ndr_err_code ndr_pull_EfsRpcEncryptFileSrv(struct ndr_pull *ndr, ndr_flags_type flags, struct EfsRpcEncryptFileSrv *r)
{
	uint32_t size_Filename_0 = 0;
	uint32_t length_Filename_0 = 0;
	NDR_PULL_CHECK_FN_FLAGS(ndr, flags);
...
_PUBLIC_ void ndr_print_EfsRpcEncryptFileSrv(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct EfsRpcEncryptFileSrv *r)
{
...
static enum ndr_err_code ndr_push_EfsRpcDecryptFileSrv(struct ndr_push *ndr, ndr_flags_type flags, const struct EfsRpcDecryptFileSrv *r)
{
	NDR_PUSH_CHECK_FN_FLAGS(ndr, flags);
	if (flags & NDR_IN) {
		NDR_CHECK(ndr_push_uint3264(ndr, NDR_SCALARS, ndr_charset_length(r->in.FileName, CH_UTF16)));
...
static enum ndr_err_code ndr_pull_EfsRpcDecryptFileSrv(struct ndr_pull *ndr, ndr_flags_type flags, struct EfsRpcDecryptFileSrv *r)
{
	uint32_t size_FileName_0 = 0;
	uint32_t length_FileName_0 = 0;
	NDR_PULL_CHECK_FN_FLAGS(ndr, flags);
...
_PUBLIC_ void ndr_print_EfsRpcDecryptFileSrv(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct EfsRpcDecryptFileSrv *r)
{
...
static enum ndr_err_code ndr_push_EfsRpcQueryUsersOnFile(struct ndr_push *ndr, ndr_flags_type flags, const struct EfsRpcQueryUsersOnFile *r)
{
	NDR_PUSH_CHECK_FN_FLAGS(ndr, flags);
	if (flags & NDR_IN) {
		NDR_CHECK(ndr_push_uint3264(ndr, NDR_SCALARS, ndr_charset_length(r->in.FileName, CH_UTF16)));
...
static enum ndr_err_code ndr_pull_EfsRpcQueryUsersOnFile(struct ndr_pull *ndr, ndr_flags_type flags, struct EfsRpcQueryUsersOnFile *r)
{
	uint32_t size_FileName_0 = 0;
	uint32_t length_FileName_0 = 0;
	uint32_t _ptr_pUsers;
...
_PUBLIC_ void ndr_print_EfsRpcQueryUsersOnFile(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct EfsRpcQueryUsersOnFile *r)
{
...
static enum ndr_err_code ndr_push_EfsRpcQueryRecoveryAgents(struct ndr_push *ndr, ndr_flags_type flags, const struct EfsRpcQueryRecoveryAgents *r)
{
	NDR_PUSH_CHECK_FN_FLAGS(ndr, flags);
	if (flags & NDR_IN) {
		NDR_CHECK(ndr_push_uint3264(ndr, NDR_SCALARS, ndr_charset_length(r->in.FileName, CH_UTF16)));
...
static enum ndr_err_code ndr_pull_EfsRpcQueryRecoveryAgents(struct ndr_pull *ndr, ndr_flags_type flags, struct EfsRpcQueryRecoveryAgents *r)
{
	uint32_t size_FileName_0 = 0;
	uint32_t length_FileName_0 = 0;
	uint32_t _ptr_pRecoveryAgents;
	TALLOC_CTX *_mem_save_pRecoveryAgents_0 = NULL;
	TALLOC_CTX *_mem_save_pRecoveryAgents_1 = NULL;
	NDR_PULL_CHECK_FN_FLAGS(ndr, flags);
	if (flags & NDR_IN) {
		NDR_ZERO_STRUCT(r->out);
		...
		NDR_ZERO_STRUCTP(r->out.pRecoveryAgents);
	}
	if (flags & NDR_OUT) {
#ifdef FUZZING_BUILD_MODE_UNSAFE_FOR_PRODUCTION
#endif /* FUZZING_BUILD_MODE_UNSAFE_FOR_PRODUCTION */
...
_PUBLIC_ void ndr_print_EfsRpcQueryRecoveryAgents(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct EfsRpcQueryRecoveryAgents *r)
{
...
static enum ndr_err_code ndr_push_EfsRpcRemoveUsersFromFile(struct ndr_push *ndr, ndr_flags_type flags, const struct EfsRpcRemoveUsersFromFile *r)
{
	NDR_PUSH_CHECK_FN_FLAGS(ndr, flags);
	if (flags & NDR_IN) {
		NDR_CHECK(ndr_push_uint3264(ndr, NDR_SCALARS, ndr_charset_length(r->in.FileName, CH_UTF16)));
...
static enum ndr_err_code ndr_pull_EfsRpcRemoveUsersFromFile(struct ndr_pull *ndr, ndr_flags_type flags, struct EfsRpcRemoveUsersFromFile *r)
{
	uint32_t size_FileName_0 = 0;
	uint32_t length_FileName_0 = 0;
	NDR_PULL_CHECK_FN_FLAGS(ndr, flags);
...
_PUBLIC_ void ndr_print_EfsRpcRemoveUsersFromFile(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct EfsRpcRemoveUsersFromFile *r)
{
...
static enum ndr_err_code ndr_push_EfsRpcAddUsersToFile(struct ndr_push *ndr, ndr_flags_type flags, const struct EfsRpcAddUsersToFile *r)
{
	NDR_PUSH_CHECK_FN_FLAGS(ndr, flags);
	if (flags & NDR_IN) {
		NDR_CHECK(ndr_push_uint3264(ndr, NDR_SCALARS, ndr_charset_length(r->in.FileName, CH_UTF16)));
...
static enum ndr_err_code ndr_pull_EfsRpcAddUsersToFile(struct ndr_pull *ndr, ndr_flags_type flags, struct EfsRpcAddUsersToFile *r)
{
	uint32_t size_FileName_0 = 0;
	uint32_t length_FileName_0 = 0;
	NDR_PULL_CHECK_FN_FLAGS(ndr, flags);
...
_PUBLIC_ void ndr_print_EfsRpcAddUsersToFile(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct EfsRpcAddUsersToFile *r)
{
...
static enum ndr_err_code ndr_push_EfsRpcSetFileEncryptionKey(struct ndr_push *ndr, ndr_flags_type flags, const struct EfsRpcSetFileEncryptionKey *r)
{
	NDR_PUSH_CHECK_FN_FLAGS(ndr, flags);
	if (flags & NDR_IN) {
...
static enum ndr_err_code ndr_pull_EfsRpcSetFileEncryptionKey(struct ndr_pull *ndr, ndr_flags_type flags, struct EfsRpcSetFileEncryptionKey *r)
{
	uint32_t _ptr_pEncryptionCertificate;
	TALLOC_CTX *_mem_save_pEncryptionCertificate_0 = NULL;
	NDR_PULL_CHECK_FN_FLAGS(ndr, flags);
	if (flags & NDR_IN) {
...
_PUBLIC_ void ndr_print_EfsRpcSetFileEncryptionKey(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct EfsRpcSetFileEncryptionKey *r)
{
...
static enum ndr_err_code ndr_push_EfsRpcNotSupported(struct ndr_push *ndr, ndr_flags_type flags, const struct EfsRpcNotSupported *r)
{
	NDR_PUSH_CHECK_FN_FLAGS(ndr, flags);
	if (flags & NDR_IN) {
	}
...
static enum ndr_err_code ndr_pull_EfsRpcNotSupported(struct ndr_pull *ndr, ndr_flags_type flags, struct EfsRpcNotSupported *r)
{
	NDR_PULL_CHECK_FN_FLAGS(ndr, flags);
	if (flags & NDR_IN) {
	}
...
_PUBLIC_ void ndr_print_EfsRpcNotSupported(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct EfsRpcNotSupported *r)
{
...
static enum ndr_err_code ndr_push_EfsRpcFileKeyInfo(struct ndr_push *ndr, ndr_flags_type flags, const struct EfsRpcFileKeyInfo *r)
{
	NDR_PUSH_CHECK_FN_FLAGS(ndr, flags);
	if (flags & NDR_IN) {
	}
...
static enum ndr_err_code ndr_pull_EfsRpcFileKeyInfo(struct ndr_pull *ndr, ndr_flags_type flags, struct EfsRpcFileKeyInfo *r)
{
	NDR_PULL_CHECK_FN_FLAGS(ndr, flags);
	if (flags & NDR_IN) {
	}
...
_PUBLIC_ void ndr_print_EfsRpcFileKeyInfo(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct EfsRpcFileKeyInfo *r)
{
...
static enum ndr_err_code ndr_push_EfsRpcDuplicateEncryptionInfoFile(struct ndr_push *ndr, ndr_flags_type flags, const struct EfsRpcDuplicateEncryptionInfoFile *r)
{
	NDR_PUSH_CHECK_FN_FLAGS(ndr, flags);
	if (flags & NDR_IN) {
	}
...
static enum ndr_err_code ndr_pull_EfsRpcDuplicateEncryptionInfoFile(struct ndr_pull *ndr, ndr_flags_type flags, struct EfsRpcDuplicateEncryptionInfoFile *r)
{
	NDR_PULL_CHECK_FN_FLAGS(ndr, flags);
	if (flags & NDR_IN) {
	}
...
_PUBLIC_ void ndr_print_EfsRpcDuplicateEncryptionInfoFile(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct EfsRpcDuplicateEncryptionInfoFile *r)
{
...
#ifndef SKIP_NDR_TABLE_efs
static const struct ndr_interface_public_struct efs_public_structs[] = {
	{ .name = NULL }
};
...
const struct ndr_interface_table ndr_table_efs = {
	...
	.public_structs		= efs_public_structs,
