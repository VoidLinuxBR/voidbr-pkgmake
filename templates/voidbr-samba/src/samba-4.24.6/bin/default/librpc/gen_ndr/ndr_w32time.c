...
static enum ndr_err_code ndr_push_w32time_SyncTime(struct ndr_push *ndr, ndr_flags_type flags, const struct w32time_SyncTime *r)
{
...
static enum ndr_err_code ndr_pull_w32time_SyncTime(struct ndr_pull *ndr, ndr_flags_type flags, struct w32time_SyncTime *r)
{
...
_PUBLIC_ void ndr_print_w32time_SyncTime(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct w32time_SyncTime *r)
{
...
static enum ndr_err_code ndr_push_w32time_GetNetLogonServiceBits(struct ndr_push *ndr, ndr_flags_type flags, const struct w32time_GetNetLogonServiceBits *r)
{
	NDR_PUSH_CHECK_FN_FLAGS(ndr, flags);
	if (flags & NDR_IN) {
	}
...
static enum ndr_err_code ndr_pull_w32time_GetNetLogonServiceBits(struct ndr_pull *ndr, ndr_flags_type flags, struct w32time_GetNetLogonServiceBits *r)
{
	NDR_PULL_CHECK_FN_FLAGS(ndr, flags);
	if (flags & NDR_IN) {
	}
...
_PUBLIC_ void ndr_print_w32time_GetNetLogonServiceBits(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct w32time_GetNetLogonServiceBits *r)
{
...
static enum ndr_err_code ndr_push_w32time_QueryProviderStatus(struct ndr_push *ndr, ndr_flags_type flags, const struct w32time_QueryProviderStatus *r)
{
	NDR_PUSH_CHECK_FN_FLAGS(ndr, flags);
	if (flags & NDR_IN) {
	}
...
static enum ndr_err_code ndr_pull_w32time_QueryProviderStatus(struct ndr_pull *ndr, ndr_flags_type flags, struct w32time_QueryProviderStatus *r)
{
	NDR_PULL_CHECK_FN_FLAGS(ndr, flags);
	if (flags & NDR_IN) {
	}
...
_PUBLIC_ void ndr_print_w32time_QueryProviderStatus(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct w32time_QueryProviderStatus *r)
{
