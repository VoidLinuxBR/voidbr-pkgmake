...
enum dns_record_type
#ifndef USE_UINT_ENUMS
 {
	...
	DNS_TYPE_CERT=(int)(0x25),
	DNS_TYPE_DNAME=(int)(0x27),
	DNS_TYPE_DS=(int)(0x2B),
	DNS_TYPE_SSHFP=(int)(0x2C),
	DNS_TYPE_IPSECKEY=(int)(0x2D),
	DNS_TYPE_RRSIG=(int)(0x2E),
	DNS_TYPE_NSEC=(int)(0x2F),
	DNS_TYPE_DNSKEY=(int)(0x30),
	DNS_TYPE_DHCID=(int)(0x31),
	DNS_TYPE_NSEC3=(int)(0x32),
	DNS_TYPE_NSEC3PARAM=(int)(0x33),
	DNS_TYPE_TLSA=(int)(0x34),
	DNS_TYPE_CDS=(int)(0x3B),
	DNS_TYPE_CDNSKEY=(int)(0x3C),
	DNS_TYPE_SVCB=(int)(0x40),
	DNS_TYPE_HTTPS=(int)(0x41),
	DNS_TYPE_ALL=(int)(0xFF),
	DNS_TYPE_URI=(int)(0x100),
	DNS_TYPE_CAA=(int)(0x101),
	DNS_TYPE_WINS=(int)(0xFF01),
	DNS_TYPE_WINSR=(int)(0xFF02)
}
#else
 { __do_not_use_enum_dns_record_type=INT_MAX}
...
#define DNS_TYPE_CERT ( 0x25 )
#define DNS_TYPE_DNAME ( 0x27 )
#define DNS_TYPE_DS ( 0x2B )
#define DNS_TYPE_SSHFP ( 0x2C )
#define DNS_TYPE_IPSECKEY ( 0x2D )
#define DNS_TYPE_RRSIG ( 0x2E )
#define DNS_TYPE_NSEC ( 0x2F )
#define DNS_TYPE_DNSKEY ( 0x30 )
#define DNS_TYPE_DHCID ( 0x31 )
#define DNS_TYPE_NSEC3 ( 0x32 )
#define DNS_TYPE_NSEC3PARAM ( 0x33 )
#define DNS_TYPE_TLSA ( 0x34 )
#define DNS_TYPE_CDS ( 0x3B )
#define DNS_TYPE_CDNSKEY ( 0x3C )
#define DNS_TYPE_SVCB ( 0x40 )
#define DNS_TYPE_HTTPS ( 0x41 )
#define DNS_TYPE_ALL ( 0xFF )
#define DNS_TYPE_URI ( 0x100 )
#define DNS_TYPE_CAA ( 0x101 )
...
#define DNS_RPC_FLAG_RECORD_WIRE_FORMAT ( 0x00100000 )
#define DNS_RPC_FLAG_SUPPRESS_RECORD_UPDATE_PTR ( 0x00200000 )
...
#else
 { __do_not_use_enum_dns_record_rank=INT_MAX}
...
#else
 { __do_not_use_enum_dns_zone_type=INT_MAX}
...
#else
 { __do_not_use_enum_dns_zone_update=INT_MAX}
...
#else
 { __do_not_use_enum_dns_property_id=INT_MAX}
...
#else
 { __do_not_use_enum_dns_dcpromo_flag=INT_MAX}
...
struct dnsp_dns_addr {
	uint16_t family;
	uint16_t port;/* [flag(LIBNDR_FLAG_BIGENDIAN)] */
...
struct dnsp_string_list {
	uint8_t count;
	const char * *str;
}/* [gensize,noprint,nopull,nopush,public] */;

union dnsRecordData {
	NTTIME EntombedTime;/* [case(DNS_TYPE_TOMBSTONE)] */
...
union dnsPropertyData {
	...
	const char * deleted_by_hostname;/* [case(DSPROPERTY_ZONE_DELETED_FROM_HOSTNAME),flag(LIBNDR_FLAG_STR_NULLTERM|LIBNDR_FLAG_ALIGN2)] */
...
struct dnsp_DnsProperty {
	...
	union dnsPropertyData data;/* [switch_is(id)] */
	uint32_t name;
}/* [flag(LIBNDR_FLAG_NOALIGN),public] */;

struct dnsp_DnsProperty_short {
	uint32_t wDataLength;/* [range(0,0),value(0)] */
	uint32_t namelength;
	uint32_t flag;/* [value(0)] */
	uint32_t version;/* [value] */
	enum dns_property_id id;
	union dnsPropertyData data;/* [switch_is(DSPROPERTY_ZONE_EMPTY)] */
	uint32_t name;
}/* [flag(LIBNDR_FLAG_NOALIGN),public] */;
