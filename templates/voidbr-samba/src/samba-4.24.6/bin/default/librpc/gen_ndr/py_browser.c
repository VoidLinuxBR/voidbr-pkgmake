...
{
	struct BrowserrSrvInfo100Ctr *object = pytalloc_get_ptr(obj);
...
{
	struct BrowserrSrvInfo100Ctr *object = pytalloc_get_ptr(py_obj);
	if (value == NULL) {
...
{
	struct BrowserrSrvInfo101Ctr *object = pytalloc_get_ptr(obj);
	PyObject *py_entries_read;
	py_entries_read = PyLong_FromUnsignedLongLong((uint32_t)(object->entries_read));
	return py_entries_read;
}
...
{
	struct BrowserrSrvInfo101Ctr *object = pytalloc_get_ptr(py_obj);
	if (value == NULL) {
		PyErr_Format(PyExc_AttributeError, "Cannot delete NDR object: object->entries_read");
		return -1;
	}
...
static PyMethodDef py_BrowserrSrvInfoUnion_methods[] = {
	{ "__import__", PY_DISCARD_FUNC_SIG(PyCFunction,py_BrowserrSrvInfoUnion_import),
		METH_VARARGS|METH_KEYWORDS|METH_CLASS,
		"T.__import__(mem_ctx, level, in) => ret." },
	{ "__export__", PY_DISCARD_FUNC_SIG(PyCFunction,py_BrowserrSrvInfoUnion_export),
		METH_VARARGS|METH_KEYWORDS|METH_CLASS,
...
{
	struct BrowserrSrvInfo *object = pytalloc_get_ptr(obj);
	PyObject *py_level;
...
{
	struct BrowserrSrvInfo *object = pytalloc_get_ptr(py_obj);
	if (value == NULL) {
...
{
	struct BrowserrQueryOtherDomains *object = pytalloc_get_ptr(obj);
...
{
	struct BrowserrQueryOtherDomains *object = pytalloc_get_ptr(py_obj);
	if (value == NULL) {
...
{
	PyObject *self = pytalloc_new(struct BrowserrQueryOtherDomains, type);
	struct BrowserrQueryOtherDomains *_self = (struct BrowserrQueryOtherDomains *)pytalloc_get_ptr(self);
	TALLOC_CTX *mem_ctx = pytalloc_get_mem_ctx(self);
	_self->in.info = talloc_zero(mem_ctx, struct BrowserrSrvInfo);
	_self->out.info = talloc_zero(mem_ctx, struct BrowserrSrvInfo);
	_self->out.total_entries = talloc_zero(mem_ctx, uint32_t);
	return self;
}

static PyObject *py_BrowserrQueryOtherDomains_ndr_opnum(PyTypeObject *type, PyObject *Py_UNUSED(ignored))
{
...
static PyObject *py_BrowserrQueryOtherDomains_ndr_pack(PyObject *py_obj, ndr_flags_type ndr_inout_flags, libndr_flags ndr_push_flags)
{
	...
	if (ndr_table_browser.num_calls < 3) {
...
static PyObject *py_BrowserrQueryOtherDomains_ndr_unpack(PyObject *py_obj, const DATA_BLOB *blob, ndr_flags_type ndr_inout_flags, libndr_flags ndr_pull_flags, bool allow_remaining)
{
	const struct ndr_interface_call *call = NULL;
	struct BrowserrQueryOtherDomains *object = pytalloc_get_ptr(py_obj);
...
static PyObject *py_BrowserrQueryOtherDomains_ndr_print(PyObject *py_obj, PyObject *args, PyObject *kwargs, const char *name, ndr_flags_type ndr_inout_flags)
{
	const struct ndr_interface_call *call = NULL;
	struct BrowserrQueryOtherDomains *object = pytalloc_get_ptr(py_obj);
...
static PyObject *py_BrowserrQueryOtherDomains_ndr_print_in(PyObject *py_obj, PyObject *args, PyObject *kwargs)
{
	return py_BrowserrQueryOtherDomains_ndr_print(py_obj, args, kwargs, "BrowserrQueryOtherDomains_in", NDR_IN);
}

static PyObject *py_BrowserrQueryOtherDomains_ndr_print_out(PyObject *py_obj, PyObject *args, PyObject *kwargs)
{
	return py_BrowserrQueryOtherDomains_ndr_print(py_obj, args, kwargs, "BrowserrQueryOtherDomains_out", NDR_OUT);
}
...
static PyMethodDef py_BrowserrQueryOtherDomains_methods[] = {
	...
	{ "__ndr_pack_in__", PY_DISCARD_FUNC_SIG(PyCFunction,py_BrowserrQueryOtherDomains_ndr_pack_in), METH_VARARGS|METH_KEYWORDS,
		"S.ndr_pack_in(object, bigendian=False, ndr64=False) -> blob\nNDR pack input" },
	{ "__ndr_pack_out__", PY_DISCARD_FUNC_SIG(PyCFunction,py_BrowserrQueryOtherDomains_ndr_pack_out), METH_VARARGS|METH_KEYWORDS,
		"S.ndr_pack_out(object, bigendian=False, ndr64=False) -> blob\nNDR pack output" },
	{ "__ndr_unpack_in__", PY_DISCARD_FUNC_SIG(PyCFunction,py_BrowserrQueryOtherDomains_ndr_unpack_in), METH_VARARGS|METH_KEYWORDS,
		"S.ndr_unpack_in(class, blob, bigendian=False, ndr64=False, allow_remaining=False) -> None\nNDR unpack input" },
	{ "__ndr_unpack_out__", PY_DISCARD_FUNC_SIG(PyCFunction,py_BrowserrQueryOtherDomains_ndr_unpack_out), METH_VARARGS|METH_KEYWORDS,
		"S.ndr_unpack_out(class, blob, bigendian=False, ndr64=False, allow_remaining=False) -> None\nNDR unpack output" },
	{ "__ndr_print_in__", PY_DISCARD_FUNC_SIG(PyCFunction,py_BrowserrQueryOtherDomains_ndr_print_in), METH_VARARGS|METH_KEYWORDS,
		"S.ndr_print_in(object, print_secrets=False) -> String\nNDR print input" },
	{ "__ndr_print_out__", PY_DISCARD_FUNC_SIG(PyCFunction,py_BrowserrQueryOtherDomains_ndr_print_out), METH_VARARGS|METH_KEYWORDS,
...
static PyObject *unpack_py_BrowserrQueryOtherDomains_args_out(struct BrowserrQueryOtherDomains *r, bool raise_result_exception)
{
...
const struct PyNdrRpcMethodDef py_ndr_browser_methods[] = {
	{
		.name = "BrowserrQueryOtherDomains",
		.doc = "S.BrowserrQueryOtherDomains(server_unc, info) -> (info, total_entries)",
		.call = (py_dcerpc_call_fn)dcerpc_BrowserrQueryOtherDomains_r,
		.pack_in_data = (py_data_pack_fn)pack_py_BrowserrQueryOtherDomains_args_in,
		.unpack_out_data = (py_data_unpack_fn)unpack_py_BrowserrQueryOtherDomains_args_out,
		.opnum = 2,
...
static PyTypeObject browser_InterfaceType = {
	...
	.tp_doc = "browser(binding, lp_ctx=None, credentials=None, basis_connection=None) -> connection\n"
"\n\n"
"Parameters\n"
"----------\n"
"binding : str\n"
...
"    A browser client connection object (default is None).\n"
"\n\n"
"Returns\n"
"-------\n"
...
static struct PyModuleDef moduledef = {
	...
	.m_name = "browser",
	.m_doc = "browser DCE/RPC",
	.m_size = -1,
	.m_methods = browser_methods,
};
MODULE_INIT_FUNC(browser)
{
	PyObject *m = NULL;
	PyObject *dep_samba_dcerpc_srvsvc = NULL;
...
#endif
	out:
	Py_XDECREF(dep_samba_dcerpc_srvsvc);
