...
#include "bin/default/librpc/gen_ndr/srvsvc.h"
...
enum ndr_err_code ndr_push_srvsvc_PlatformId(struct ndr_push *ndr, ndr_flags_type ndr_flags, enum srvsvc_PlatformId r);
enum ndr_err_code ndr_pull_srvsvc_PlatformId(struct ndr_pull *ndr, ndr_flags_type ndr_flags, enum srvsvc_PlatformId *r);
void ndr_print_srvsvc_PlatformId(struct ndr_print *ndr, const char *name, enum srvsvc_PlatformId r);
enum ndr_err_code ndr_push_srvsvc_NetSrvInfo100(struct ndr_push *ndr, ndr_flags_type ndr_flags, const struct srvsvc_NetSrvInfo100 *r);
enum ndr_err_code ndr_pull_srvsvc_NetSrvInfo100(struct ndr_pull *ndr, ndr_flags_type ndr_flags, struct srvsvc_NetSrvInfo100 *r);
void ndr_print_srvsvc_NetSrvInfo100(struct ndr_print *ndr, const char *name, const struct srvsvc_NetSrvInfo100 *r);
enum ndr_err_code ndr_push_srvsvc_NetSrvInfo101(struct ndr_push *ndr, ndr_flags_type ndr_flags, const struct srvsvc_NetSrvInfo101 *r);
enum ndr_err_code ndr_pull_srvsvc_NetSrvInfo101(struct ndr_pull *ndr, ndr_flags_type ndr_flags, struct srvsvc_NetSrvInfo101 *r);
...
void ndr_print_srvsvc_NetCharDevEnum(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct srvsvc_NetCharDevEnum *r);
void ndr_print_srvsvc_NetCharDevGetInfo(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct srvsvc_NetCharDevGetInfo *r);
void ndr_print_srvsvc_NetCharDevControl(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct srvsvc_NetCharDevControl *r);
void ndr_print_srvsvc_NetCharDevQEnum(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct srvsvc_NetCharDevQEnum *r);
void ndr_print_srvsvc_NetCharDevQGetInfo(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct srvsvc_NetCharDevQGetInfo *r);
void ndr_print_srvsvc_NetCharDevQSetInfo(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct srvsvc_NetCharDevQSetInfo *r);
void ndr_print_srvsvc_NetCharDevQPurge(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct srvsvc_NetCharDevQPurge *r);
void ndr_print_srvsvc_NetCharDevQPurgeSelf(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct srvsvc_NetCharDevQPurgeSelf *r);
void ndr_print_srvsvc_NetConnEnum(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct srvsvc_NetConnEnum *r);
void ndr_print_srvsvc_NetFileEnum(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct srvsvc_NetFileEnum *r);
void ndr_print_srvsvc_NetFileGetInfo(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct srvsvc_NetFileGetInfo *r);
void ndr_print_srvsvc_NetFileClose(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct srvsvc_NetFileClose *r);
void ndr_print_srvsvc_NetSessEnum(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct srvsvc_NetSessEnum *r);
void ndr_print_srvsvc_NetSessDel(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct srvsvc_NetSessDel *r);
void ndr_print_srvsvc_NetShareAdd(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct srvsvc_NetShareAdd *r);
void ndr_print_srvsvc_NetShareEnumAll(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct srvsvc_NetShareEnumAll *r);
void ndr_print_srvsvc_NetShareGetInfo(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct srvsvc_NetShareGetInfo *r);
void ndr_print_srvsvc_NetShareSetInfo(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct srvsvc_NetShareSetInfo *r);
void ndr_print_srvsvc_NetShareDel(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct srvsvc_NetShareDel *r);
void ndr_print_srvsvc_NetShareDelSticky(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct srvsvc_NetShareDelSticky *r);
void ndr_print_srvsvc_NetShareCheck(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct srvsvc_NetShareCheck *r);
void ndr_print_srvsvc_NetSrvGetInfo(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct srvsvc_NetSrvGetInfo *r);
void ndr_print_srvsvc_NetSrvSetInfo(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct srvsvc_NetSrvSetInfo *r);
void ndr_print_srvsvc_NetDiskEnum(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct srvsvc_NetDiskEnum *r);
void ndr_print_srvsvc_NetServerStatisticsGet(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct srvsvc_NetServerStatisticsGet *r);
void ndr_print_srvsvc_NetTransportAdd(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct srvsvc_NetTransportAdd *r);
void ndr_print_srvsvc_NetTransportEnum(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct srvsvc_NetTransportEnum *r);
void ndr_print_srvsvc_NetTransportDel(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct srvsvc_NetTransportDel *r);
void ndr_print_srvsvc_NetRemoteTOD(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct srvsvc_NetRemoteTOD *r);
void ndr_print_srvsvc_NetSetServiceBits(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct srvsvc_NetSetServiceBits *r);
void ndr_print_srvsvc_NetPathType(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct srvsvc_NetPathType *r);
void ndr_print_srvsvc_NetPathCanonicalize(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct srvsvc_NetPathCanonicalize *r);
void ndr_print_srvsvc_NetPathCompare(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct srvsvc_NetPathCompare *r);
void ndr_print_srvsvc_NetNameValidate(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct srvsvc_NetNameValidate *r);
void ndr_print_srvsvc_NETRPRNAMECANONICALIZE(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct srvsvc_NETRPRNAMECANONICALIZE *r);
void ndr_print_srvsvc_NetPRNameCompare(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct srvsvc_NetPRNameCompare *r);
void ndr_print_srvsvc_NetShareEnum(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct srvsvc_NetShareEnum *r);
void ndr_print_srvsvc_NetShareDelStart(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct srvsvc_NetShareDelStart *r);
void ndr_print_srvsvc_NetShareDelCommit(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct srvsvc_NetShareDelCommit *r);
void ndr_print_srvsvc_NetGetFileSecurity(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct srvsvc_NetGetFileSecurity *r);
void ndr_print_srvsvc_NetSetFileSecurity(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct srvsvc_NetSetFileSecurity *r);
void ndr_print_srvsvc_NetServerTransportAddEx(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct srvsvc_NetServerTransportAddEx *r);
void ndr_print_srvsvc_NetServerSetServiceBitsEx(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct srvsvc_NetServerSetServiceBitsEx *r);
void ndr_print_srvsvc_NETRDFSGETVERSION(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct srvsvc_NETRDFSGETVERSION *r);
void ndr_print_srvsvc_NETRDFSCREATELOCALPARTITION(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct srvsvc_NETRDFSCREATELOCALPARTITION *r);
void ndr_print_srvsvc_NETRDFSDELETELOCALPARTITION(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct srvsvc_NETRDFSDELETELOCALPARTITION *r);
void ndr_print_srvsvc_NETRDFSSETLOCALVOLUMESTATE(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct srvsvc_NETRDFSSETLOCALVOLUMESTATE *r);
void ndr_print_srvsvc_NETRDFSSETSERVERINFO(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct srvsvc_NETRDFSSETSERVERINFO *r);
void ndr_print_srvsvc_NETRDFSCREATEEXITPOINT(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct srvsvc_NETRDFSCREATEEXITPOINT *r);
void ndr_print_srvsvc_NETRDFSDELETEEXITPOINT(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct srvsvc_NETRDFSDELETEEXITPOINT *r);
void ndr_print_srvsvc_NETRDFSMODIFYPREFIX(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct srvsvc_NETRDFSMODIFYPREFIX *r);
void ndr_print_srvsvc_NETRDFSFIXLOCALVOLUME(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct srvsvc_NETRDFSFIXLOCALVOLUME *r);
void ndr_print_srvsvc_NETRDFSMANAGERREPORTSITEINFO(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct srvsvc_NETRDFSMANAGERREPORTSITEINFO *r);
void ndr_print_srvsvc_NETRSERVERTRANSPORTDELEX(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct srvsvc_NETRSERVERTRANSPORTDELEX *r);
