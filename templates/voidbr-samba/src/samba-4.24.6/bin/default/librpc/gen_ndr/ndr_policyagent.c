...
static enum ndr_err_code ndr_push_policyagent_Dummy(struct ndr_push *ndr, ndr_flags_type flags, const struct policyagent_Dummy *r)
{
...
static enum ndr_err_code ndr_pull_policyagent_Dummy(struct ndr_pull *ndr, ndr_flags_type flags, struct policyagent_Dummy *r)
{
...
_PUBLIC_ void ndr_print_policyagent_Dummy(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct policyagent_Dummy *r)
{
...
#ifndef SKIP_NDR_TABLE_policyagent
static const struct ndr_interface_public_struct policyagent_public_structs[] = {
	{ .name = NULL }
};
...
const struct ndr_interface_table ndr_table_policyagent = {
	...
	.public_structs		= policyagent_public_structs,
	.endpoints	= &policyagent_endpoints,
	.authservices	= &policyagent_authservices
};

#endif /* SKIP_NDR_TABLE_policyagent */
