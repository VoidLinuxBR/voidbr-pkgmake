...
static enum ndr_err_code ndr_push_rot_add(struct ndr_push *ndr, ndr_flags_type flags, const struct rot_add *r)
{
...
static enum ndr_err_code ndr_pull_rot_add(struct ndr_pull *ndr, ndr_flags_type flags, struct rot_add *r)
{
	TALLOC_CTX *_mem_save_unk_0 = NULL;
	TALLOC_CTX *_mem_save_moniker_0 = NULL;
	TALLOC_CTX *_mem_save_rotid_0 = NULL;
	...
	if (flags & NDR_IN) {
		...
		NDR_ZERO_STRUCTP(r->out.rotid);
	}
	if (flags & NDR_OUT) {
#ifdef FUZZING_BUILD_MODE_UNSAFE_FOR_PRODUCTION
		if (r->in.unk == NULL) {
			NDR_PULL_ALLOC(ndr, r->in.unk);
			NDR_ZERO_STRUCTP(r->in.unk);
		}
		if (r->in.moniker == NULL) {
			NDR_PULL_ALLOC(ndr, r->in.moniker);
			NDR_ZERO_STRUCTP(r->in.moniker);
		}
...
_PUBLIC_ void ndr_print_rot_add(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct rot_add *r)
{
...
static enum ndr_err_code ndr_push_rot_remove(struct ndr_push *ndr, ndr_flags_type flags, const struct rot_remove *r)
{
	NDR_PUSH_CHECK_FN_FLAGS(ndr, flags);
	if (flags & NDR_IN) {
...
static enum ndr_err_code ndr_pull_rot_remove(struct ndr_pull *ndr, ndr_flags_type flags, struct rot_remove *r)
{
	NDR_PULL_CHECK_FN_FLAGS(ndr, flags);
	if (flags & NDR_IN) {
...
_PUBLIC_ void ndr_print_rot_remove(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct rot_remove *r)
{
...
static enum ndr_err_code ndr_push_rot_is_listed(struct ndr_push *ndr, ndr_flags_type flags, const struct rot_is_listed *r)
{
	NDR_PUSH_CHECK_FN_FLAGS(ndr, flags);
	if (flags & NDR_IN) {
		if (r->in.moniker == NULL) {
...
static enum ndr_err_code ndr_pull_rot_is_listed(struct ndr_pull *ndr, ndr_flags_type flags, struct rot_is_listed *r)
{
	TALLOC_CTX *_mem_save_moniker_0 = NULL;
	NDR_PULL_CHECK_FN_FLAGS(ndr, flags);
	if (flags & NDR_IN) {
...
_PUBLIC_ void ndr_print_rot_is_listed(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct rot_is_listed *r)
{
...
static enum ndr_err_code ndr_push_rot_get_interface_pointer(struct ndr_push *ndr, ndr_flags_type flags, const struct rot_get_interface_pointer *r)
{
	NDR_PUSH_CHECK_FN_FLAGS(ndr, flags);
	if (flags & NDR_IN) {
		if (r->in.moniker == NULL) {
...
static enum ndr_err_code ndr_pull_rot_get_interface_pointer(struct ndr_pull *ndr, ndr_flags_type flags, struct rot_get_interface_pointer *r)
{
	TALLOC_CTX *_mem_save_moniker_0 = NULL;
	TALLOC_CTX *_mem_save_ip_0 = NULL;
	NDR_PULL_CHECK_FN_FLAGS(ndr, flags);
	if (flags & NDR_IN) {
		NDR_ZERO_STRUCT(r->out);
...
_PUBLIC_ void ndr_print_rot_get_interface_pointer(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct rot_get_interface_pointer *r)
{
...
static enum ndr_err_code ndr_push_rot_set_modification_time(struct ndr_push *ndr, ndr_flags_type flags, const struct rot_set_modification_time *r)
{
	NDR_PUSH_CHECK_FN_FLAGS(ndr, flags);
	if (flags & NDR_IN) {
		if (r->in.t == NULL) {
...
static enum ndr_err_code ndr_pull_rot_set_modification_time(struct ndr_pull *ndr, ndr_flags_type flags, struct rot_set_modification_time *r)
{
	TALLOC_CTX *_mem_save_t_0 = NULL;
	NDR_PULL_CHECK_FN_FLAGS(ndr, flags);
	if (flags & NDR_IN) {
		NDR_CHECK(ndr_pull_uint32(ndr, NDR_SCALARS, &r->in.rotid));
		if (ndr->flags & LIBNDR_FLAG_REF_ALLOC) {
...
_PUBLIC_ void ndr_print_rot_set_modification_time(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct rot_set_modification_time *r)
{
...
static enum ndr_err_code ndr_push_rot_get_modification_time(struct ndr_push *ndr, ndr_flags_type flags, const struct rot_get_modification_time *r)
{
	NDR_PUSH_CHECK_FN_FLAGS(ndr, flags);
	if (flags & NDR_IN) {
		if (r->in.moniker == NULL) {
...
static enum ndr_err_code ndr_pull_rot_get_modification_time(struct ndr_pull *ndr, ndr_flags_type flags, struct rot_get_modification_time *r)
{
	TALLOC_CTX *_mem_save_moniker_0 = NULL;
	TALLOC_CTX *_mem_save_t_0 = NULL;
	NDR_PULL_CHECK_FN_FLAGS(ndr, flags);
...
_PUBLIC_ void ndr_print_rot_get_modification_time(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct rot_get_modification_time *r)
{
...
static enum ndr_err_code ndr_push_rot_enum(struct ndr_push *ndr, ndr_flags_type flags, const struct rot_enum *r)
{
	NDR_PUSH_CHECK_FN_FLAGS(ndr, flags);
	if (flags & NDR_IN) {
	}
...
static enum ndr_err_code ndr_pull_rot_enum(struct ndr_pull *ndr, ndr_flags_type flags, struct rot_enum *r)
{
	TALLOC_CTX *_mem_save_EnumMoniker_0 = NULL;
	NDR_PULL_CHECK_FN_FLAGS(ndr, flags);
	if (flags & NDR_IN) {
		NDR_ZERO_STRUCT(r->out);

		NDR_PULL_ALLOC(ndr, r->out.EnumMoniker);
		NDR_ZERO_STRUCTP(r->out.EnumMoniker);
	}
	if (flags & NDR_OUT) {
#ifdef FUZZING_BUILD_MODE_UNSAFE_FOR_PRODUCTION
#endif /* FUZZING_BUILD_MODE_UNSAFE_FOR_PRODUCTION */
...
_PUBLIC_ void ndr_print_rot_enum(struct ndr_print *ndr, const char *name, ndr_flags_type flags, const struct rot_enum *r)
{
...
#ifndef SKIP_NDR_TABLE_rot
static const struct ndr_interface_public_struct rot_public_structs[] = {
	{ .name = NULL }
};
...
const struct ndr_interface_table ndr_table_rot = {
	...
	.public_structs		= rot_public_structs,
	.endpoints	= &rot_endpoints,
	.authservices	= &rot_authservices
};

#endif /* SKIP_NDR_TABLE_rot */
