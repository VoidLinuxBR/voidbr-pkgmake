...
_PUBLIC_ enum ndr_err_code ndr_push_file_id(struct ndr_push *ndr, ndr_flags_type ndr_flags, const struct file_id *r)
{
...
_PUBLIC_ enum ndr_err_code ndr_pull_file_id(struct ndr_pull *ndr, ndr_flags_type ndr_flags, struct file_id *r)
{
...
static void ndr_print_flags_file_id(struct ndr_print *ndr, const char *name, ndr_flags_type unused, const struct file_id *r)
{
