...
MODULE_INIT_FUNC(werror)
{
	...
	PyModule_AddObject(m, "WERR_PRINTER_NOT_SHAREABLE",
                  		PyLong_FromUnsignedLongLong(W_ERROR_V(WERR_PRINTER_NOT_SHAREABLE)));
	...
	PyModule_AddObject(m, "WERR_DS_DRA_RECYCLED_TARGET",
                  		PyLong_FromUnsignedLongLong(W_ERROR_V(WERR_DS_DRA_RECYCLED_TARGET)));
