...
pub const NT_STATUS_PRIMARY_TRANSPORT_CONNECT_FAILED: NTSTATUS = NTSTATUS(0x10e);
...
pub const NT_STATUS_FSFILTER_OP_COMPLETED_SUCCESSFULLY: NTSTATUS = NTSTATUS(0x126);
pub const NT_STATUS_INTERRUPT_VECTOR_ALREADY_CONNECTED: NTSTATUS = NTSTATUS(0x127);
...
pub const NT_STATUS_CALLBACK_RETURNED_THREAD_AFFINITY: NTSTATUS = NTSTATUS(0xc0000721);
...
pub const NT_STATUS_FT_READ_RECOVERY_FROM_BACKUP: NTSTATUS = NTSTATUS(0x4000000a);
...
pub const NT_STATUS_IMAGE_MACHINE_TYPE_MISMATCH: NTSTATUS = NTSTATUS(0x4000000e);
...
pub const NT_STATUS_IMAGE_MACHINE_TYPE_MISMATCH_EXE: NTSTATUS = NTSTATUS(0x40000023);
...
pub const NT_STATUS_DRIVERS_LEAKING_LOCKED_PAGES: NTSTATUS = NTSTATUS(0x4000002d);
pub const NT_STATUS_MESSAGE_RETRIEVED: NTSTATUS = NTSTATUS(0x4000002e);
pub const NT_STATUS_SYSTEM_POWERSTATE_TRANSITION: NTSTATUS = NTSTATUS(0x4000002f);
pub const NT_STATUS_ALPC_CHECK_COMPLETION_LIST: NTSTATUS = NTSTATUS(0x40000030);
pub const NT_STATUS_SYSTEM_POWERSTATE_COMPLEX_TRANSITION: NTSTATUS = NTSTATUS(0x40000031);
...
pub const NT_STATUS_DBG_UNABLE_TO_PROVIDE_HANDLE: NTSTATUS = NTSTATUS(0x40010002);
...
pub const NT_STATUS_SXS_RELEASE_ACTIVATION_CONTEXT: NTSTATUS = NTSTATUS(0x4015000d);
...
pub const NT_STATUS_VIDEO_DRIVER_DEBUG_REPORT_REQUEST: NTSTATUS = NTSTATUS(0x401b00ec);
pub const NT_STATUS_GRAPHICS_PARTIAL_DATA_POPULATED: NTSTATUS = NTSTATUS(0x401e000a);
...
pub const NT_STATUS_GRAPHICS_NO_MORE_ELEMENTS_IN_DATASET: NTSTATUS = NTSTATUS(0x401e034c);
pub const NT_STATUS_GRAPHICS_PATH_CONTENT_GEOMETRY_TRANSFORMATION_NOT_PINNED: NTSTATUS = NTSTATUS(0x401e0351);
pub const NT_STATUS_GRAPHICS_UNKNOWN_CHILD_STATUS: NTSTATUS = NTSTATUS(0x401e042f);
pub const NT_STATUS_GRAPHICS_LEADLINK_START_DEFERRED: NTSTATUS = NTSTATUS(0x401e0437);
pub const NT_STATUS_GRAPHICS_POLLING_TOO_FREQUENTLY: NTSTATUS = NTSTATUS(0x401e0439);
...
pub const NT_STATUS_REDIRECTOR_HAS_OPEN_HANDLES: NTSTATUS = NTSTATUS(0x80000023);
...
pub const NT_STATUS_CLEANER_CARTRIDGE_INSTALLED: NTSTATUS = NTSTATUS(0x80000027);
...
pub const NT_STATUS_CLUSTER_NETWORK_ALREADY_ONLINE: NTSTATUS = NTSTATUS(0x80130003);
pub const NT_STATUS_CLUSTER_NETWORK_ALREADY_OFFLINE: NTSTATUS = NTSTATUS(0x80130004);
pub const NT_STATUS_CLUSTER_NODE_ALREADY_MEMBER: NTSTATUS = NTSTATUS(0x80130005);
...
pub const NT_STATUS_CANT_RECOVER_WITH_HANDLE_OPEN: NTSTATUS = NTSTATUS(0x80190031);
pub const NT_STATUS_TXF_METADATA_ALREADY_PRESENT: NTSTATUS = NTSTATUS(0x80190041);
pub const NT_STATUS_TRANSACTION_SCOPE_CALLBACKS_NOT_SET: NTSTATUS = NTSTATUS(0x80190042);
pub const NT_STATUS_VIDEO_HUNG_DISPLAY_DRIVER_THREAD_RECOVERED: NTSTATUS = NTSTATUS(0x801b00eb);
...
pub const NT_STATUS_NT_CROSS_ENCRYPTION_REQUIRED: NTSTATUS = NTSTATUS(0xc000015d);
...
pub const NT_STATUS_BIOS_FAILED_TO_CONNECT_INTERRUPT: NTSTATUS = NTSTATUS(0xc000016e);
...
pub const NT_STATUS_LM_CROSS_ENCRYPTION_REQUIRED: NTSTATUS = NTSTATUS(0xc000017f);
...
pub const NT_STATUS_TRUSTED_RELATIONSHIP_FAILURE: NTSTATUS = NTSTATUS(0xc000018d);
...
pub const NT_STATUS_NETWORK_CREDENTIAL_CONFLICT: NTSTATUS = NTSTATUS(0xc0000195);
...
pub const NT_STATUS_NOLOGON_INTERDOMAIN_TRUST_ACCOUNT: NTSTATUS = NTSTATUS(0xc0000198);
pub const NT_STATUS_NOLOGON_WORKSTATION_TRUST_ACCOUNT: NTSTATUS = NTSTATUS(0xc0000199);
pub const NT_STATUS_NOLOGON_SERVER_TRUST_ACCOUNT: NTSTATUS = NTSTATUS(0xc000019a);
...
pub const NT_STATUS_IMAGE_ALREADY_LOADED_AS_DLL: NTSTATUS = NTSTATUS(0xc000019d);
pub const NT_STATUS_INCOMPATIBLE_WITH_GLOBAL_SHORT_NAME_REGISTRY_SETTING: NTSTATUS = NTSTATUS(0xc000019e);
pub const NT_STATUS_SHORT_NAMES_NOT_ENABLED_ON_VOLUME: NTSTATUS = NTSTATUS(0xc000019f);
pub const NT_STATUS_SECURITY_STREAM_IS_INCONSISTENT: NTSTATUS = NTSTATUS(0xc00001a0);
...
pub const NT_STATUS_IMAGE_SUBSYSTEM_NOT_PRESENT: NTSTATUS = NTSTATUS(0xc00001a3);
pub const NT_STATUS_NOTIFICATION_GUID_ALREADY_DEFINED: NTSTATUS = NTSTATUS(0xc00001a4);
...
pub const NT_STATUS_CLIENT_SERVER_PARAMETERS_INVALID: NTSTATUS = NTSTATUS(0xc0000223);
...
pub const NT_STATUS_DOMAIN_CONTROLLER_NOT_FOUND: NTSTATUS = NTSTATUS(0xc0000233);
...
pub const NT_STATUS_INVALID_PLUGPLAY_DEVICE_PATH: NTSTATUS = NTSTATUS(0xc0000261);
pub const NT_STATUS_DRIVER_ORDINAL_NOT_FOUND: NTSTATUS = NTSTATUS(0xc0000262);
pub const NT_STATUS_DRIVER_ENTRYPOINT_NOT_FOUND: NTSTATUS = NTSTATUS(0xc0000263);
...
pub const NT_STATUS_DIRECTORY_IS_A_REPARSE_POINT: NTSTATUS = NTSTATUS(0xc0000281);
...
pub const NT_STATUS_DS_INVALID_ATTRIBUTE_SYNTAX: NTSTATUS = NTSTATUS(0xc00002a2);
pub const NT_STATUS_DS_ATTRIBUTE_TYPE_UNDEFINED: NTSTATUS = NTSTATUS(0xc00002a3);
pub const NT_STATUS_DS_ATTRIBUTE_OR_VALUE_EXISTS: NTSTATUS = NTSTATUS(0xc00002a4);
...
pub const NT_STATUS_MUTUAL_AUTHENTICATION_FAILED: NTSTATUS = NTSTATUS(0xc00002c3);
pub const NT_STATUS_CORRUPT_SYSTEM_FILE: NTSTATUS = NTSTATUS(0xc00002c4);
pub const NT_STATUS_DATATYPE_MISALIGNMENT_ERROR: NTSTATUS = NTSTATUS(0xc00002c5);
...
pub const NT_STATUS_DS_SENSITIVE_GROUP_VIOLATION: NTSTATUS = NTSTATUS(0xc00002cd);
...
pub const NT_STATUS_DS_NO_NEST_GLOBALGROUP_IN_MIXEDDOMAIN: NTSTATUS = NTSTATUS(0xc00002d5);
pub const NT_STATUS_DS_NO_NEST_LOCALGROUP_IN_MIXEDDOMAIN: NTSTATUS = NTSTATUS(0xc00002d6);
pub const NT_STATUS_DS_GLOBAL_CANT_HAVE_LOCAL_MEMBER: NTSTATUS = NTSTATUS(0xc00002d7);
pub const NT_STATUS_DS_GLOBAL_CANT_HAVE_UNIVERSAL_MEMBER: NTSTATUS = NTSTATUS(0xc00002d8);
pub const NT_STATUS_DS_UNIVERSAL_CANT_HAVE_LOCAL_MEMBER: NTSTATUS = NTSTATUS(0xc00002d9);
pub const NT_STATUS_DS_GLOBAL_CANT_HAVE_CROSSDOMAIN_MEMBER: NTSTATUS = NTSTATUS(0xc00002da);
pub const NT_STATUS_DS_LOCAL_CANT_HAVE_CROSSDOMAIN_LOCAL_MEMBER: NTSTATUS = NTSTATUS(0xc00002db);
...
pub const NT_STATUS_DS_LOCAL_MEMBER_OF_LOCAL_ONLY: NTSTATUS = NTSTATUS(0xc00002e5);
pub const NT_STATUS_DS_NO_FPO_IN_UNIVERSAL_GROUPS: NTSTATUS = NTSTATUS(0xc00002e6);
pub const NT_STATUS_DS_MACHINE_ACCOUNT_QUOTA_EXCEEDED: NTSTATUS = NTSTATUS(0xc00002e7);
...
pub const NT_STATUS_DS_SAM_INIT_FAILURE_CONSOLE: NTSTATUS = NTSTATUS(0xc00002ed);
...
pub const NT_STATUS_STRONG_CRYPTO_NOT_SUPPORTED: NTSTATUS = NTSTATUS(0xc00002f6);
...
pub const NT_STATUS_SERVER_SHUTDOWN_IN_PROGRESS: NTSTATUS = NTSTATUS(0xc00002ff);
...
pub const NT_STATUS_SMARTCARD_SUBSYSTEM_FAILURE: NTSTATUS = NTSTATUS(0xc0000321);
...
pub const NT_STATUS_DS_AG_CANT_HAVE_UNIVERSAL_MEMBER: NTSTATUS = NTSTATUS(0xc0000358);
...
pub const NT_STATUS_ACCESS_DISABLED_BY_POLICY_DEFAULT: NTSTATUS = NTSTATUS(0xc0000361);
pub const NT_STATUS_ACCESS_DISABLED_BY_POLICY_PATH: NTSTATUS = NTSTATUS(0xc0000362);
pub const NT_STATUS_ACCESS_DISABLED_BY_POLICY_PUBLISHER: NTSTATUS = NTSTATUS(0xc0000363);
pub const NT_STATUS_ACCESS_DISABLED_BY_POLICY_OTHER: NTSTATUS = NTSTATUS(0xc0000364);
...
pub const NT_STATUS_INVALID_DEVICE_OBJECT_PARAMETER: NTSTATUS = NTSTATUS(0xc0000369);
...
pub const NT_STATUS_ACCESS_DISABLED_NO_SAFER_UI_BY_POLICY: NTSTATUS = NTSTATUS(0xc0000372);
...
pub const NT_STATUS_SMARTCARD_CARD_NOT_AUTHENTICATED: NTSTATUS = NTSTATUS(0xc0000382);
...
pub const NT_STATUS_PER_USER_TRUST_QUOTA_EXCEEDED: NTSTATUS = NTSTATUS(0xc0000401);
pub const NT_STATUS_ALL_USER_TRUST_QUOTA_EXCEEDED: NTSTATUS = NTSTATUS(0xc0000402);
pub const NT_STATUS_USER_DELETE_TRUST_QUOTA_EXCEEDED: NTSTATUS = NTSTATUS(0xc0000403);
...
pub const NT_STATUS_CROSSREALM_DELEGATION_FAILURE: NTSTATUS = NTSTATUS(0xc000040b);
...
pub const NT_STATUS_AUTHENTICATION_FIREWALL_FAILED: NTSTATUS = NTSTATUS(0xc0000413);
...
pub const NT_STATUS_INSUFFICIENT_RESOURCE_FOR_SPECIFIED_SHARED_SECTION_SIZE: NTSTATUS = NTSTATUS(0xc0000416);
...
pub const NT_STATUS_DS_SRC_SID_EXISTS_IN_FOREST: NTSTATUS = NTSTATUS(0xc0000419);
pub const NT_STATUS_DS_DOMAIN_NAME_EXISTS_IN_FOREST: NTSTATUS = NTSTATUS(0xc000041a);
pub const NT_STATUS_DS_FLAT_NAME_EXISTS_IN_FOREST: NTSTATUS = NTSTATUS(0xc000041b);
pub const NT_STATUS_INVALID_USER_PRINCIPAL_NAME: NTSTATUS = NTSTATUS(0xc000041c);
...
pub const NT_STATUS_INCOMPATIBLE_DRIVER_BLOCKED: NTSTATUS = NTSTATUS(0xc0000424);
...
pub const NT_STATUS_ENCOUNTERED_WRITE_IN_PROGRESS: NTSTATUS = NTSTATUS(0xc0000433);
...
pub const NT_STATUS_CS_ENCRYPTION_INVALID_SERVER_RESPONSE: NTSTATUS = NTSTATUS(0xc0000441);
pub const NT_STATUS_CS_ENCRYPTION_UNSUPPORTED_SERVER: NTSTATUS = NTSTATUS(0xc0000442);
pub const NT_STATUS_CS_ENCRYPTION_EXISTING_ENCRYPTED_FILE: NTSTATUS = NTSTATUS(0xc0000443);
pub const NT_STATUS_CS_ENCRYPTION_NEW_ENCRYPTED_FILE: NTSTATUS = NTSTATUS(0xc0000444);
...
pub const NT_STATUS_INSUFFICIENT_NVRAM_RESOURCES: NTSTATUS = NTSTATUS(0xc0000454);
pub const NT_STATUS_NO_RANGES_PROCESSED: NTSTATUS = NTSTATUS(0xc0000460);
pub const NT_STATUS_DEVICE_FEATURE_NOT_SUPPORTED: NTSTATUS = NTSTATUS(0xc0000463);
...
pub const NT_STATUS_LPC_RECEIVE_BUFFER_EXPECTED: NTSTATUS = NTSTATUS(0xc0000705);
pub const NT_STATUS_LPC_INVALID_CONNECTION_USAGE: NTSTATUS = NTSTATUS(0xc0000706);
...
pub const NT_STATUS_THREADPOOL_HANDLE_EXCEPTION: NTSTATUS = NTSTATUS(0xc000070a);
pub const NT_STATUS_THREADPOOL_SET_EVENT_ON_COMPLETION_FAILED: NTSTATUS = NTSTATUS(0xc000070b);
pub const NT_STATUS_THREADPOOL_RELEASE_SEMAPHORE_ON_COMPLETION_FAILED: NTSTATUS = NTSTATUS(0xc000070c);
pub const NT_STATUS_THREADPOOL_RELEASE_MUTEX_ON_COMPLETION_FAILED: NTSTATUS = NTSTATUS(0xc000070d);
pub const NT_STATUS_THREADPOOL_FREE_LIBRARY_ON_COMPLETION_FAILED: NTSTATUS = NTSTATUS(0xc000070e);
pub const NT_STATUS_THREADPOOL_RELEASED_DURING_OPERATION: NTSTATUS = NTSTATUS(0xc000070f);
pub const NT_STATUS_CALLBACK_RETURNED_WHILE_IMPERSONATING: NTSTATUS = NTSTATUS(0xc0000710);
pub const NT_STATUS_APC_RETURNED_WHILE_IMPERSONATING: NTSTATUS = NTSTATUS(0xc0000711);
...
pub const NT_STATUS_CERTIFICATE_MAPPING_NOT_UNIQUE: NTSTATUS = NTSTATUS(0xc0000714);
...
pub const NT_STATUS_PORT_ALREADY_HAS_COMPLETION_LIST: NTSTATUS = NTSTATUS(0xc000071a);
pub const NT_STATUS_CALLBACK_RETURNED_THREAD_PRIORITY: NTSTATUS = NTSTATUS(0xc000071b);
pub const NT_STATUS_INVALID_THREAD: NTSTATUS = NTSTATUS(0xc000071c);
pub const NT_STATUS_CALLBACK_RETURNED_TRANSACTION: NTSTATUS = NTSTATUS(0xc000071d);
...
pub const NT_STATUS_DS_DOMAIN_RENAME_IN_PROGRESS: NTSTATUS = NTSTATUS(0xc0000801);
...
pub const NT_STATUS_LOST_WRITEBEHIND_DATA_NETWORK_DISCONNECTED: NTSTATUS = NTSTATUS(0xc000a080);
pub const NT_STATUS_LOST_WRITEBEHIND_DATA_NETWORK_SERVER_ERROR: NTSTATUS = NTSTATUS(0xc000a081);
pub const NT_STATUS_LOST_WRITEBEHIND_DATA_LOCAL_DISK_ERROR: NTSTATUS = NTSTATUS(0xc000a082);
...
pub const NT_STATUS_DS_OID_MAPPED_GROUP_CANT_HAVE_MEMBERS: NTSTATUS = NTSTATUS(0xc000a087);
...
pub const NT_STATUS_OFFLOAD_READ_FLT_NOT_SUPPORTED: NTSTATUS = NTSTATUS(0xc000a2a1);
pub const NT_STATUS_OFFLOAD_WRITE_FLT_NOT_SUPPORTED: NTSTATUS = NTSTATUS(0xc000a2a2);
pub const NT_STATUS_OFFLOAD_READ_FILE_NOT_SUPPORTED: NTSTATUS = NTSTATUS(0xc000a2a3);
pub const NT_STATUS_OFFLOAD_WRITE_FILE_NOT_SUPPORTED: NTSTATUS = NTSTATUS(0xc000a2a4);
...
pub const NT_STATUS_RPC_INVALID_ENDPOINT_FORMAT: NTSTATUS = NTSTATUS(0xc0020007);
...
pub const NT_STATUS_RPC_TYPE_ALREADY_REGISTERED: NTSTATUS = NTSTATUS(0xc002000d);
...
pub const NT_STATUS_RPC_INVALID_NETWORK_OPTIONS: NTSTATUS = NTSTATUS(0xc0020019);
...
pub const NT_STATUS_RPC_UNSUPPORTED_NAME_SYNTAX: NTSTATUS = NTSTATUS(0xc0020026);
...
pub const NT_STATUS_RPC_NOT_ALL_OBJS_UNEXPORTED: NTSTATUS = NTSTATUS(0xc002003b);
...
pub const NT_STATUS_RPC_NAME_SERVICE_UNAVAILABLE: NTSTATUS = NTSTATUS(0xc002003f);
...
pub const NT_STATUS_RPC_UNSUPPORTED_AUTHN_LEVEL: NTSTATUS = NTSTATUS(0xc0020053);
...
pub const NT_STATUS_RPC_SS_CHAR_TRANS_OPEN_FAIL: NTSTATUS = NTSTATUS(0xc0030002);
pub const NT_STATUS_RPC_SS_CHAR_TRANS_SHORT_FILE: NTSTATUS = NTSTATUS(0xc0030003);
...
pub const NT_STATUS_RPC_SS_CANNOT_GET_CALL_HANDLE: NTSTATUS = NTSTATUS(0xc0030008);
pub const NT_STATUS_RPC_NULL_REF_POINTER: NTSTATUS = NTSTATUS(0xc0030009);
pub const NT_STATUS_RPC_ENUM_VALUE_OUT_OF_RANGE: NTSTATUS = NTSTATUS(0xc003000a);
...
pub const NT_STATUS_CTX_WINSTATION_NAME_INVALID: NTSTATUS = NTSTATUS(0xc00a0001);
...
pub const NT_STATUS_CTX_MODEM_RESPONSE_NO_CARRIER: NTSTATUS = NTSTATUS(0xc00a000c);
pub const NT_STATUS_CTX_MODEM_RESPONSE_NO_DIALTONE: NTSTATUS = NTSTATUS(0xc00a000d);
...
pub const NT_STATUS_CTX_WINSTATION_NAME_COLLISION: NTSTATUS = NTSTATUS(0xc00a0016);
...
pub const NT_STATUS_CTX_WINSTATION_ACCESS_DENIED: NTSTATUS = NTSTATUS(0xc00a002b);
...
pub const NT_STATUS_CTX_SHADOW_ENDED_BY_MODE_CHANGE: NTSTATUS = NTSTATUS(0xc00a0035);
...
pub const NT_STATUS_MUI_INVALID_ULTIMATEFALLBACK_NAME: NTSTATUS = NTSTATUS(0xc00b0005);
...
pub const NT_STATUS_CLUSTER_LOCAL_NODE_NOT_FOUND: NTSTATUS = NTSTATUS(0xc0130005);
...
pub const NT_STATUS_CLUSTER_NETINTERFACE_EXISTS: NTSTATUS = NTSTATUS(0xc0130008);
pub const NT_STATUS_CLUSTER_NETINTERFACE_NOT_FOUND: NTSTATUS = NTSTATUS(0xc0130009);
pub const NT_STATUS_CLUSTER_INVALID_REQUEST: NTSTATUS = NTSTATUS(0xc013000a);
pub const NT_STATUS_CLUSTER_INVALID_NETWORK_PROVIDER: NTSTATUS = NTSTATUS(0xc013000b);
...
pub const NT_STATUS_CLUSTER_JOIN_NOT_IN_PROGRESS: NTSTATUS = NTSTATUS(0xc013000f);
...
pub const NT_STATUS_CLUSTER_NO_SECURITY_CONTEXT: NTSTATUS = NTSTATUS(0xc0130015);
pub const NT_STATUS_CLUSTER_NETWORK_NOT_INTERNAL: NTSTATUS = NTSTATUS(0xc0130016);
...
pub const NT_STATUS_ACPI_INCORRECT_ARGUMENT_COUNT: NTSTATUS = NTSTATUS(0xc014000b);
...
pub const NT_STATUS_SXS_INVALID_ACTCTXDATA_FORMAT: NTSTATUS = NTSTATUS(0xc0150003);
...
pub const NT_STATUS_SXS_ACTIVATION_CONTEXT_DISABLED: NTSTATUS = NTSTATUS(0xc0150007);
...
pub const NT_STATUS_SXS_THREAD_QUERIES_DISABLED: NTSTATUS = NTSTATUS(0xc015000b);
pub const NT_STATUS_SXS_ASSEMBLY_MISSING: NTSTATUS = NTSTATUS(0xc015000c);
pub const NT_STATUS_SXS_PROCESS_DEFAULT_ALREADY_SET: NTSTATUS = NTSTATUS(0xc015000e);
...
pub const NT_STATUS_SXS_SYSTEM_DEFAULT_ACTIVATION_CONTEXT_EMPTY: NTSTATUS = NTSTATUS(0xc0150012);
pub const NT_STATUS_SXS_PROCESS_TERMINATION_REQUESTED: NTSTATUS = NTSTATUS(0xc0150013);
pub const NT_STATUS_SXS_CORRUPT_ACTIVATION_STACK: NTSTATUS = NTSTATUS(0xc0150014);
pub const NT_STATUS_SXS_CORRUPTION: NTSTATUS = NTSTATUS(0xc0150015);
pub const NT_STATUS_SXS_INVALID_IDENTITY_ATTRIBUTE_VALUE: NTSTATUS = NTSTATUS(0xc0150016);
pub const NT_STATUS_SXS_INVALID_IDENTITY_ATTRIBUTE_NAME: NTSTATUS = NTSTATUS(0xc0150017);
pub const NT_STATUS_SXS_IDENTITY_DUPLICATE_ATTRIBUTE: NTSTATUS = NTSTATUS(0xc0150018);
pub const NT_STATUS_SXS_IDENTITY_PARSE_ERROR: NTSTATUS = NTSTATUS(0xc0150019);
pub const NT_STATUS_SXS_COMPONENT_STORE_CORRUPT: NTSTATUS = NTSTATUS(0xc015001a);
pub const NT_STATUS_SXS_FILE_HASH_MISMATCH: NTSTATUS = NTSTATUS(0xc015001b);
pub const NT_STATUS_SXS_MANIFEST_IDENTITY_SAME_BUT_CONTENTS_DIFFERENT: NTSTATUS = NTSTATUS(0xc015001c);
pub const NT_STATUS_SXS_IDENTITIES_DIFFERENT: NTSTATUS = NTSTATUS(0xc015001d);
pub const NT_STATUS_SXS_ASSEMBLY_IS_NOT_A_DEPLOYMENT: NTSTATUS = NTSTATUS(0xc015001e);
pub const NT_STATUS_SXS_FILE_NOT_PART_OF_ASSEMBLY: NTSTATUS = NTSTATUS(0xc015001f);
...
pub const NT_STATUS_SXS_TRANSACTION_CLOSURE_INCOMPLETE: NTSTATUS = NTSTATUS(0xc0150024);
pub const NT_STATUS_SMI_PRIMITIVE_INSTALLER_FAILED: NTSTATUS = NTSTATUS(0xc0150025);
...
pub const NT_STATUS_TRANSACTIONS_UNSUPPORTED_REMOTE: NTSTATUS = NTSTATUS(0xc019000a);
pub const NT_STATUS_LOG_RESIZE_INVALID_SIZE: NTSTATUS = NTSTATUS(0xc019000b);
pub const NT_STATUS_REMOTE_FILE_VERSION_MISMATCH: NTSTATUS = NTSTATUS(0xc019000c);
pub const NT_STATUS_CRM_PROTOCOL_ALREADY_EXISTS: NTSTATUS = NTSTATUS(0xc019000f);
pub const NT_STATUS_TRANSACTION_PROPAGATION_FAILED: NTSTATUS = NTSTATUS(0xc0190010);
pub const NT_STATUS_CRM_PROTOCOL_NOT_FOUND: NTSTATUS = NTSTATUS(0xc0190011);
pub const NT_STATUS_TRANSACTION_SUPERIOR_EXISTS: NTSTATUS = NTSTATUS(0xc0190012);
pub const NT_STATUS_TRANSACTION_REQUEST_NOT_VALID: NTSTATUS = NTSTATUS(0xc0190013);
pub const NT_STATUS_TRANSACTION_NOT_REQUESTED: NTSTATUS = NTSTATUS(0xc0190014);
pub const NT_STATUS_TRANSACTION_ALREADY_ABORTED: NTSTATUS = NTSTATUS(0xc0190015);
pub const NT_STATUS_TRANSACTION_ALREADY_COMMITTED: NTSTATUS = NTSTATUS(0xc0190016);
pub const NT_STATUS_TRANSACTION_INVALID_MARSHALL_BUFFER: NTSTATUS = NTSTATUS(0xc0190017);
pub const NT_STATUS_CURRENT_TRANSACTION_NOT_VALID: NTSTATUS = NTSTATUS(0xc0190018);
...
pub const NT_STATUS_STREAM_MINIVERSION_NOT_FOUND: NTSTATUS = NTSTATUS(0xc0190022);
pub const NT_STATUS_STREAM_MINIVERSION_NOT_VALID: NTSTATUS = NTSTATUS(0xc0190023);
pub const NT_STATUS_MINIVERSION_INACCESSIBLE_FROM_SPECIFIED_TRANSACTION: NTSTATUS = NTSTATUS(0xc0190024);
pub const NT_STATUS_CANT_OPEN_MINIVERSION_WITH_MODIFY_INTENT: NTSTATUS = NTSTATUS(0xc0190025);
pub const NT_STATUS_CANT_CREATE_MORE_STREAM_MINIVERSIONS: NTSTATUS = NTSTATUS(0xc0190026);
...
pub const NT_STATUS_FILE_IDENTITY_NOT_PERSISTENT: NTSTATUS = NTSTATUS(0xc0190036);
pub const NT_STATUS_CANT_BREAK_TRANSACTIONAL_DEPENDENCY: NTSTATUS = NTSTATUS(0xc0190037);
...
pub const NT_STATUS_EFS_NOT_ALLOWED_IN_TRANSACTION: NTSTATUS = NTSTATUS(0xc019003e);
pub const NT_STATUS_TRANSACTIONAL_OPEN_NOT_ALLOWED: NTSTATUS = NTSTATUS(0xc019003f);
pub const NT_STATUS_TRANSACTED_MAPPING_UNSUPPORTED_REMOTE: NTSTATUS = NTSTATUS(0xc0190040);
pub const NT_STATUS_TRANSACTION_REQUIRED_PROMOTION: NTSTATUS = NTSTATUS(0xc0190043);
pub const NT_STATUS_CANNOT_EXECUTE_FILE_IN_TRANSACTION: NTSTATUS = NTSTATUS(0xc0190044);
pub const NT_STATUS_TRANSACTIONS_NOT_FROZEN: NTSTATUS = NTSTATUS(0xc0190045);
pub const NT_STATUS_TRANSACTION_FREEZE_IN_PROGRESS: NTSTATUS = NTSTATUS(0xc0190046);
pub const NT_STATUS_NOT_SNAPSHOT_VOLUME: NTSTATUS = NTSTATUS(0xc0190047);
pub const NT_STATUS_NO_SAVEPOINT_WITH_OPEN_FILES: NTSTATUS = NTSTATUS(0xc0190048);
pub const NT_STATUS_SPARSE_NOT_ALLOWED_IN_TRANSACTION: NTSTATUS = NTSTATUS(0xc0190049);
...
pub const NT_STATUS_CANNOT_ACCEPT_TRANSACTED_WORK: NTSTATUS = NTSTATUS(0xc019004c);
...
pub const NT_STATUS_TRANSACTIONMANAGER_NOT_FOUND: NTSTATUS = NTSTATUS(0xc0190051);
pub const NT_STATUS_TRANSACTIONMANAGER_NOT_ONLINE: NTSTATUS = NTSTATUS(0xc0190052);
pub const NT_STATUS_TRANSACTIONMANAGER_RECOVERY_NAME_COLLISION: NTSTATUS = NTSTATUS(0xc0190053);
...
pub const NT_STATUS_COMPRESSION_NOT_ALLOWED_IN_TRANSACTION: NTSTATUS = NTSTATUS(0xc0190056);
pub const NT_STATUS_TRANSACTION_RESPONSE_NOT_ENLISTED: NTSTATUS = NTSTATUS(0xc0190057);
pub const NT_STATUS_TRANSACTION_RECORD_TOO_LONG: NTSTATUS = NTSTATUS(0xc0190058);
pub const NT_STATUS_NO_LINK_TRACKING_IN_TRANSACTION: NTSTATUS = NTSTATUS(0xc0190059);
pub const NT_STATUS_OPERATION_NOT_SUPPORTED_IN_TRANSACTION: NTSTATUS = NTSTATUS(0xc019005a);
pub const NT_STATUS_TRANSACTION_INTEGRITY_VIOLATED: NTSTATUS = NTSTATUS(0xc019005b);
...
pub const NT_STATUS_LOG_CONTAINER_LIMIT_EXCEEDED: NTSTATUS = NTSTATUS(0xc01a0012);
pub const NT_STATUS_LOG_START_OF_LOG: NTSTATUS = NTSTATUS(0xc01a0013);
pub const NT_STATUS_LOG_POLICY_ALREADY_INSTALLED: NTSTATUS = NTSTATUS(0xc01a0014);
...
pub const NT_STATUS_LOG_RECORDS_RESERVED_INVALID: NTSTATUS = NTSTATUS(0xc01a001a);
...
pub const NT_STATUS_LOG_ARCHIVE_NOT_IN_PROGRESS: NTSTATUS = NTSTATUS(0xc01a0020);
...
pub const NT_STATUS_LOG_CLIENT_ALREADY_REGISTERED: NTSTATUS = NTSTATUS(0xc01a0024);
pub const NT_STATUS_LOG_CLIENT_NOT_REGISTERED: NTSTATUS = NTSTATUS(0xc01a0025);
pub const NT_STATUS_LOG_FULL_HANDLER_IN_PROGRESS: NTSTATUS = NTSTATUS(0xc01a0026);
...
pub const NT_STATUS_LOG_CONTAINER_STATE_INVALID: NTSTATUS = NTSTATUS(0xc01a002a);
...
pub const NT_STATUS_VIDEO_HUNG_DISPLAY_DRIVER_THREAD: NTSTATUS = NTSTATUS(0xc01b00ea);
pub const NT_STATUS_FLT_NO_HANDLER_DEFINED: NTSTATUS = NTSTATUS(0xc01c0001);
pub const NT_STATUS_FLT_CONTEXT_ALREADY_DEFINED: NTSTATUS = NTSTATUS(0xc01c0002);
pub const NT_STATUS_FLT_INVALID_ASYNCHRONOUS_REQUEST: NTSTATUS = NTSTATUS(0xc01c0003);
...
pub const NT_STATUS_FLT_NOT_SAFE_TO_POST_OPERATION: NTSTATUS = NTSTATUS(0xc01c0006);
...
pub const NT_STATUS_FLT_INSTANCE_ALTITUDE_COLLISION: NTSTATUS = NTSTATUS(0xc01c0011);
pub const NT_STATUS_FLT_INSTANCE_NAME_COLLISION: NTSTATUS = NTSTATUS(0xc01c0012);
...
pub const NT_STATUS_FLT_CONTEXT_ALLOCATION_NOT_FOUND: NTSTATUS = NTSTATUS(0xc01c0016);
pub const NT_STATUS_FLT_INVALID_CONTEXT_REGISTRATION: NTSTATUS = NTSTATUS(0xc01c0017);
...
pub const NT_STATUS_MONITOR_UNKNOWN_DESCRIPTOR_FORMAT: NTSTATUS = NTSTATUS(0xc01d0002);
pub const NT_STATUS_MONITOR_INVALID_DESCRIPTOR_CHECKSUM: NTSTATUS = NTSTATUS(0xc01d0003);
pub const NT_STATUS_MONITOR_INVALID_STANDARD_TIMING_BLOCK: NTSTATUS = NTSTATUS(0xc01d0004);
pub const NT_STATUS_MONITOR_WMI_DATABLOCK_REGISTRATION_FAILED: NTSTATUS = NTSTATUS(0xc01d0005);
pub const NT_STATUS_MONITOR_INVALID_SERIAL_NUMBER_MONDSC_BLOCK: NTSTATUS = NTSTATUS(0xc01d0006);
pub const NT_STATUS_MONITOR_INVALID_USER_FRIENDLY_MONDSC_BLOCK: NTSTATUS = NTSTATUS(0xc01d0007);
pub const NT_STATUS_MONITOR_NO_MORE_DESCRIPTOR_DATA: NTSTATUS = NTSTATUS(0xc01d0008);
pub const NT_STATUS_MONITOR_INVALID_DETAILED_TIMING_BLOCK: NTSTATUS = NTSTATUS(0xc01d0009);
pub const NT_STATUS_MONITOR_INVALID_MANUFACTURE_DATE: NTSTATUS = NTSTATUS(0xc01d000a);
pub const NT_STATUS_GRAPHICS_NOT_EXCLUSIVE_MODE_OWNER: NTSTATUS = NTSTATUS(0xc01e0000);
pub const NT_STATUS_GRAPHICS_INSUFFICIENT_DMA_BUFFER: NTSTATUS = NTSTATUS(0xc01e0001);
pub const NT_STATUS_GRAPHICS_INVALID_DISPLAY_ADAPTER: NTSTATUS = NTSTATUS(0xc01e0002);
pub const NT_STATUS_GRAPHICS_ADAPTER_WAS_RESET: NTSTATUS = NTSTATUS(0xc01e0003);
pub const NT_STATUS_GRAPHICS_INVALID_DRIVER_MODEL: NTSTATUS = NTSTATUS(0xc01e0004);
pub const NT_STATUS_GRAPHICS_PRESENT_MODE_CHANGED: NTSTATUS = NTSTATUS(0xc01e0005);
...
pub const NT_STATUS_GRAPHICS_CANNOTCOLORCONVERT: NTSTATUS = NTSTATUS(0xc01e0008);
pub const NT_STATUS_GRAPHICS_PRESENT_REDIRECTION_DISABLED: NTSTATUS = NTSTATUS(0xc01e000b);
pub const NT_STATUS_GRAPHICS_PRESENT_UNOCCLUDED: NTSTATUS = NTSTATUS(0xc01e000c);
...
pub const NT_STATUS_GRAPHICS_TOO_MANY_REFERENCES: NTSTATUS = NTSTATUS(0xc01e0103);
...
pub const NT_STATUS_GRAPHICS_ALLOCATION_INVALID: NTSTATUS = NTSTATUS(0xc01e0106);
pub const NT_STATUS_GRAPHICS_UNSWIZZLING_APERTURE_UNAVAILABLE: NTSTATUS = NTSTATUS(0xc01e0107);
pub const NT_STATUS_GRAPHICS_UNSWIZZLING_APERTURE_UNSUPPORTED: NTSTATUS = NTSTATUS(0xc01e0108);
pub const NT_STATUS_GRAPHICS_CANT_EVICT_PINNED_ALLOCATION: NTSTATUS = NTSTATUS(0xc01e0109);
pub const NT_STATUS_GRAPHICS_INVALID_ALLOCATION_USAGE: NTSTATUS = NTSTATUS(0xc01e0110);
pub const NT_STATUS_GRAPHICS_CANT_RENDER_LOCKED_ALLOCATION: NTSTATUS = NTSTATUS(0xc01e0111);
pub const NT_STATUS_GRAPHICS_ALLOCATION_CLOSED: NTSTATUS = NTSTATUS(0xc01e0112);
pub const NT_STATUS_GRAPHICS_INVALID_ALLOCATION_INSTANCE: NTSTATUS = NTSTATUS(0xc01e0113);
pub const NT_STATUS_GRAPHICS_INVALID_ALLOCATION_HANDLE: NTSTATUS = NTSTATUS(0xc01e0114);
pub const NT_STATUS_GRAPHICS_WRONG_ALLOCATION_DEVICE: NTSTATUS = NTSTATUS(0xc01e0115);
pub const NT_STATUS_GRAPHICS_ALLOCATION_CONTENT_LOST: NTSTATUS = NTSTATUS(0xc01e0116);
pub const NT_STATUS_GRAPHICS_GPU_EXCEPTION_ON_DEVICE: NTSTATUS = NTSTATUS(0xc01e0200);
pub const NT_STATUS_GRAPHICS_INVALID_VIDPN_TOPOLOGY: NTSTATUS = NTSTATUS(0xc01e0300);
pub const NT_STATUS_GRAPHICS_VIDPN_TOPOLOGY_NOT_SUPPORTED: NTSTATUS = NTSTATUS(0xc01e0301);
pub const NT_STATUS_GRAPHICS_VIDPN_TOPOLOGY_CURRENTLY_NOT_SUPPORTED: NTSTATUS = NTSTATUS(0xc01e0302);
pub const NT_STATUS_GRAPHICS_INVALID_VIDPN: NTSTATUS = NTSTATUS(0xc01e0303);
pub const NT_STATUS_GRAPHICS_INVALID_VIDEO_PRESENT_SOURCE: NTSTATUS = NTSTATUS(0xc01e0304);
pub const NT_STATUS_GRAPHICS_INVALID_VIDEO_PRESENT_TARGET: NTSTATUS = NTSTATUS(0xc01e0305);
pub const NT_STATUS_GRAPHICS_VIDPN_MODALITY_NOT_SUPPORTED: NTSTATUS = NTSTATUS(0xc01e0306);
pub const NT_STATUS_GRAPHICS_INVALID_VIDPN_SOURCEMODESET: NTSTATUS = NTSTATUS(0xc01e0308);
pub const NT_STATUS_GRAPHICS_INVALID_VIDPN_TARGETMODESET: NTSTATUS = NTSTATUS(0xc01e0309);
pub const NT_STATUS_GRAPHICS_INVALID_FREQUENCY: NTSTATUS = NTSTATUS(0xc01e030a);
pub const NT_STATUS_GRAPHICS_INVALID_ACTIVE_REGION: NTSTATUS = NTSTATUS(0xc01e030b);
pub const NT_STATUS_GRAPHICS_INVALID_TOTAL_REGION: NTSTATUS = NTSTATUS(0xc01e030c);
pub const NT_STATUS_GRAPHICS_INVALID_VIDEO_PRESENT_SOURCE_MODE: NTSTATUS = NTSTATUS(0xc01e0310);
pub const NT_STATUS_GRAPHICS_INVALID_VIDEO_PRESENT_TARGET_MODE: NTSTATUS = NTSTATUS(0xc01e0311);
pub const NT_STATUS_GRAPHICS_PINNED_MODE_MUST_REMAIN_IN_SET: NTSTATUS = NTSTATUS(0xc01e0312);
pub const NT_STATUS_GRAPHICS_PATH_ALREADY_IN_TOPOLOGY: NTSTATUS = NTSTATUS(0xc01e0313);
pub const NT_STATUS_GRAPHICS_MODE_ALREADY_IN_MODESET: NTSTATUS = NTSTATUS(0xc01e0314);
pub const NT_STATUS_GRAPHICS_INVALID_VIDEOPRESENTSOURCESET: NTSTATUS = NTSTATUS(0xc01e0315);
pub const NT_STATUS_GRAPHICS_INVALID_VIDEOPRESENTTARGETSET: NTSTATUS = NTSTATUS(0xc01e0316);
pub const NT_STATUS_GRAPHICS_SOURCE_ALREADY_IN_SET: NTSTATUS = NTSTATUS(0xc01e0317);
pub const NT_STATUS_GRAPHICS_TARGET_ALREADY_IN_SET: NTSTATUS = NTSTATUS(0xc01e0318);
pub const NT_STATUS_GRAPHICS_INVALID_VIDPN_PRESENT_PATH: NTSTATUS = NTSTATUS(0xc01e0319);
pub const NT_STATUS_GRAPHICS_NO_RECOMMENDED_VIDPN_TOPOLOGY: NTSTATUS = NTSTATUS(0xc01e031a);
pub const NT_STATUS_GRAPHICS_INVALID_MONITOR_FREQUENCYRANGESET: NTSTATUS = NTSTATUS(0xc01e031b);
pub const NT_STATUS_GRAPHICS_INVALID_MONITOR_FREQUENCYRANGE: NTSTATUS = NTSTATUS(0xc01e031c);
pub const NT_STATUS_GRAPHICS_FREQUENCYRANGE_NOT_IN_SET: NTSTATUS = NTSTATUS(0xc01e031d);
pub const NT_STATUS_GRAPHICS_FREQUENCYRANGE_ALREADY_IN_SET: NTSTATUS = NTSTATUS(0xc01e031f);
pub const NT_STATUS_GRAPHICS_STALE_MODESET: NTSTATUS = NTSTATUS(0xc01e0320);
pub const NT_STATUS_GRAPHICS_INVALID_MONITOR_SOURCEMODESET: NTSTATUS = NTSTATUS(0xc01e0321);
pub const NT_STATUS_GRAPHICS_INVALID_MONITOR_SOURCE_MODE: NTSTATUS = NTSTATUS(0xc01e0322);
pub const NT_STATUS_GRAPHICS_NO_RECOMMENDED_FUNCTIONAL_VIDPN: NTSTATUS = NTSTATUS(0xc01e0323);
pub const NT_STATUS_GRAPHICS_MODE_ID_MUST_BE_UNIQUE: NTSTATUS = NTSTATUS(0xc01e0324);
pub const NT_STATUS_GRAPHICS_EMPTY_ADAPTER_MONITOR_MODE_SUPPORT_INTERSECTION: NTSTATUS = NTSTATUS(0xc01e0325);
pub const NT_STATUS_GRAPHICS_VIDEO_PRESENT_TARGETS_LESS_THAN_SOURCES: NTSTATUS = NTSTATUS(0xc01e0326);
pub const NT_STATUS_GRAPHICS_PATH_NOT_IN_TOPOLOGY: NTSTATUS = NTSTATUS(0xc01e0327);
pub const NT_STATUS_GRAPHICS_ADAPTER_MUST_HAVE_AT_LEAST_ONE_SOURCE: NTSTATUS = NTSTATUS(0xc01e0328);
pub const NT_STATUS_GRAPHICS_ADAPTER_MUST_HAVE_AT_LEAST_ONE_TARGET: NTSTATUS = NTSTATUS(0xc01e0329);
pub const NT_STATUS_GRAPHICS_INVALID_MONITORDESCRIPTORSET: NTSTATUS = NTSTATUS(0xc01e032a);
pub const NT_STATUS_GRAPHICS_INVALID_MONITORDESCRIPTOR: NTSTATUS = NTSTATUS(0xc01e032b);
pub const NT_STATUS_GRAPHICS_MONITORDESCRIPTOR_NOT_IN_SET: NTSTATUS = NTSTATUS(0xc01e032c);
pub const NT_STATUS_GRAPHICS_MONITORDESCRIPTOR_ALREADY_IN_SET: NTSTATUS = NTSTATUS(0xc01e032d);
pub const NT_STATUS_GRAPHICS_MONITORDESCRIPTOR_ID_MUST_BE_UNIQUE: NTSTATUS = NTSTATUS(0xc01e032e);
pub const NT_STATUS_GRAPHICS_INVALID_VIDPN_TARGET_SUBSET_TYPE: NTSTATUS = NTSTATUS(0xc01e032f);
pub const NT_STATUS_GRAPHICS_RESOURCES_NOT_RELATED: NTSTATUS = NTSTATUS(0xc01e0330);
pub const NT_STATUS_GRAPHICS_SOURCE_ID_MUST_BE_UNIQUE: NTSTATUS = NTSTATUS(0xc01e0331);
pub const NT_STATUS_GRAPHICS_TARGET_ID_MUST_BE_UNIQUE: NTSTATUS = NTSTATUS(0xc01e0332);
pub const NT_STATUS_GRAPHICS_NO_AVAILABLE_VIDPN_TARGET: NTSTATUS = NTSTATUS(0xc01e0333);
pub const NT_STATUS_GRAPHICS_MONITOR_COULD_NOT_BE_ASSOCIATED_WITH_ADAPTER: NTSTATUS = NTSTATUS(0xc01e0334);
...
pub const NT_STATUS_GRAPHICS_STALE_VIDPN_TOPOLOGY: NTSTATUS = NTSTATUS(0xc01e0337);
pub const NT_STATUS_GRAPHICS_MONITOR_NOT_CONNECTED: NTSTATUS = NTSTATUS(0xc01e0338);
pub const NT_STATUS_GRAPHICS_SOURCE_NOT_IN_TOPOLOGY: NTSTATUS = NTSTATUS(0xc01e0339);
pub const NT_STATUS_GRAPHICS_INVALID_PRIMARYSURFACE_SIZE: NTSTATUS = NTSTATUS(0xc01e033a);
pub const NT_STATUS_GRAPHICS_INVALID_VISIBLEREGION_SIZE: NTSTATUS = NTSTATUS(0xc01e033b);
pub const NT_STATUS_GRAPHICS_INVALID_STRIDE: NTSTATUS = NTSTATUS(0xc01e033c);
pub const NT_STATUS_GRAPHICS_INVALID_PIXELFORMAT: NTSTATUS = NTSTATUS(0xc01e033d);
pub const NT_STATUS_GRAPHICS_INVALID_COLORBASIS: NTSTATUS = NTSTATUS(0xc01e033e);
pub const NT_STATUS_GRAPHICS_INVALID_PIXELVALUEACCESSMODE: NTSTATUS = NTSTATUS(0xc01e033f);
pub const NT_STATUS_GRAPHICS_TARGET_NOT_IN_TOPOLOGY: NTSTATUS = NTSTATUS(0xc01e0340);
pub const NT_STATUS_GRAPHICS_NO_DISPLAY_MODE_MANAGEMENT_SUPPORT: NTSTATUS = NTSTATUS(0xc01e0341);
pub const NT_STATUS_GRAPHICS_VIDPN_SOURCE_IN_USE: NTSTATUS = NTSTATUS(0xc01e0342);
pub const NT_STATUS_GRAPHICS_CANT_ACCESS_ACTIVE_VIDPN: NTSTATUS = NTSTATUS(0xc01e0343);
pub const NT_STATUS_GRAPHICS_INVALID_PATH_IMPORTANCE_ORDINAL: NTSTATUS = NTSTATUS(0xc01e0344);
pub const NT_STATUS_GRAPHICS_INVALID_PATH_CONTENT_GEOMETRY_TRANSFORMATION: NTSTATUS = NTSTATUS(0xc01e0345);
pub const NT_STATUS_GRAPHICS_PATH_CONTENT_GEOMETRY_TRANSFORMATION_NOT_SUPPORTED: NTSTATUS = NTSTATUS(0xc01e0346);
pub const NT_STATUS_GRAPHICS_INVALID_GAMMA_RAMP: NTSTATUS = NTSTATUS(0xc01e0347);
pub const NT_STATUS_GRAPHICS_GAMMA_RAMP_NOT_SUPPORTED: NTSTATUS = NTSTATUS(0xc01e0348);
pub const NT_STATUS_GRAPHICS_MULTISAMPLING_NOT_SUPPORTED: NTSTATUS = NTSTATUS(0xc01e0349);
pub const NT_STATUS_GRAPHICS_MODE_NOT_IN_MODESET: NTSTATUS = NTSTATUS(0xc01e034a);
pub const NT_STATUS_GRAPHICS_INVALID_VIDPN_TOPOLOGY_RECOMMENDATION_REASON: NTSTATUS = NTSTATUS(0xc01e034d);
pub const NT_STATUS_GRAPHICS_INVALID_PATH_CONTENT_TYPE: NTSTATUS = NTSTATUS(0xc01e034e);
pub const NT_STATUS_GRAPHICS_INVALID_COPYPROTECTION_TYPE: NTSTATUS = NTSTATUS(0xc01e034f);
pub const NT_STATUS_GRAPHICS_UNASSIGNED_MODESET_ALREADY_EXISTS: NTSTATUS = NTSTATUS(0xc01e0350);
pub const NT_STATUS_GRAPHICS_INVALID_SCANLINE_ORDERING: NTSTATUS = NTSTATUS(0xc01e0352);
pub const NT_STATUS_GRAPHICS_TOPOLOGY_CHANGES_NOT_ALLOWED: NTSTATUS = NTSTATUS(0xc01e0353);
pub const NT_STATUS_GRAPHICS_NO_AVAILABLE_IMPORTANCE_ORDINALS: NTSTATUS = NTSTATUS(0xc01e0354);
pub const NT_STATUS_GRAPHICS_INCOMPATIBLE_PRIVATE_FORMAT: NTSTATUS = NTSTATUS(0xc01e0355);
pub const NT_STATUS_GRAPHICS_INVALID_MODE_PRUNING_ALGORITHM: NTSTATUS = NTSTATUS(0xc01e0356);
pub const NT_STATUS_GRAPHICS_INVALID_MONITOR_CAPABILITY_ORIGIN: NTSTATUS = NTSTATUS(0xc01e0357);
pub const NT_STATUS_GRAPHICS_INVALID_MONITOR_FREQUENCYRANGE_CONSTRAINT: NTSTATUS = NTSTATUS(0xc01e0358);
pub const NT_STATUS_GRAPHICS_MAX_NUM_PATHS_REACHED: NTSTATUS = NTSTATUS(0xc01e0359);
pub const NT_STATUS_GRAPHICS_CANCEL_VIDPN_TOPOLOGY_AUGMENTATION: NTSTATUS = NTSTATUS(0xc01e035a);
pub const NT_STATUS_GRAPHICS_INVALID_CLIENT_TYPE: NTSTATUS = NTSTATUS(0xc01e035b);
pub const NT_STATUS_GRAPHICS_CLIENTVIDPN_NOT_SET: NTSTATUS = NTSTATUS(0xc01e035c);
pub const NT_STATUS_GRAPHICS_SPECIFIED_CHILD_ALREADY_CONNECTED: NTSTATUS = NTSTATUS(0xc01e0400);
pub const NT_STATUS_GRAPHICS_CHILD_DESCRIPTOR_NOT_SUPPORTED: NTSTATUS = NTSTATUS(0xc01e0401);
pub const NT_STATUS_GRAPHICS_NOT_A_LINKED_ADAPTER: NTSTATUS = NTSTATUS(0xc01e0430);
pub const NT_STATUS_GRAPHICS_LEADLINK_NOT_ENUMERATED: NTSTATUS = NTSTATUS(0xc01e0431);
pub const NT_STATUS_GRAPHICS_CHAINLINKS_NOT_ENUMERATED: NTSTATUS = NTSTATUS(0xc01e0432);
pub const NT_STATUS_GRAPHICS_ADAPTER_CHAIN_NOT_READY: NTSTATUS = NTSTATUS(0xc01e0433);
pub const NT_STATUS_GRAPHICS_CHAINLINKS_NOT_STARTED: NTSTATUS = NTSTATUS(0xc01e0434);
pub const NT_STATUS_GRAPHICS_CHAINLINKS_NOT_POWERED_ON: NTSTATUS = NTSTATUS(0xc01e0435);
pub const NT_STATUS_GRAPHICS_INCONSISTENT_DEVICE_LINK_STATE: NTSTATUS = NTSTATUS(0xc01e0436);
pub const NT_STATUS_GRAPHICS_NOT_POST_DEVICE_DRIVER: NTSTATUS = NTSTATUS(0xc01e0438);
pub const NT_STATUS_GRAPHICS_ADAPTER_ACCESS_NOT_EXCLUDED: NTSTATUS = NTSTATUS(0xc01e043b);
pub const NT_STATUS_GRAPHICS_OPM_NOT_SUPPORTED: NTSTATUS = NTSTATUS(0xc01e0500);
pub const NT_STATUS_GRAPHICS_COPP_NOT_SUPPORTED: NTSTATUS = NTSTATUS(0xc01e0501);
pub const NT_STATUS_GRAPHICS_UAB_NOT_SUPPORTED: NTSTATUS = NTSTATUS(0xc01e0502);
pub const NT_STATUS_GRAPHICS_OPM_INVALID_ENCRYPTED_PARAMETERS: NTSTATUS = NTSTATUS(0xc01e0503);
pub const NT_STATUS_GRAPHICS_OPM_PARAMETER_ARRAY_TOO_SMALL: NTSTATUS = NTSTATUS(0xc01e0504);
pub const NT_STATUS_GRAPHICS_OPM_NO_PROTECTED_OUTPUTS_EXIST: NTSTATUS = NTSTATUS(0xc01e0505);
pub const NT_STATUS_GRAPHICS_PVP_NO_DISPLAY_DEVICE_CORRESPONDS_TO_NAME: NTSTATUS = NTSTATUS(0xc01e0506);
pub const NT_STATUS_GRAPHICS_PVP_DISPLAY_DEVICE_NOT_ATTACHED_TO_DESKTOP: NTSTATUS = NTSTATUS(0xc01e0507);
pub const NT_STATUS_GRAPHICS_PVP_MIRRORING_DEVICES_NOT_SUPPORTED: NTSTATUS = NTSTATUS(0xc01e0508);
pub const NT_STATUS_GRAPHICS_OPM_INVALID_POINTER: NTSTATUS = NTSTATUS(0xc01e050a);
pub const NT_STATUS_GRAPHICS_OPM_INTERNAL_ERROR: NTSTATUS = NTSTATUS(0xc01e050b);
pub const NT_STATUS_GRAPHICS_OPM_INVALID_HANDLE: NTSTATUS = NTSTATUS(0xc01e050c);
pub const NT_STATUS_GRAPHICS_PVP_NO_MONITORS_CORRESPOND_TO_DISPLAY_DEVICE: NTSTATUS = NTSTATUS(0xc01e050d);
pub const NT_STATUS_GRAPHICS_PVP_INVALID_CERTIFICATE_LENGTH: NTSTATUS = NTSTATUS(0xc01e050e);
pub const NT_STATUS_GRAPHICS_OPM_SPANNING_MODE_ENABLED: NTSTATUS = NTSTATUS(0xc01e050f);
pub const NT_STATUS_GRAPHICS_OPM_THEATER_MODE_ENABLED: NTSTATUS = NTSTATUS(0xc01e0510);
...
pub const NT_STATUS_GRAPHICS_OPM_OUTPUT_DOES_NOT_SUPPORT_HDCP: NTSTATUS = NTSTATUS(0xc01e0513);
pub const NT_STATUS_GRAPHICS_OPM_OUTPUT_DOES_NOT_SUPPORT_ACP: NTSTATUS = NTSTATUS(0xc01e0514);
pub const NT_STATUS_GRAPHICS_OPM_OUTPUT_DOES_NOT_SUPPORT_CGMSA: NTSTATUS = NTSTATUS(0xc01e0515);
pub const NT_STATUS_GRAPHICS_OPM_HDCP_SRM_NEVER_SET: NTSTATUS = NTSTATUS(0xc01e0516);
pub const NT_STATUS_GRAPHICS_OPM_RESOLUTION_TOO_HIGH: NTSTATUS = NTSTATUS(0xc01e0517);
pub const NT_STATUS_GRAPHICS_OPM_ALL_HDCP_HARDWARE_ALREADY_IN_USE: NTSTATUS = NTSTATUS(0xc01e0518);
pub const NT_STATUS_GRAPHICS_OPM_PROTECTED_OUTPUT_NO_LONGER_EXISTS: NTSTATUS = NTSTATUS(0xc01e051a);
pub const NT_STATUS_GRAPHICS_OPM_SESSION_TYPE_CHANGE_IN_PROGRESS: NTSTATUS = NTSTATUS(0xc01e051b);
pub const NT_STATUS_GRAPHICS_OPM_PROTECTED_OUTPUT_DOES_NOT_HAVE_COPP_SEMANTICS: NTSTATUS = NTSTATUS(0xc01e051c);
pub const NT_STATUS_GRAPHICS_OPM_INVALID_INFORMATION_REQUEST: NTSTATUS = NTSTATUS(0xc01e051d);
pub const NT_STATUS_GRAPHICS_OPM_DRIVER_INTERNAL_ERROR: NTSTATUS = NTSTATUS(0xc01e051e);
pub const NT_STATUS_GRAPHICS_OPM_PROTECTED_OUTPUT_DOES_NOT_HAVE_OPM_SEMANTICS: NTSTATUS = NTSTATUS(0xc01e051f);
pub const NT_STATUS_GRAPHICS_OPM_SIGNALING_NOT_SUPPORTED: NTSTATUS = NTSTATUS(0xc01e0520);
pub const NT_STATUS_GRAPHICS_OPM_INVALID_CONFIGURATION_REQUEST: NTSTATUS = NTSTATUS(0xc01e0521);
pub const NT_STATUS_GRAPHICS_I2C_NOT_SUPPORTED: NTSTATUS = NTSTATUS(0xc01e0580);
pub const NT_STATUS_GRAPHICS_I2C_DEVICE_DOES_NOT_EXIST: NTSTATUS = NTSTATUS(0xc01e0581);
pub const NT_STATUS_GRAPHICS_I2C_ERROR_TRANSMITTING_DATA: NTSTATUS = NTSTATUS(0xc01e0582);
pub const NT_STATUS_GRAPHICS_I2C_ERROR_RECEIVING_DATA: NTSTATUS = NTSTATUS(0xc01e0583);
pub const NT_STATUS_GRAPHICS_DDCCI_VCP_NOT_SUPPORTED: NTSTATUS = NTSTATUS(0xc01e0584);
pub const NT_STATUS_GRAPHICS_DDCCI_INVALID_DATA: NTSTATUS = NTSTATUS(0xc01e0585);
pub const NT_STATUS_GRAPHICS_DDCCI_MONITOR_RETURNED_INVALID_TIMING_STATUS_BYTE: NTSTATUS = NTSTATUS(0xc01e0586);
pub const NT_STATUS_GRAPHICS_DDCCI_INVALID_CAPABILITIES_STRING: NTSTATUS = NTSTATUS(0xc01e0587);
pub const NT_STATUS_GRAPHICS_MCA_INTERNAL_ERROR: NTSTATUS = NTSTATUS(0xc01e0588);
pub const NT_STATUS_GRAPHICS_DDCCI_INVALID_MESSAGE_COMMAND: NTSTATUS = NTSTATUS(0xc01e0589);
pub const NT_STATUS_GRAPHICS_DDCCI_INVALID_MESSAGE_LENGTH: NTSTATUS = NTSTATUS(0xc01e058a);
pub const NT_STATUS_GRAPHICS_DDCCI_INVALID_MESSAGE_CHECKSUM: NTSTATUS = NTSTATUS(0xc01e058b);
pub const NT_STATUS_GRAPHICS_INVALID_PHYSICAL_MONITOR_HANDLE: NTSTATUS = NTSTATUS(0xc01e058c);
pub const NT_STATUS_GRAPHICS_MONITOR_NO_LONGER_EXISTS: NTSTATUS = NTSTATUS(0xc01e058d);
pub const NT_STATUS_GRAPHICS_ONLY_CONSOLE_SESSION_SUPPORTED: NTSTATUS = NTSTATUS(0xc01e05e0);
pub const NT_STATUS_GRAPHICS_NO_DISPLAY_DEVICE_CORRESPONDS_TO_NAME: NTSTATUS = NTSTATUS(0xc01e05e1);
pub const NT_STATUS_GRAPHICS_DISPLAY_DEVICE_NOT_ATTACHED_TO_DESKTOP: NTSTATUS = NTSTATUS(0xc01e05e2);
pub const NT_STATUS_GRAPHICS_MIRRORING_DEVICES_NOT_SUPPORTED: NTSTATUS = NTSTATUS(0xc01e05e3);
pub const NT_STATUS_GRAPHICS_INVALID_POINTER: NTSTATUS = NTSTATUS(0xc01e05e4);
pub const NT_STATUS_GRAPHICS_NO_MONITORS_CORRESPOND_TO_DISPLAY_DEVICE: NTSTATUS = NTSTATUS(0xc01e05e5);
pub const NT_STATUS_GRAPHICS_PARAMETER_ARRAY_TOO_SMALL: NTSTATUS = NTSTATUS(0xc01e05e6);
pub const NT_STATUS_GRAPHICS_INTERNAL_ERROR: NTSTATUS = NTSTATUS(0xc01e05e7);
pub const NT_STATUS_GRAPHICS_SESSION_TYPE_CHANGE_IN_PROGRESS: NTSTATUS = NTSTATUS(0xc01e05e8);
...
pub const NT_STATUS_FVE_AUTH_INVALID_APPLICATION: NTSTATUS = NTSTATUS(0xc021001b);
...
pub const NT_STATUS_FVE_POLICY_USER_DISABLE_RDV_NOT_ALLOWED: NTSTATUS = NTSTATUS(0xc0210027);
pub const NT_STATUS_FVE_CONV_RECOVERY_FAILED: NTSTATUS = NTSTATUS(0xc0210028);
pub const NT_STATUS_FVE_VIRTUALIZED_SPACE_TOO_BIG: NTSTATUS = NTSTATUS(0xc0210029);
...
pub const NT_STATUS_FWP_PROVIDER_CONTEXT_NOT_FOUND: NTSTATUS = NTSTATUS(0xc0220006);
...
pub const NT_STATUS_FWP_DYNAMIC_SESSION_IN_PROGRESS: NTSTATUS = NTSTATUS(0xc022000b);
...
#[allow(dead_code)]
pub const NT_STATUS_FWP_TOO_MANY_BOOTTIME_FILTERS: NTSTATUS = NTSTATUS(0xc0220018);
...
pub const NT_STATUS_FWP_ACTION_INCOMPATIBLE_WITH_LAYER: NTSTATUS = NTSTATUS(0xc022002c);
pub const NT_STATUS_FWP_ACTION_INCOMPATIBLE_WITH_SUBLAYER: NTSTATUS = NTSTATUS(0xc022002d);
pub const NT_STATUS_FWP_CONTEXT_INCOMPATIBLE_WITH_LAYER: NTSTATUS = NTSTATUS(0xc022002e);
pub const NT_STATUS_FWP_CONTEXT_INCOMPATIBLE_WITH_CALLOUT: NTSTATUS = NTSTATUS(0xc022002f);
pub const NT_STATUS_FWP_INCOMPATIBLE_AUTH_METHOD: NTSTATUS = NTSTATUS(0xc0220030);
...
pub const NT_STATUS_FWP_PROVIDER_CONTEXT_MISMATCH: NTSTATUS = NTSTATUS(0xc0220034);
...
pub const NT_STATUS_FWP_CALLOUT_NOTIFICATION_FAILED: NTSTATUS = NTSTATUS(0xc0220037);
pub const NT_STATUS_FWP_INCOMPATIBLE_AUTH_CONFIG: NTSTATUS = NTSTATUS(0xc0220038);
pub const NT_STATUS_FWP_INCOMPATIBLE_CIPHER_CONFIG: NTSTATUS = NTSTATUS(0xc0220039);
...
pub const NT_STATUS_NDIS_INVALID_DEVICE_REQUEST: NTSTATUS = NTSTATUS(0xc0230010);
...
pub const NT_STATUS_NDIS_OFFLOAD_CONNECTION_REJECTED: NTSTATUS = NTSTATUS(0xc0231012);
pub const NT_STATUS_NDIS_OFFLOAD_PATH_REJECTED: NTSTATUS = NTSTATUS(0xc0231013);
pub const NT_STATUS_NDIS_DOT11_AUTO_CONFIG_ENABLED: NTSTATUS = NTSTATUS(0xc0232000);
pub const NT_STATUS_NDIS_DOT11_MEDIA_IN_USE: NTSTATUS = NTSTATUS(0xc0232001);
pub const NT_STATUS_NDIS_DOT11_POWER_STATE_INVALID: NTSTATUS = NTSTATUS(0xc0232002);
pub const NT_STATUS_NDIS_PM_WOL_PATTERN_LIST_FULL: NTSTATUS = NTSTATUS(0xc0232003);
pub const NT_STATUS_NDIS_PM_PROTOCOL_OFFLOAD_LIST_FULL: NTSTATUS = NTSTATUS(0xc0232004);
...
pub const NT_STATUS_IPSEC_INTEGRITY_CHECK_FAILED: NTSTATUS = NTSTATUS(0xc0360006);
...
pub const NT_STATUS_IPSEC_DOSP_RECEIVED_MULTICAST: NTSTATUS = NTSTATUS(0xc0368001);
pub const NT_STATUS_IPSEC_DOSP_INVALID_PACKET: NTSTATUS = NTSTATUS(0xc0368002);
pub const NT_STATUS_IPSEC_DOSP_STATE_LOOKUP_FAILED: NTSTATUS = NTSTATUS(0xc0368003);
pub const NT_STATUS_IPSEC_DOSP_MAX_ENTRIES: NTSTATUS = NTSTATUS(0xc0368004);
pub const NT_STATUS_IPSEC_DOSP_KEYMOD_NOT_ALLOWED: NTSTATUS = NTSTATUS(0xc0368005);
pub const NT_STATUS_IPSEC_DOSP_MAX_PER_IP_RATELIMIT_QUEUES: NTSTATUS = NTSTATUS(0xc0368006);
pub const NT_STATUS_VOLMGR_MIRROR_NOT_SUPPORTED: NTSTATUS = NTSTATUS(0xc038005b);
pub const NT_STATUS_VOLMGR_RAID5_NOT_SUPPORTED: NTSTATUS = NTSTATUS(0xc038005c);
pub const NT_STATUS_VIRTDISK_PROVIDER_NOT_FOUND: NTSTATUS = NTSTATUS(0xc03a0014);
pub const NT_STATUS_VIRTDISK_NOT_VIRTUAL_DISK: NTSTATUS = NTSTATUS(0xc03a0015);
pub const NT_STATUS_VHD_PARENT_VHD_ACCESS_DENIED: NTSTATUS = NTSTATUS(0xc03a0016);
pub const NT_STATUS_VHD_CHILD_PARENT_SIZE_MISMATCH: NTSTATUS = NTSTATUS(0xc03a0017);
pub const NT_STATUS_VHD_DIFFERENCING_CHAIN_CYCLE_DETECTED: NTSTATUS = NTSTATUS(0xc03a0018);
pub const NT_STATUS_VHD_DIFFERENCING_CHAIN_ERROR_IN_PARENT: NTSTATUS = NTSTATUS(0xc03a0019);
