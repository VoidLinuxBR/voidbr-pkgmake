...
FN_GLOBAL_SUBSTITUTED_STRING(abort_shutdown_script, abort_shutdown_script)
...
FN_GLOBAL_INTEGER(acl_claims_evaluation, acl_claims_evaluation)
FN_LOCAL_BOOL(acl_flag_inherited_canonicalization, acl_flag_inherited_canonicalization)
FN_LOCAL_BOOL(acl_group_control, acl_group_control)
FN_LOCAL_BOOL(acl_map_full_control, acl_map_full_control)
FN_GLOBAL_INTEGER(ad_dc_functional_level, ad_dc_functional_level)
FN_GLOBAL_SUBSTITUTED_STRING(add_group_script, add_group_script)
FN_GLOBAL_LIST(additional_dns_hostnames, additional_dns_hostnames)
FN_GLOBAL_SUBSTITUTED_STRING(add_machine_script, add_machine_script)
FN_GLOBAL_SUBSTITUTED_STRING(addport_command, addport_command)
FN_GLOBAL_SUBSTITUTED_STRING(addprinter_command, addprinter_command)
FN_GLOBAL_SUBSTITUTED_STRING(add_share_command, add_share_command)
FN_GLOBAL_SUBSTITUTED_STRING(add_user_script, add_user_script)
FN_GLOBAL_SUBSTITUTED_STRING(add_user_to_group_script, add_user_to_group_script)
...
FN_GLOBAL_INTEGER(aio_max_threads, aio_max_threads)
FN_LOCAL_INTEGER(aio_read_size, aio_read_size)
FN_LOCAL_SUBSTITUTED_STRING(aio_write_behind, aio_write_behind)
...
FN_GLOBAL_BOOL(allow_dcerpc_auth_level_connect, allow_dcerpc_auth_level_connect)
...
FN_GLOBAL_BOOL(allow_unsafe_cluster_upgrade, allow_unsafe_cluster_upgrade)
FN_GLOBAL_BOOL(apply_group_policies, apply_group_policies)
FN_GLOBAL_INTEGER(async_dns_timeout, async_dns_timeout)
FN_GLOBAL_BOOL(async_smb_echo_handler, async_smb_echo_handler)
FN_GLOBAL_BOOL(auth_event_notification, auth_event_notification)
FN_GLOBAL_SUBSTITUTED_STRING(auto_services, auto_services)
FN_GLOBAL_LIST(automount_fs_types, automount_fs_types)
FN_GLOBAL_CONST_STRING(binddns_dir, binddns_dir)
...
FN_GLOBAL_CONST_STRING(cache_directory, cache_directory)
FN_LOCAL_INTEGER(case_sensitive, case_sensitive)
FN_GLOBAL_BOOL(change_notify, change_notify)
FN_GLOBAL_SUBSTITUTED_STRING(change_share_command, change_share_command)
FN_LOCAL_BOOL(check_parent_directory_delete_on_close, check_parent_directory_delete_on_close)
FN_GLOBAL_SUBSTITUTED_STRING(check_password_script, check_password_script)
FN_GLOBAL_INTEGER(_client_ipc_max_protocol, _client_ipc_max_protocol)
FN_GLOBAL_INTEGER(_client_ipc_min_protocol, _client_ipc_min_protocol)
FN_GLOBAL_INTEGER(_client_ipc_signing, _client_ipc_signing)
...
FN_GLOBAL_INTEGER(_client_max_protocol, _client_max_protocol)
FN_GLOBAL_INTEGER(client_min_protocol, client_min_protocol)
FN_GLOBAL_INTEGER(client_netlogon_ping_protocol, client_netlogon_ping_protocol)
FN_GLOBAL_BOOL(client_ntlmv2_auth, client_ntlmv2_auth)
FN_GLOBAL_BOOL(client_plaintext_auth, client_plaintext_auth)
FN_GLOBAL_INTEGER(client_protection, client_protection)
FN_GLOBAL_INTEGER(client_schannel, client_schannel)
FN_GLOBAL_INTEGER(client_signing, client_signing)
FN_GLOBAL_INTEGER(client_smb_encrypt, client_smb_encrypt)
FN_GLOBAL_LIST(client_smb3_encryption_algorithms, client_smb3_encryption_algorithms)
FN_GLOBAL_BOOL(client_smb_encryption_over_quic, client_smb_encryption_over_quic)
FN_GLOBAL_LIST(client_smb3_signing_algorithms, client_smb3_signing_algorithms)
FN_GLOBAL_LIST(client_smb_transports, client_smb_transports)
FN_GLOBAL_INTEGER(_client_use_kerberos, _client_use_kerberos)
FN_GLOBAL_INTEGER(_client_use_krb5_netlogon, _client_use_krb5_netlogon)
...
FN_LOCAL_SUBSTITUTED_STRING(comment, comment)
FN_GLOBAL_INTEGER(config_backend, config_backend)
FN_GLOBAL_SUBSTITUTED_STRING(next_configfile, next_configfile)
...
FN_GLOBAL_CONST_STRING(_ctdbd_socket, _ctdbd_socket)
...
FN_GLOBAL_INTEGER(cups_encrypt, cups_encrypt)
FN_LOCAL_SUBSTITUTED_STRING(cups_options, cups_options)
FN_GLOBAL_SUBSTITUTED_STRING(cups_server, cups_server)
...
FN_GLOBAL_BOOL(debug_encryption, debug_encryption)
...
FN_GLOBAL_INTEGER(debug_syslog_format, debug_syslog_format)
FN_GLOBAL_BOOL(winbind_debug_traceid, winbind_debug_traceid)
...
FN_GLOBAL_SUBSTITUTED_STRING(defaultservice, defaultservice)
FN_GLOBAL_BOOL(defer_sharing_violations, defer_sharing_violations)
FN_GLOBAL_SUBSTITUTED_STRING(delete_group_script, delete_group_script)
FN_GLOBAL_SUBSTITUTED_STRING(deleteprinter_command, deleteprinter_command)
FN_LOCAL_BOOL(delete_readonly, delete_readonly)
FN_GLOBAL_SUBSTITUTED_STRING(delete_share_command, delete_share_command)
FN_GLOBAL_SUBSTITUTED_STRING(delete_user_from_group_script, delete_user_from_group_script)
FN_GLOBAL_SUBSTITUTED_STRING(delete_user_script, delete_user_script)
FN_LOCAL_BOOL(delete_veto_files, delete_veto_files)
FN_LOCAL_INTEGER(dfree_cache_time, dfree_cache_time)
FN_LOCAL_SUBSTITUTED_STRING(dfree_command, dfree_command)
...
FN_GLOBAL_CONST_STRING(_dns_hostname, _dns_hostname)
FN_GLOBAL_LIST(dns_forwarder, dns_forwarder)
FN_GLOBAL_INTEGER(dns_port, dns_port)
FN_GLOBAL_BOOL(wins_dns_proxy, wins_dns_proxy)
FN_GLOBAL_LIST(dns_update_command, dns_update_command)
FN_GLOBAL_BOOL(dns_zone_scavenging, dns_zone_scavenging)
FN_GLOBAL_LIST(dns_zone_transfer_clients_allow, dns_zone_transfer_clients_allow)
FN_GLOBAL_LIST(dns_zone_transfer_clients_deny, dns_zone_transfer_clients_deny)
FN_GLOBAL_BOOL(_domain_logons, _domain_logons)
FN_GLOBAL_INTEGER(_domain_master, _domain_master)
FN_LOCAL_SUBSTITUTED_STRING(dont_descend, dont_descend)
...
FN_GLOBAL_BOOL(dsdb_event_notification, dsdb_event_notification)
FN_GLOBAL_BOOL(dsdb_group_change_notification, dsdb_group_change_notification)
FN_GLOBAL_BOOL(dsdb_password_event_notification, dsdb_password_event_notification)
...
FN_GLOBAL_SUBSTITUTED_STRING(enumports_command, enumports_command)
...
FN_LOCAL_BOOL(smbd_force_process_locks, smbd_force_process_locks)
FN_LOCAL_INTEGER(force_create_mode, force_create_mode)
FN_LOCAL_INTEGER(force_directory_mode, force_directory_mode)
FN_LOCAL_SUBSTITUTED_STRING(force_group, force_group)
FN_LOCAL_BOOL(force_printername, force_printername)
FN_LOCAL_BOOL(force_unknown_acl_user, force_unknown_acl_user)
FN_LOCAL_SUBSTITUTED_STRING(force_user, force_user)
FN_LOCAL_CONST_STRING(fstype, fstype)
FN_GLOBAL_SUBSTITUTED_STRING(get_quota_command, get_quota_command)
FN_GLOBAL_BOOL(getwd_cache, getwd_cache)
FN_GLOBAL_LIST(gpo_update_command, gpo_update_command)
...
FN_LOCAL_SUBSTITUTED_STRING(hide_files, hide_files)
FN_LOCAL_INTEGER(hide_new_files_timeout, hide_new_files_timeout)
...
FN_LOCAL_BOOL(honor_change_notify_privilege, honor_change_notify_privilege)
...
FN_GLOBAL_BOOL(include_system_krb5_conf, include_system_krb5_conf)
FN_LOCAL_BOOL(inherit_acls, inherit_acls)
FN_LOCAL_INTEGER(inherit_owner, inherit_owner)
...
FN_GLOBAL_SUBSTITUTED_STRING(iprint_server, iprint_server)
FN_GLOBAL_BOOL(kdc_always_include_pac, kdc_always_include_pac)
FN_GLOBAL_INTEGER(certificate_backdating_compensation, certificate_backdating_compensation)
FN_GLOBAL_INTEGER(strong_certificate_binding_enforcement, strong_certificate_binding_enforcement)
FN_GLOBAL_INTEGER(kdc_default_domain_supported_enctypes, kdc_default_domain_supported_enctypes)
FN_GLOBAL_BOOL(kdc_enable_fast, kdc_enable_fast)
FN_GLOBAL_BOOL(kdc_force_enable_rc4_weak_session_keys, kdc_force_enable_rc4_weak_session_keys)
FN_GLOBAL_BOOL(kdc_name_match_implicit_dollar_without_canonicalization, kdc_name_match_implicit_dollar_without_canonicalization)
FN_GLOBAL_BOOL(kdc_require_canonicalization, kdc_require_canonicalization)
FN_GLOBAL_INTEGER(kdc_supported_enctypes, kdc_supported_enctypes)
FN_GLOBAL_INTEGER(keepalive, keepalive)
FN_GLOBAL_INTEGER(kerberos_encryption_types, kerberos_encryption_types)
FN_GLOBAL_INTEGER(kerberos_method, kerberos_method)
FN_GLOBAL_BOOL(kernel_change_notify, kernel_change_notify)
...
FN_GLOBAL_BOOL(krb5_acceptor_report_canonical_client_name, krb5_acceptor_report_canonical_client_name)
FN_GLOBAL_INTEGER(krb5_port, krb5_port)
FN_GLOBAL_BOOL(_lanman_auth, _lanman_auth)
FN_GLOBAL_BOOL(large_readwrite, large_readwrite)
FN_GLOBAL_CONST_STRING(ldap_admin_dn, ldap_admin_dn)
...
FN_GLOBAL_CONST_STRING(_ldap_group_suffix, _ldap_group_suffix)
FN_GLOBAL_CONST_STRING(_ldap_idmap_suffix, _ldap_idmap_suffix)
FN_GLOBAL_CONST_STRING(_ldap_machine_suffix, _ldap_machine_suffix)
FN_GLOBAL_INTEGER(ldap_max_anonymous_request_size, ldap_max_anonymous_request_size)
FN_GLOBAL_INTEGER(ldap_max_authenticated_request_size, ldap_max_authenticated_request_size)
FN_GLOBAL_INTEGER(ldap_max_search_request_size, ldap_max_search_request_size)
...
FN_GLOBAL_INTEGER(ldap_server_require_strong_auth, ldap_server_require_strong_auth)
FN_GLOBAL_INTEGER(ldap_ssl, ldap_ssl)
FN_GLOBAL_CONST_STRING(ldap_suffix, ldap_suffix)
FN_GLOBAL_INTEGER(ldap_timeout, ldap_timeout)
FN_GLOBAL_CONST_STRING(_ldap_user_suffix, _ldap_user_suffix)
...
FN_GLOBAL_SUBSTITUTED_STRING(logfile, logfile)
FN_GLOBAL_SUBSTITUTED_STRING(logging, logging)
FN_GLOBAL_SUBSTITUTED_STRING(log_level, log_level)
FN_GLOBAL_SUBSTITUTED_STRING(log_nt_token_command, log_nt_token_command)
...
FN_LOCAL_CONST_STRING(lppause_command, lppause_command)
FN_GLOBAL_INTEGER(lpq_cache_time, lpq_cache_time)
FN_LOCAL_CONST_STRING(lpq_command, lpq_command)
FN_LOCAL_CONST_STRING(lpresume_command, lpresume_command)
FN_LOCAL_CONST_STRING(lprm_command, lprm_command)
FN_GLOBAL_BOOL(lsa_over_netlogon, lsa_over_netlogon)
FN_GLOBAL_INTEGER(machine_password_timeout, machine_password_timeout)
FN_LOCAL_SUBSTITUTED_STRING(magic_output, magic_output)
FN_LOCAL_SUBSTITUTED_STRING(magic_script, magic_script)
FN_LOCAL_PARM_INTEGER(mangled_names, mangled_names)
FN_GLOBAL_INTEGER(mangle_prefix, mangle_prefix)
FN_LOCAL_PARM_CHAR(mangling_char, mangling_char)
FN_GLOBAL_CONST_STRING(mangling_method, mangling_method)
...
FN_LOCAL_INTEGER(max_print_jobs, max_print_jobs)
...
FN_GLOBAL_INTEGER(mdns_name, mdns_name)
FN_GLOBAL_SUBSTITUTED_STRING(message_command, message_command)
FN_GLOBAL_INTEGER(min_domain_uid, min_domain_uid)
FN_LOCAL_INTEGER(min_print_space, min_print_space)
FN_GLOBAL_INTEGER(min_receivefile_size, min_receivefile_size)
FN_GLOBAL_INTEGER(min_wins_ttl, min_wins_ttl)
FN_GLOBAL_LIST(mit_kdc_command, mit_kdc_command)
FN_LOCAL_SUBSTITUTED_STRING(msdfs_proxy, msdfs_proxy)
FN_LOCAL_BOOL(msdfs_root, msdfs_root)
FN_LOCAL_BOOL(msdfs_shuffle_referrals, msdfs_shuffle_referrals)
...
FN_GLOBAL_INTEGER(nt_hash_store, nt_hash_store)
FN_LOCAL_BOOL(nt_acl_support, nt_acl_support)
FN_GLOBAL_INTEGER(ntlm_auth, ntlm_auth)
...
FN_GLOBAL_INTEGER(old_password_allowed_period, old_password_allowed_period)
FN_GLOBAL_INTEGER(oplock_break_wait_time, oplock_break_wait_time)
FN_LOCAL_BOOL(oplocks, oplocks)
FN_GLOBAL_SUBSTITUTED_STRING(os2_driver_map, os2_driver_map)
FN_GLOBAL_INTEGER(os_level, os_level)
FN_GLOBAL_BOOL(pam_password_change, pam_password_change)
FN_GLOBAL_SUBSTITUTED_STRING(panic_action, panic_action)
FN_GLOBAL_CONST_STRING(passdb_backend, passdb_backend)
FN_GLOBAL_BOOL(passdb_expand_explicit, passdb_expand_explicit)
FN_GLOBAL_SUBSTITUTED_STRING(passwd_chat, passwd_chat)
FN_GLOBAL_BOOL(passwd_chat_debug, passwd_chat_debug)
FN_GLOBAL_INTEGER(passwd_chat_timeout, passwd_chat_timeout)
FN_GLOBAL_SUBSTITUTED_STRING(passwd_program, passwd_program)
FN_GLOBAL_LIST(password_hash_gpg_key_ids, password_hash_gpg_key_ids)
FN_GLOBAL_LIST(password_hash_userpassword_schemes, password_hash_userpassword_schemes)
FN_GLOBAL_CONST_STRING(password_server, password_server)
FN_LOCAL_SUBSTITUTED_STRING(path, path)
FN_GLOBAL_SUBSTITUTED_STRING(perfcount_module, perfcount_module)
FN_GLOBAL_CONST_STRING(pid_directory, pid_directory)
FN_LOCAL_PARM_BOOL(posix_locking, posix_locking)
FN_LOCAL_SUBSTITUTED_STRING(postexec, postexec)
FN_LOCAL_SUBSTITUTED_STRING(preexec, preexec)
FN_LOCAL_BOOL(preexec_close, preexec_close)
FN_GLOBAL_INTEGER(_preferred_master, _preferred_master)
FN_GLOBAL_INTEGER(prefork_backoff_increment, prefork_backoff_increment)
FN_GLOBAL_INTEGER(prefork_children, prefork_children)
FN_GLOBAL_INTEGER(prefork_maximum_backoff, prefork_maximum_backoff)
...
FN_GLOBAL_CONST_STRING(printcap_name, printcap_name)
FN_LOCAL_CONST_STRING(print_command, print_command)
FN_LOCAL_SUBSTITUTED_STRING(_printername, _printername)
...
FN_LOCAL_CONST_STRING(queuepause_command, queuepause_command)
FN_LOCAL_CONST_STRING(queueresume_command, queueresume_command)
FN_GLOBAL_BOOL(raw_ntlmv2_auth, raw_ntlmv2_auth)
FN_LOCAL_LIST(read_list, read_list)
FN_LOCAL_BOOL(read_only, read_only)
FN_GLOBAL_BOOL(read_raw, read_raw)
FN_GLOBAL_CONST_STRING(realm, realm)
FN_GLOBAL_BOOL(registry_shares, registry_shares)
FN_GLOBAL_BOOL(reject_aes_netlogon_servers, reject_aes_netlogon_servers)
FN_GLOBAL_BOOL(reject_md5_clients, reject_md5_clients)
FN_GLOBAL_BOOL(reject_md5_servers, reject_md5_servers)
FN_GLOBAL_SUBSTITUTED_STRING(remote_announce, remote_announce)
FN_GLOBAL_SUBSTITUTED_STRING(remote_browse_sync, remote_browse_sync)
FN_GLOBAL_SUBSTITUTED_STRING(rename_user_script, rename_user_script)
...
FN_GLOBAL_SUBSTITUTED_STRING(root_directory, root_directory)
FN_LOCAL_SUBSTITUTED_STRING(root_postexec, root_postexec)
FN_LOCAL_SUBSTITUTED_STRING(root_preexec, root_preexec)
FN_LOCAL_BOOL(root_preexec_close, root_preexec_close)
FN_GLOBAL_BOOL(rpc_big_endian, rpc_big_endian)
FN_GLOBAL_CONST_STRING(rpc_server_dynamic_port_range, rpc_server_dynamic_port_range)
FN_GLOBAL_INTEGER(rpc_server_port, rpc_server_port)
FN_GLOBAL_BOOL(rpc_start_on_demand_helpers, rpc_start_on_demand_helpers)
FN_GLOBAL_LIST(samba_kcc_command, samba_kcc_command)
FN_GLOBAL_INTEGER(_security, _security)
FN_LOCAL_LIST(server_addresses, server_addresses)
FN_GLOBAL_INTEGER(server_max_protocol, server_max_protocol)
FN_GLOBAL_INTEGER(server_min_protocol, server_min_protocol)
FN_GLOBAL_BOOL(server_multi_channel_support, server_multi_channel_support)
FN_GLOBAL_BOOL(server_reject_aes_schannel, server_reject_aes_schannel)
FN_GLOBAL_INTEGER(_server_role, _server_role)
FN_GLOBAL_INTEGER(server_schannel, server_schannel)
FN_GLOBAL_BOOL(server_schannel_require_seal, server_schannel_require_seal)
FN_GLOBAL_LIST(server_services, server_services)
FN_GLOBAL_INTEGER(server_signing, server_signing)
FN_LOCAL_INTEGER(_server_smb_encrypt, _server_smb_encrypt)
FN_GLOBAL_LIST(server_smb3_encryption_algorithms, server_smb3_encryption_algorithms)
FN_GLOBAL_BOOL(server_smb_encryption_over_quic, server_smb_encryption_over_quic)
FN_GLOBAL_LIST(server_smb3_signing_algorithms, server_smb3_signing_algorithms)
FN_GLOBAL_LIST(server_smb_transports, server_smb_transports)
FN_GLOBAL_SUBSTITUTED_STRING(server_string, server_string)
FN_GLOBAL_BOOL(server_support_krb5_netlogon, server_support_krb5_netlogon)
FN_GLOBAL_SUBSTITUTED_STRING(set_primary_group_script, set_primary_group_script)
FN_GLOBAL_SUBSTITUTED_STRING(set_quota_command, set_quota_command)
FN_LOCAL_BOOL(short_preserve_case, short_preserve_case)
FN_GLOBAL_BOOL(show_add_printer_wizard, show_add_printer_wizard)
FN_GLOBAL_SUBSTITUTED_STRING(shutdown_script, shutdown_script)
FN_GLOBAL_BOOL(smb1_unix_extensions, smb1_unix_extensions)
FN_GLOBAL_BOOL(smb2_disable_lock_sequence_checking, smb2_disable_lock_sequence_checking)
FN_GLOBAL_BOOL(smb2_disable_oplock_break_retry, smb2_disable_oplock_break_retry)
FN_GLOBAL_BOOL(smb2_leases, smb2_leases)
FN_GLOBAL_INTEGER(smb2_max_credits, smb2_max_credits)
...
FN_GLOBAL_INTEGER(_smb3_directory_leases, _smb3_directory_leases)
FN_LOCAL_BOOL(smb3_unix_extensions, smb3_unix_extensions)
FN_LOCAL_BOOL(smbd_async_dosmode, smbd_async_dosmode)
FN_LOCAL_BOOL(smbd_getinfo_ask_sharemode, smbd_getinfo_ask_sharemode)
FN_LOCAL_INTEGER(smbd_max_async_dosmode, smbd_max_async_dosmode)
FN_LOCAL_INTEGER(smbd_max_xattr_size, smbd_max_xattr_size)
FN_LOCAL_BOOL(smbd_profiling_share, smbd_profiling_share)
FN_GLOBAL_INTEGER(smbd_profiling_level, smbd_profiling_level)
FN_LOCAL_BOOL(smbd_search_ask_sharemode, smbd_search_ask_sharemode)
...
FN_LOCAL_BOOL(spotlight, spotlight)
FN_LOCAL_INTEGER(spotlight_backend, spotlight_backend)
FN_GLOBAL_BOOL(stat_cache, stat_cache)
FN_GLOBAL_CONST_STRING(state_directory, state_directory)
...
FN_LOCAL_BOOL(_strict_rename, _strict_rename)
FN_LOCAL_BOOL(strict_sync, strict_sync)
FN_GLOBAL_LIST(svcctl_list, svcctl_list)
FN_LOCAL_BOOL(sync_always, sync_always)
FN_GLOBAL_SUBSTITUTED_STRING(sync_machine_password_script, sync_machine_password_script)
FN_GLOBAL_LIST(sync_machine_password_to_keytab, sync_machine_password_to_keytab)
...
FN_GLOBAL_LIST(tls_ca_directories, tls_ca_directories)
FN_GLOBAL_CONST_STRING(_tls_cafile, _tls_cafile)
FN_GLOBAL_CONST_STRING(_tls_certfile, _tls_certfile)
FN_GLOBAL_CONST_STRING(_tls_crlfile, _tls_crlfile)
FN_GLOBAL_CONST_STRING(_tls_dhpfile, _tls_dhpfile)
FN_GLOBAL_BOOL(tls_enabled, tls_enabled)
FN_GLOBAL_CONST_STRING(_tls_keyfile, _tls_keyfile)
FN_GLOBAL_CONST_STRING(tls_priority, tls_priority)
FN_GLOBAL_BOOL(tls_trust_system_cas, tls_trust_system_cas)
FN_GLOBAL_INTEGER(tls_verify_peer, tls_verify_peer)
...
FN_GLOBAL_SUBSTITUTED_STRING(username_map, username_map)
FN_GLOBAL_INTEGER(username_map_cache_time, username_map_cache_time)
FN_GLOBAL_SUBSTITUTED_STRING(username_map_script, username_map_script)
...
FN_GLOBAL_SUBSTITUTED_STRING(usershare_path, usershare_path)
...
FN_GLOBAL_CONST_STRING(usershare_template_share, usershare_template_share)
...
FN_LOCAL_SUBSTITUTED_STRING(veto_files, veto_files)
FN_LOCAL_SUBSTITUTED_STRING(veto_oplock_files, veto_oplock_files)
FN_LOCAL_INTEGER(vfs_mkdir_use_tmp_name, vfs_mkdir_use_tmp_name)
FN_LOCAL_LIST(vfs_objects, vfs_objects)
FN_LOCAL_SUBSTITUTED_STRING(volume, volume)
FN_LOCAL_INTEGER(volume_serial_number, volume_serial_number)
FN_LOCAL_BOOL(wide_links, wide_links)
...
FN_GLOBAL_INTEGER(_winbind_max_domain_connections, _winbind_max_domain_connections)
...
FN_GLOBAL_BOOL(winbind_scan_trusted_domains, winbind_scan_trusted_domains)
...
FN_GLOBAL_BOOL(winbind_use_krb5_enterprise_principals, winbind_use_krb5_enterprise_principals)
FN_GLOBAL_BOOL(winbind_varlink_service, winbind_varlink_service)
FN_GLOBAL_SUBSTITUTED_STRING(wins_hook, wins_hook)
...
FN_GLOBAL_BOOL(write_raw, write_raw)
FN_GLOBAL_CONST_STRING(wsp_property_file, wsp_property_file)
