...
#ifndef __PARAM_TABLE_GEN_C__
#define __PARAM_TABLE_GEN_C__
...
struct parm_struct parm_table[] = {
	...
	{
		.label		= "acl claims evaluation",
		.type		= P_ENUM,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(acl_claims_evaluation),
		.special	= NULL,
		.enum_list	= enum_acl_claims_evaluation,
	},
	{
		.label		= "acl flag inherited canonicalization",
		.type		= P_BOOL,
		.p_class	= P_LOCAL,
		.offset		= LOCAL_VAR(acl_flag_inherited_canonicalization),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
	...
	{
		.label		= "ad dc functional level",
		.type		= P_ENUM,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(ad_dc_functional_level),
		.special	= NULL,
		.enum_list	= enum_ad_functional_level,
	},
	{
	...
	{
		.label		= "additional dns hostnames",
		.type		= P_CMDLIST,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(additional_dns_hostnames),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
	...
	{
		.label		= "aio max threads",
		.type		= P_INTEGER,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(aio_max_threads),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
	...
	{
		.label		= "allow unsafe cluster upgrade",
		.type		= P_BOOL,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(allow_unsafe_cluster_upgrade),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
		.label		= "apply group policies",
		.type		= P_BOOL,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(apply_group_policies),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
		.label		= "async dns timeout",
		.type		= P_INTEGER,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(async_dns_timeout),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
	...
	{
		.label		= "auth event notification",
		.type		= P_BOOL,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(auth_event_notification),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
	...
	{
		.label		= "automount fs types",
		.type		= P_CMDLIST,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(automount_fs_types),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
	...
	},
	{
		...
		.type		= P_STRING,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(binddns_dir),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
		.label		= "bind dns directory",
		.type		= P_STRING,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(binddns_dir),
		.special	= NULL,
	...
	{
		.label		= "check parent directory delete on close",
		.type		= P_BOOL,
		.p_class	= P_LOCAL,
		.offset		= LOCAL_VAR(check_parent_directory_delete_on_close),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
	...
	{
		.label		= "client netlogon ping protocol",
		.type		= P_ENUM,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(client_netlogon_ping_protocol),
		.special	= NULL,
		.enum_list	= enum_client_netlogon_ping_protocol,
	},
	{
	...
	},
	{
		...
		.type		= P_ENUM,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(client_protection),
		.special	= NULL,
		.enum_list	= enum_client_protection_vals,
	},
	{
	...
	{
		.label		= "client smb encrypt",
		.type		= P_ENUM,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(client_smb_encrypt),
		.special	= NULL,
		.enum_list	= enum_smb_encryption_vals,
	},
	{
		.label		= "client smb3 encryption algorithms",
		.type		= P_LIST,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(client_smb3_encryption_algorithms),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
		.label		= "client smb encryption over quic",
		.type		= P_BOOL,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(client_smb_encryption_over_quic),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
		.label		= "client smb3 signing algorithms",
		.type		= P_LIST,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(client_smb3_signing_algorithms),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
		.label		= "client smb transports",
		.type		= P_LIST,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(client_smb_transports),
		.special	= handle_client_smb_transports,
		.enum_list	= NULL,
	},
	{
		.label		= "client use kerberos",
		.type		= P_ENUM,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(_client_use_kerberos),
		.special	= NULL,
		.enum_list	= enum_use_kerberos_vals,
	},
	{
		.label		= "client use krb5 netlogon",
		.type		= P_ENUM,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(_client_use_krb5_netlogon),
		.special	= NULL,
		.enum_list	= enum_bool_auto_default,
	},
	{
	...
	{
		.label		= "debug encryption",
		.type		= P_BOOL,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(debug_encryption),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
	...
	{
		.label		= "debug syslog format",
		.type		= P_ENUM,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(debug_syslog_format),
		.special	= NULL,
		.enum_list	= enum_debug_syslog_format,
	},
	{
		.label		= "winbind debug traceid",
		.type		= P_BOOL,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(winbind_debug_traceid),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
	...
	},
	{
		...
		.type		= P_STRING,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(_dns_hostname),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
	...
	{
		.label		= "dns zone scavenging",
		.type		= P_BOOL,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(dns_zone_scavenging),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
		.label		= "dns zone transfer clients allow",
		.type		= P_CMDLIST,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(dns_zone_transfer_clients_allow),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
		.label		= "dns zone transfer clients deny",
		.type		= P_CMDLIST,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(dns_zone_transfer_clients_deny),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
	...
	{
		.label		= "dsdb event notification",
		.type		= P_BOOL,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(dsdb_event_notification),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
		.label		= "dsdb group change notification",
		.type		= P_BOOL,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(dsdb_group_change_notification),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
		.label		= "dsdb password event notification",
		.type		= P_BOOL,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(dsdb_password_event_notification),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
	...
	{
		.label		= "smbd force process locks",
		.type		= P_BOOL,
		.p_class	= P_LOCAL,
		.offset		= LOCAL_VAR(smbd_force_process_locks),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
	...
	{
		.label		= "hide new files timeout",
		.type		= P_INTEGER,
		.p_class	= P_LOCAL,
		.offset		= LOCAL_VAR(hide_new_files_timeout),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
	...
	{
		.label		= "honor change notify privilege",
		.type		= P_BOOL,
		.p_class	= P_LOCAL,
		.offset		= LOCAL_VAR(honor_change_notify_privilege),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
	...
	{
		.label		= "include system krb5 conf",
		.type		= P_BOOL,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(include_system_krb5_conf),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
	...
	},
	{
		...
		.special	= NULL,
		.enum_list	= enum_inherit_owner_vals,
	},
	{
	...
	{
		.label		= "kdc always include pac",
		.type		= P_BOOL,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(kdc_always_include_pac),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
		.label		= "certificate backdating compensation",
		.type		= P_INTEGER,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(certificate_backdating_compensation),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
		.label		= "strong certificate binding enforcement",
		.type		= P_ENUM,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(strong_certificate_binding_enforcement),
		.special	= NULL,
		.enum_list	= enum_strong_cert_binding_enforcement_vals,
	},
	{
		.label		= "kdc default domain supported enctypes",
		.type		= P_INTEGER,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(kdc_default_domain_supported_enctypes),
		.special	= handle_kdc_default_domain_supported_enctypes,
		.enum_list	= NULL,
	},
	{
		.label		= "kdc enable fast",
		.type		= P_BOOL,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(kdc_enable_fast),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
		.label		= "kdc force enable rc4 weak session keys",
		.type		= P_BOOL,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(kdc_force_enable_rc4_weak_session_keys),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
		.label		= "kdc name match implicit dollar without canonicalization",
		.type		= P_BOOL,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(kdc_name_match_implicit_dollar_without_canonicalization),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
		.label		= "kdc require canonicalization",
		.type		= P_BOOL,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(kdc_require_canonicalization),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
		.label		= "kdc supported enctypes",
		.type		= P_INTEGER,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(kdc_supported_enctypes),
		.special	= handle_kdc_supported_enctypes,
		.enum_list	= NULL,
	},
	{
		.label		= "keepalive",
	...
	{
		.label		= "kerberos encryption types",
		.type		= P_ENUM,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(kerberos_encryption_types),
		.special	= NULL,
		.enum_list	= enum_kerberos_encryption_types_vals,
	},
	{
	...
	{
		.label		= "krb5 acceptor report canonical client name",
		.type		= P_BOOL,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(krb5_acceptor_report_canonical_client_name),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
	...
	},
	{
		...
		.type		= P_BOOL,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(_lanman_auth),
		.special	= NULL,
		.enum_list	= NULL,
		.flags		= FLAG_DEPRECATED,
	},
	...
	{
		.label		= "ldap max anonymous request size",
		.type		= P_INTEGER,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(ldap_max_anonymous_request_size),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
		.label		= "ldap max authenticated request size",
		.type		= P_INTEGER,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(ldap_max_authenticated_request_size),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
		.label		= "ldap max search request size",
		.type		= P_INTEGER,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(ldap_max_search_request_size),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
	...
	{
		.label		= "lsa over netlogon",
		.type		= P_BOOL,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(lsa_over_netlogon),
		.special	= NULL,
		.enum_list	= NULL,
		.flags		= FLAG_DEPRECATED,
	},
	...
	},
	{
		...
		.type		= P_ENUM,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(mdns_name),
		.special	= NULL,
		.enum_list	= enum_mdns_name_values,
	},
	{
	...
	{
		.label		= "min domain uid",
		.type		= P_INTEGER,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(min_domain_uid),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
	...
	{
		.label		= "mit kdc command",
		.type		= P_LIST,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(mit_kdc_command),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
	...
	},
	{
		...
		.special	= handle_name_resolve_order,
		.enum_list	= NULL,
	},
	{
	...
	},
	{
		...
		.type		= P_ENUM,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(nt_hash_store),
		.special	= NULL,
		.enum_list	= enum_nt_hash_store,
	},
	{
	...
	{
		.label		= "password hash gpg key ids",
		.type		= P_CMDLIST,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(password_hash_gpg_key_ids),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
		.label		= "password hash userPassword schemes",
		.type		= P_CMDLIST,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(password_hash_userpassword_schemes),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
	...
	{
		.label		= "prefork backoff increment",
		.type		= P_INTEGER,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(prefork_backoff_increment),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
		.label		= "prefork children",
		.type		= P_INTEGER,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(prefork_children),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
		.label		= "prefork maximum backoff",
		.type		= P_INTEGER,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(prefork_maximum_backoff),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
	...
	{
		.label		= "reject aes netlogon servers",
		.type		= P_BOOL,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(reject_aes_netlogon_servers),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
	...
	{
		.label		= "rpc server dynamic port range",
		.type		= P_STRING,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(rpc_server_dynamic_port_range),
		.special	= handle_rpc_server_dynamic_port_range,
		.enum_list	= NULL,
	},
	{
		...
		.type		= P_INTEGER,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(rpc_server_port),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
		.label		= "rpc start on demand helpers",
		.type		= P_BOOL,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(rpc_start_on_demand_helpers),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
	...
	},
	{
		...
		.type		= P_CMDLIST,
		.p_class	= P_LOCAL,
		.offset		= LOCAL_VAR(server_addresses),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
	...
	{
		.label		= "server multi channel support",
		.type		= P_BOOL,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(server_multi_channel_support),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
		.label		= "server reject aes schannel",
		.type		= P_BOOL,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(server_reject_aes_schannel),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
	...
	{
		.label		= "server schannel require seal",
		.type		= P_BOOL,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(server_schannel_require_seal),
		.special	= NULL,
		.enum_list	= NULL,
		.flags		= FLAG_DEPRECATED,
	},
	...
	{
		.label		= "server smb encrypt",
		.type		= P_ENUM,
		.p_class	= P_LOCAL,
		.offset		= LOCAL_VAR(_server_smb_encrypt),
		.special	= NULL,
		.enum_list	= enum_smb_encryption_vals,
	},
	{
		.label		= "server smb3 encryption algorithms",
		.type		= P_LIST,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(server_smb3_encryption_algorithms),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
		.label		= "server smb encryption over quic",
		.type		= P_BOOL,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(server_smb_encryption_over_quic),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
		.label		= "server smb3 signing algorithms",
		.type		= P_LIST,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(server_smb3_signing_algorithms),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
		.label		= "server smb transports",
		.type		= P_LIST,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(server_smb_transports),
		.special	= handle_server_smb_transports,
		.enum_list	= NULL,
	},
	{
		.label		= "smb ports",
	...
	{
		.label		= "server support krb5 netlogon",
		.type		= P_BOOL,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(server_support_krb5_netlogon),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
	...
	{
		.label		= "smb1 unix extensions",
		.type		= P_BOOL,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(smb1_unix_extensions),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
	...
	{
		.label		= "smb2 disable lock sequence checking",
		.type		= P_BOOL,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(smb2_disable_lock_sequence_checking),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
		.label		= "smb2 disable oplock break retry",
		.type		= P_BOOL,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(smb2_disable_oplock_break_retry),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
	...
	{
		.label		= "smb3 directory leases",
		.type		= P_ENUM,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(_smb3_directory_leases),
		.special	= NULL,
		.enum_list	= enum_bool_auto,
	},
	{
		.label		= "smb3 unix extensions",
		.type		= P_BOOL,
		.p_class	= P_LOCAL,
		.offset		= LOCAL_VAR(smb3_unix_extensions),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
		.label		= "smbd async dosmode",
		.type		= P_BOOL,
		.p_class	= P_LOCAL,
		.offset		= LOCAL_VAR(smbd_async_dosmode),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
		.label		= "smbd getinfo ask sharemode",
		.type		= P_BOOL,
		.p_class	= P_LOCAL,
		.offset		= LOCAL_VAR(smbd_getinfo_ask_sharemode),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
		.label		= "smbd max async dosmode",
		.type		= P_INTEGER,
		.p_class	= P_LOCAL,
		.offset		= LOCAL_VAR(smbd_max_async_dosmode),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
		.label		= "smbd max xattr size",
		.type		= P_INTEGER,
		.p_class	= P_LOCAL,
		.offset		= LOCAL_VAR(smbd_max_xattr_size),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
		.label		= "smbd profiling share",
		.type		= P_BOOL,
		.p_class	= P_LOCAL,
		.offset		= LOCAL_VAR(smbd_profiling_share),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
	...
	{
		.label		= "smbd search ask sharemode",
		.type		= P_BOOL,
		.p_class	= P_LOCAL,
		.offset		= LOCAL_VAR(smbd_search_ask_sharemode),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
	...
	{
		.label		= "spotlight backend",
		.type		= P_ENUM,
		.p_class	= P_LOCAL,
		.offset		= LOCAL_VAR(spotlight_backend),
		.special	= NULL,
		.enum_list	= enum_spotlight_backend,
	},
	{
		.label		= "stat cache",
		.type		= P_BOOL,
	...
	},
	{
		...
		.type		= P_BOOL,
		.p_class	= P_LOCAL,
		.offset		= LOCAL_VAR(_strict_rename),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
	...
	{
		.label		= "sync machine password script",
		.type		= P_STRING,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(sync_machine_password_script),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
		.label		= "sync machine password to keytab",
		.type		= P_CMDLIST,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(sync_machine_password_to_keytab),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
	...
	{
		.label		= "tls ca directories",
		.type		= P_LIST,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(tls_ca_directories),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
	...
	{
		.label		= "tls trust system cas",
		.type		= P_BOOL,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(tls_trust_system_cas),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
	...
	{
		.label		= "vfs mkdir use tmp name",
		.type		= P_ENUM,
		.p_class	= P_LOCAL,
		.offset		= LOCAL_VAR(vfs_mkdir_use_tmp_name),
		.special	= NULL,
		.enum_list	= enum_bool_auto,
	},
	{
	...
	},
	{
		...
		.type		= P_INTEGER,
		.p_class	= P_LOCAL,
		.offset		= LOCAL_VAR(volume_serial_number),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
	...
	{
		.label		= "winbind scan trusted domains",
		.type		= P_BOOL,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(winbind_scan_trusted_domains),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
	...
	{
		.label		= "winbind use krb5 enterprise principals",
		.type		= P_BOOL,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(winbind_use_krb5_enterprise_principals),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
		.label		= "winbind varlink service",
		.type		= P_BOOL,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(winbind_varlink_service),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
	...
	{
		.label		= "wsp property file",
		.type		= P_STRING,
		.p_class	= P_GLOBAL,
		.offset		= GLOBAL_VAR(wsp_property_file),
		.special	= NULL,
		.enum_list	= NULL,
	},
	{
