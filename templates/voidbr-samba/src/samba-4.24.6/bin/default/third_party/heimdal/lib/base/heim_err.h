...
typedef enum heim_error_number{
	...
	HEIM_ERR_RANDOM_OFFLINE = -1980176629,
	HEIM_ERR_CONFIG_BADFORMAT = -1980176628,
	HEIM_ERR_PA_CONTINUE_NEEDED = -1980176627,
	HEIM_ERR_PA_CANT_CONTINUE = -1980176626,
	HEIM_ERR_NO_MORE_PA_MECHS = -1980176625,
