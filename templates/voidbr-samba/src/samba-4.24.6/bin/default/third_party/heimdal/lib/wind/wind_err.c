#include "config.h"
/* Generated from /github/voidbr/voidbr-pkgmake/templates/voidbr-samba/src/samba-4.24.6/third_party/heimdal/lib/wind/wind_err.et */
/* $Id$ */
...
static const char *const wind_error_strings[] = {
	/* 000 */ N_("No error"),
