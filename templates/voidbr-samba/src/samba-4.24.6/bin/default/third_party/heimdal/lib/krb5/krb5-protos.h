...
void
initialize_k5e1_error_table (void);

void
initialize_k5e1_error_table_r (struct et_list **/*list*/);
...
void
initialize_krb_error_table_r (struct et_list **/*list*/);

void
initialize_kx59_error_table (void);

void
initialize_kx59_error_table_r (struct et_list **/*list*/);
...
krb5_set_error_string (
	...
	const char */*fmt*/,
	...)
     __attribute__ ((__format__ (__printf__, 2, 3))) KRB5_DEPRECATED_FUNCTION("Use krb5_set_error_message instead");
...
krb5_vset_error_string (
	...
	const char */*fmt*/,
	va_list /*args*/)
     __attribute__ ((__format__ (__printf__, 2, 0))) KRB5_DEPRECATED_FUNCTION("Use krb5_vset_error_message instead");
