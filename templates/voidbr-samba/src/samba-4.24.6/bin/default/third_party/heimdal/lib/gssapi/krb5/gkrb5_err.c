...
static const char *const gk5_error_strings[] = {
	...
	/* 009 */ N_("Credential store contained unknown elements"),
	/* 010 */ N_("Credential store cannot contain both a password and a credentials cache or client keytab"),
