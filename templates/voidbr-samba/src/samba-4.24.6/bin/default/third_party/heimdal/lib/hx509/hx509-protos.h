...
extern "C" {
  ...
  #endif
 #endif
 #ifndef HX509_LIB_NORETURN_FUNCTION
  #if defined(_WIN32)
   #define HX509_LIB_NORETURN_FUNCTION __declspec(dllimport noreturn)
  #else
   #define HX509_LIB_NORETURN_FUNCTION
  #endif
 #endif
 #ifndef HX509_LIB_CALL
  #if defined(_WIN32)
...
HX509_LIB_NORETURN_FUNCTION 
     __attribute__ ((__noreturn__, __format__ (__printf__, 4, 5))) void HX509_LIB_CALL hx509_err(hx509_context context, int exit_code, int error_code, const char *fmt, ...);
...
void
initialize_hx_error_table (void);

void
initialize_hx_error_table_r (struct et_list **/*list*/);
