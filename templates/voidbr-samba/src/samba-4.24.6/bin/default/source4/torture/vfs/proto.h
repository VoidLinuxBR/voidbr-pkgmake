#ifndef __SOURCE4_TORTURE_VFS_PROTO_H__
#define __SOURCE4_TORTURE_VFS_PROTO_H__
...
/* The following definitions come from ../../source4/torture/vfs/streams_xattr.c  */

struct torture_suite *torture_vfs_streams_xattr(TALLOC_CTX *ctx);
#undef _PRINTF_ATTRIBUTE
#define _PRINTF_ATTRIBUTE(a1, a2)

#endif /* __SOURCE4_TORTURE_VFS_PROTO_H__ */
