...
_PUBLIC_ enum ndr_err_code ndr_push_share_mode_entry(struct ndr_push *ndr, ndr_flags_type ndr_flags, const struct share_mode_entry *r)
{
	...
	if (ndr_flags & NDR_SCALARS) {
		...
		NDR_CHECK(ndr_push_timeval_legacy(ndr, NDR_SCALARS, &r->time));
	...
	if (ndr_flags & NDR_BUFFERS) {
		NDR_CHECK(ndr_push_timeval_legacy(ndr, NDR_BUFFERS, &r->time));
		/* [skip] 'r->stale' */
	}
	return NDR_ERR_SUCCESS;
}
...
_PUBLIC_ enum ndr_err_code ndr_pull_share_mode_entry(struct ndr_pull *ndr, ndr_flags_type ndr_flags, struct share_mode_entry *r)
{
	...
	if (ndr_flags & NDR_SCALARS) {
		...
		NDR_CHECK(ndr_pull_timeval_legacy(ndr, NDR_SCALARS, &r->time));
	...
	if (ndr_flags & NDR_BUFFERS) {
		NDR_CHECK(ndr_pull_timeval_legacy(ndr, NDR_BUFFERS, &r->time));
	}
	return NDR_ERR_SUCCESS;
}
...
_PUBLIC_ void ndr_print_share_mode_entry(struct ndr_print *ndr, const char *name, const struct share_mode_entry *r)
{
	...
	ndr_print_timeval_legacy(ndr, "time", &r->time);
...
static enum ndr_err_code ndr_push_vfs_default_durable_stat(struct ndr_push *ndr, ndr_flags_type ndr_flags, const struct vfs_default_durable_stat *r)
{
	...
	if (ndr_flags & NDR_SCALARS) {
		...
		NDR_CHECK(ndr_push_timespec_legacy(ndr, NDR_SCALARS, &r->st_ex_atime));
		NDR_CHECK(ndr_push_timespec_legacy(ndr, NDR_SCALARS, &r->st_ex_mtime));
		NDR_CHECK(ndr_push_timespec_legacy(ndr, NDR_SCALARS, &r->st_ex_ctime));
		NDR_CHECK(ndr_push_timespec_legacy(ndr, NDR_SCALARS, &r->st_ex_btime));
	...
	if (ndr_flags & NDR_BUFFERS) {
		NDR_CHECK(ndr_push_timespec_legacy(ndr, NDR_BUFFERS, &r->st_ex_atime));
		NDR_CHECK(ndr_push_timespec_legacy(ndr, NDR_BUFFERS, &r->st_ex_mtime));
		NDR_CHECK(ndr_push_timespec_legacy(ndr, NDR_BUFFERS, &r->st_ex_ctime));
		NDR_CHECK(ndr_push_timespec_legacy(ndr, NDR_BUFFERS, &r->st_ex_btime));
	}
	return NDR_ERR_SUCCESS;
}
...
static enum ndr_err_code ndr_pull_vfs_default_durable_stat(struct ndr_pull *ndr, ndr_flags_type ndr_flags, struct vfs_default_durable_stat *r)
{
	...
	if (ndr_flags & NDR_SCALARS) {
		...
		NDR_CHECK(ndr_pull_timespec_legacy(ndr, NDR_SCALARS, &r->st_ex_atime));
		NDR_CHECK(ndr_pull_timespec_legacy(ndr, NDR_SCALARS, &r->st_ex_mtime));
		NDR_CHECK(ndr_pull_timespec_legacy(ndr, NDR_SCALARS, &r->st_ex_ctime));
		NDR_CHECK(ndr_pull_timespec_legacy(ndr, NDR_SCALARS, &r->st_ex_btime));
	...
	if (ndr_flags & NDR_BUFFERS) {
		NDR_CHECK(ndr_pull_timespec_legacy(ndr, NDR_BUFFERS, &r->st_ex_atime));
		NDR_CHECK(ndr_pull_timespec_legacy(ndr, NDR_BUFFERS, &r->st_ex_mtime));
		NDR_CHECK(ndr_pull_timespec_legacy(ndr, NDR_BUFFERS, &r->st_ex_ctime));
		NDR_CHECK(ndr_pull_timespec_legacy(ndr, NDR_BUFFERS, &r->st_ex_btime));
	}
	return NDR_ERR_SUCCESS;
}
...
_PUBLIC_ void ndr_print_vfs_default_durable_stat(struct ndr_print *ndr, const char *name, const struct vfs_default_durable_stat *r)
{
	...
	ndr_print_timespec_legacy(ndr, "st_ex_atime", &r->st_ex_atime);
	ndr_print_timespec_legacy(ndr, "st_ex_mtime", &r->st_ex_mtime);
	ndr_print_timespec_legacy(ndr, "st_ex_ctime", &r->st_ex_ctime);
	ndr_print_timespec_legacy(ndr, "st_ex_btime", &r->st_ex_btime);
