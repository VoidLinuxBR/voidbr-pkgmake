...
#define YYSTYPE         MDSYYLSTYPE
/* Substitute the variable and function names.  */
#define yyparse         mdsyylparse
#define yylex           mdsyyllex
#define yyerror         mdsyylerror
#define yydebug         mdsyyldebug
#define yynerrs         mdsyylnerrs
#define yylval          mdsyyllval
#define yychar          mdsyylchar
...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_FUNC_INRANGE = 6,               /* FUNC_INRANGE  */
  YYSYMBOL_DATE_ISO = 7,                   /* DATE_ISO  */
  YYSYMBOL_OBRACE = 8,                     /* OBRACE  */
  YYSYMBOL_CBRACE = 9,                     /* CBRACE  */
  ...
  YYSYMBOL_attribute = 24,                 /* attribute  */
  YYSYMBOL_value = 25,                     /* value  */
  YYSYMBOL_isodate = 26                    /* isodate  */
};
...
# endif
     ...
     && (! defined __cplusplus \
         || (defined MDSYYLSTYPE_IS_TRIVIAL && MDSYYLSTYPE_IS_TRIVIAL)))
...
{
       0,   114,   114,   116,   120,   132,   140,   152,   164,   167,
     180,   187,   194,   201,   208,   211,   216,   223,   232,   244,
     247,   252
};
#endif
...
{
  "\"end of file\"", "error", "\"invalid token\"", "WORD", "PHRASE",
  "BOOLEAN", "FUNC_INRANGE", "DATE_ISO", "OBRACE", "CBRACE", "EQUAL",
  "UNEQUAL", "GT", "LT", "COMMA", "QUOTE", "OR", "AND", "$accept", "input",
  "line", "expr", "match", "function", "attribute", "value", "isodate", YY_NULLPTR
};
...
{
     -19,     7,   -19,   -19,   -19,    -3,    -2,   -19,    11,    -1,
     -19,    12,    27,     2,    -2,    -2,   -19,    22,    22,    22,
      22,    20,   -19,    18,   -19,   -19,     8,   -19,   -19,   -19,
     -19,   -19,    14,    33,    23,    24,    30,    37,    34,   -19,
      35,    36,   -19,   -19
};
...
{
       2,     0,     1,    18,     9,     0,     0,     3,     4,     8,
      14,     0,     0,     0,     0,     0,    15,     0,     0,     0,
       0,     0,     5,     7,     6,    19,     0,    10,    20,    11,
      13,    12,     0,     0,     0,     0,     0,     0,     0,    21,
       0,     0,    16,    17
};
...
{
     -19,   -19,   -19,    -6,   -19,   -19,    31,    13,   -18
};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
       0,     1,     7,     8,     9,    10,    11,    27,    28
};
...
{
      13,     3,    16,     4,     5,    12,     6,     2,    23,    24,
       3,    22,     4,     5,    35,     6,    33,    34,    14,    15,
      41,    26,    17,    18,    19,    20,    25,    14,    15,    26,
       3,    29,    30,    31,    32,    15,    36,    37,    38,    39,
      40,    26,     0,    21,    42,    43
};

static const yytype_int8 yycheck[] =
{
       6,     3,     3,     5,     6,     8,     8,     0,    14,    15,
       3,     9,     5,     6,    32,     8,     8,     3,    16,    17,
      38,     7,    10,    11,    12,    13,     4,    16,    17,     7,
       3,    18,    19,    20,    14,    17,     3,    14,    14,     9,
       3,     7,    -1,    12,     9,     9
};
...
{
       0,    19,     0,     3,     5,     6,     8,    20,    21,    22,
      23,    24,     8,    21,    16,    17,     3,    10,    11,    12,
      13,    24,     9,    21,    21,     4,     7,    25,    26,    25,
      25,    25,    14,     8,     3,    26,     3,    14,    14,     9,
       3,    26,     9,     9
};
...
#define yyclearin       (yychar = MDSYYLEMPTY)
...
/* Backward compatibility with an undocumented macro.
   Use MDSYYLerror or MDSYYLUNDEF. */
#define YYERRCODE MDSYYLUNDEF
...
#define YYPOPSTACK(N)   (yyvsp -= (N), yyssp -= (N))
  ...
  yychar = MDSYYLEMPTY; /* Cause a token to be read.  */
...
yyreduce:
  ...
  case 4: /* line: expr  */
	...
	global_es_parser_state->result = (yyvsp[0].sval);
}
    break;

  case 5: /* expr: OBRACE expr CBRACE  */
                   {
  ...
  case 6: /* expr: expr AND expr  */
                {
	if ((yyvsp[-2].sval) == NULL && (yyvsp[0].sval) == NULL) {
		(yyval.sval) = NULL;
	} else if ((yyvsp[-2].sval) == NULL) {
		(yyval.sval) = (yyvsp[0].sval);
	} else if ((yyvsp[0].sval) == NULL) {
		(yyval.sval) = (yyvsp[-2].sval);
	} else {
		(yyval.sval) = talloc_asprintf(talloc_tos(), "(%s) AND (%s)", (yyvsp[-2].sval), (yyvsp[0].sval));
		if ((yyval.sval) == NULL) YYABORT;
	}
}
    break;
  ...
  case 7: /* expr: expr OR expr  */
	...
	if ((yyvsp[-2].sval) == NULL && (yyvsp[0].sval) == NULL) {
		...
		(yyval.sval) = talloc_asprintf(talloc_tos(), "%s OR %s", (yyvsp[-2].sval), (yyvsp[0].sval));
		if ((yyval.sval) == NULL) YYABORT;
	}
}
    break;
  ...
  case 10: /* match: attribute EQUAL value  */
                      {
	if ((yyvsp[-2].attr_map) == NULL) {
		(yyval.sval) = NULL;
	} else {
		(yyval.sval) = map_expr((yyvsp[-2].attr_map), '=', (yyvsp[0].sval), NULL);
	}
}
    break;

  case 11: /* match: attribute UNEQUAL value  */
                          {
	if ((yyvsp[-2].attr_map) == NULL) {
		(yyval.sval) = NULL;
	} else {
  ...
  case 12: /* match: attribute LT value  */
                     {
	if ((yyvsp[-2].attr_map) == NULL) {
		(yyval.sval) = NULL;
	} else {
  ...
  case 13: /* match: attribute GT value  */
                     {
	if ((yyvsp[-2].attr_map) == NULL) {
		(yyval.sval) = NULL;
	} else {
  ...
  case 14: /* match: function  */
           {
	(yyval.sval) = (yyvsp[0].sval);
}
    break;

  case 15: /* match: match WORD  */
             {
	(yyval.sval) = (yyvsp[-1].sval);
}
    break;

  case 16: /* function: FUNC_INRANGE OBRACE attribute COMMA WORD COMMA WORD CBRACE  */
                                                           {
	if ((yyvsp[-5].attr_map) == NULL) {
		(yyval.sval) = NULL;
	} else {
		(yyval.sval) = map_expr((yyvsp[-5].attr_map), '~', (yyvsp[-3].sval), (yyvsp[-1].sval));
	}
}
    break;

  case 17: /* function: FUNC_INRANGE OBRACE attribute COMMA isodate COMMA isodate CBRACE  */
                                                                   {
	if ((yyvsp[-5].attr_map) == NULL) {
		(yyval.sval) = NULL;
	} else {
  ...
  case 18: /* attribute: WORD  */
     {
	(yyval.attr_map) = es_map_sl_attr(global_es_parser_state->frame,
			    global_es_parser_state->kmd_map,
			    (yyvsp[0].sval));
	if ((yyval.attr_map) == NULL &&
  ...
  case 19: /* value: PHRASE  */
       {
	(yyval.sval) = (yyvsp[0].sval);
}
    break;

  case 20: /* value: isodate  */
          {
	(yyval.sval) = (yyvsp[0].sval);
}
    break;

  case 21: /* isodate: DATE_ISO OBRACE WORD CBRACE  */
                            {
	(yyval.sval) = isodate_to_sldate((yyvsp[-1].sval));
	if ((yyval.sval) == NULL) YYABORT;
}
    break;
...
yyerrlab:
  ...
  yytoken = yychar == MDSYYLEMPTY ? YYSYMBOL_YYEMPTY : YYTRANSLATE (yychar);
