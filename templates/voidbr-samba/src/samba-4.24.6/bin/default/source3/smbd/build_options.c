...
void build_options(bool screen)
{
	...
	/* Show System Headers */
       ...
       output(screen, "   HAVE_SYS_RANDOM_H\n");
#endif
	...
	/* Show Headers */
...
#endif
#ifdef HAVE_GPFS_H
       output(screen, "   HAVE_GPFS_H\n");
#endif
#ifdef HAVE_GPGME_H
       output(screen, "   HAVE_GPGME_H\n");
#endif
#ifdef HAVE_GRP_H
       ...
       output(screen, "   HAVE_LINUX_MAGIC_H\n");
#endif
#ifdef HAVE_LINUX_NETLINK_H
       output(screen, "   HAVE_LINUX_NETLINK_H\n");
#endif
#ifdef HAVE_LINUX_OPENAT2_H
       output(screen, "   HAVE_LINUX_OPENAT2_H\n");
#endif
       ...
       output(screen, "   HAVE_LINUX_TLS_H\n");
#endif
#ifdef HAVE_LINUX_TYPES_H
       output(screen, "   HAVE_LINUX_TYPES_H\n");
#endif
#ifdef HAVE_LMDB_H
       output(screen, "   HAVE_LMDB_H\n");
#endif
#ifdef HAVE_LOCALE_H
       ...
       output(screen, "   HAVE_UNICODE_USTRING_H\n");
#endif
#ifdef HAVE_UNISTD_H
	...
	/* Show HAVE_* Defines */
       ...
       output(screen, "   HAVE_CLIENT_GSS_C_CHANNEL_BOUND_FLAG\n");
#endif
       ...
       output(screen, "   HAVE_COPY_FILE_RANGE\n");
#endif
...
#endif
#ifdef HAVE_DECL_KRB5_PAC_GET_BUFFER
       output(screen, "   HAVE_DECL_KRB5_PAC_GET_BUFFER\n");
#endif
...
#endif
#ifdef HAVE_DECL_TLS_CIPHER_AES_CCM_128
       output(screen, "   HAVE_DECL_TLS_CIPHER_AES_CCM_128\n");
#endif
#ifdef HAVE_DECL_TLS_CIPHER_AES_GCM_256
       output(screen, "   HAVE_DECL_TLS_CIPHER_AES_GCM_256\n");
#endif
#ifdef HAVE_DECL_TLS_CIPHER_CHACHA20_POLY1305
       output(screen, "   HAVE_DECL_TLS_CIPHER_CHACHA20_POLY1305\n");
#endif
       ...
       output(screen, "   HAVE_EPOLL_CREATE1\n");
#endif
#ifdef HAVE_ERR
...
#endif
#ifdef HAVE_FUSE
       output(screen, "   HAVE_FUSE\n");
#endif
#ifdef HAVE_FUSE_MOUNT
       output(screen, "   HAVE_FUSE_MOUNT\n");
#endif
#ifdef HAVE_FUTIMENS
       ...
       output(screen, "   HAVE_GETDOMAINNAME\n");
#endif
#ifdef HAVE_GETGRENT
       ...
       output(screen, "   HAVE_GNUTLS_CB_TLS_SERVER_END_POINT\n");
#endif
#ifdef HAVE_GNUTLS_CIPHER_ENCRYPT3
       output(screen, "   HAVE_GNUTLS_CIPHER_ENCRYPT3\n");
#endif
#ifdef HAVE_GNUTLS_FIPS_MODE_SUPPORTED
       output(screen, "   HAVE_GNUTLS_FIPS_MODE_SUPPORTED\n");
#endif
#ifdef HAVE_GOOD_LMDB_VERSION
       output(screen, "   HAVE_GOOD_LMDB_VERSION\n");
#endif
#ifdef HAVE_GPFS
       output(screen, "   HAVE_GPFS\n");
#endif
#ifdef HAVE_GPGME
       output(screen, "   HAVE_GPGME\n");
#endif
       ...
       output(screen, "   HAVE_GSS_KEY_VALUE_SET_DESC\n");
#endif
       ...
       output(screen, "   HAVE_IF_NAMEINDEX\n");
#endif
       ...
       output(screen, "   HAVE_KRB5_ADDLOG_FUNC_NEED_CONTEXT\n");
#endif
...
#endif
#ifdef HAVE_KRB5_CONST_PAC
       output(screen, "   HAVE_KRB5_CONST_PAC\n");
#endif
       ...
       output(screen, "   HAVE_KRB5_GET_INIT_CREDS_OPT_SET_FAST_CCACHE\n");
#endif
#ifdef HAVE_KRB5_GET_INIT_CREDS_OPT_SET_FAST_FLAGS
       output(screen, "   HAVE_KRB5_GET_INIT_CREDS_OPT_SET_FAST_FLAGS\n");
#endif
       ...
       output(screen, "   HAVE_KRB5_INIT_CREDS_STEP\n");
#endif
...
#endif
#ifdef HAVE_KRB5_PAC_IS_TRUSTED
       output(screen, "   HAVE_KRB5_PAC_IS_TRUSTED\n");
#endif
...
#endif
#ifdef HAVE_LDAP_TRANSPORT_WRAPPING
       output(screen, "   HAVE_LDAP_TRANSPORT_WRAPPING\n");
#endif
#ifdef HAVE_LDWRAP
...
#endif
#ifdef HAVE_LIBFUSE
       output(screen, "   HAVE_LIBFUSE\n");
#endif
#ifdef HAVE_LIBGPGME
       output(screen, "   HAVE_LIBGPGME\n");
#endif
#ifdef HAVE_LIBICUI18N
       output(screen, "   HAVE_LIBICUI18N\n");
#endif
       ...
       output(screen, "   HAVE_LINUX_THREAD_CREDENTIALS\n");
#endif
       ...
       output(screen, "   HAVE_MALLINFO2\n");
#endif
#ifdef HAVE_MDB_ENV_CREATE
       output(screen, "   HAVE_MDB_ENV_CREATE\n");
#endif
#ifdef HAVE_MEMALIGN
       ...
       output(screen, "   HAVE_SECURE_GETENV\n");
#endif
       ...
       output(screen, "   HAVE_SPOTLIGHT_BACKEND_ES\n");
#endif
#ifdef HAVE_SRAND
       ...
       output(screen, "   HAVE_TCP_USER_TIMEOUT\n");
#endif
...
#endif
#ifdef HAVE_UTF8_NORMALISATION
       output(screen, "   HAVE_UTF8_NORMALISATION\n");
#endif
#ifdef HAVE_UTIMBUF
...
#endif
#ifdef HAVE_WNO_UNUSED_BUT_SET_VARIABLE
       output(screen, "   HAVE_WNO_UNUSED_BUT_SET_VARIABLE\n");
#endif
...
#endif
#ifdef HAVE_WUSE_AFTER_FREE_1
       output(screen, "   HAVE_WUSE_AFTER_FREE_1\n");
#endif
...
#endif
#ifdef HAVE___ATOMIC_ADD_FETCH
       output(screen, "   HAVE___ATOMIC_ADD_FETCH\n");
#endif
#ifdef HAVE___ATOMIC_ADD_LOAD
       output(screen, "   HAVE___ATOMIC_ADD_LOAD\n");
#endif
       ...
       output(screen, "   HAVE___SYNC_ADD_AND_FETCH\n");
#endif
...
#endif
#ifdef WITH_KERNEL_KEYRING
       output(screen, "   WITH_KERNEL_KEYRING\n");
#endif
#ifdef WITH_PAM
...
#endif
#ifdef WITH_SMB1SERVER
       output(screen, "   WITH_SMB1SERVER\n");
#endif
	...
	/* Show Build Options */
       ...
       output(screen, "   AD_DC_BUILD_IS_ENABLED\n");
#endif
#ifdef ALLOW_GNUTLS_AEAD_CIPHER_ENCRYPTV2_AES_CCM
       output(screen, "   ALLOW_GNUTLS_AEAD_CIPHER_ENCRYPTV2_AES_CCM\n");
#endif
#ifdef AR
       output(screen, "   AR\n");
#endif
...
#endif
#ifdef CFLAGS_acl
       output(screen, "   CFLAGS_acl\n");
#endif
#ifdef CFLAGS_archive
       output(screen, "   CFLAGS_archive\n");
#endif
#ifdef CFLAGS_avahi_client
       output(screen, "   CFLAGS_avahi_client\n");
#endif
#ifdef CFLAGS_avahi_common
       output(screen, "   CFLAGS_avahi_common\n");
#endif
#ifdef CFLAGS_bsd
       output(screen, "   CFLAGS_bsd\n");
#endif
#ifdef CFLAGS_cap
       output(screen, "   CFLAGS_cap\n");
#endif
#ifdef CFLAGS_crypt
       output(screen, "   CFLAGS_crypt\n");
#endif
#ifdef CFLAGS_crypto
       output(screen, "   CFLAGS_crypto\n");
#endif
#ifdef CFLAGS_cshlib
...
#endif
#ifdef CFLAGS_dbus_1
       output(screen, "   CFLAGS_dbus_1\n");
#endif
#ifdef CFLAGS_form
       output(screen, "   CFLAGS_form\n");
#endif
#ifdef CFLAGS_fuse
       output(screen, "   CFLAGS_fuse\n");
#endif
#ifdef CFLAGS_gpgme
       output(screen, "   CFLAGS_gpgme\n");
#endif
#ifdef CFLAGS_icui18n
       output(screen, "   CFLAGS_icui18n\n");
#endif
...
#endif
#ifdef DEFAULT_PRIVATE_LIBS
       output(screen, "   DEFAULT_PRIVATE_LIBS\n");
#endif
...
#endif
#ifdef ENABLE_GPGME
       output(screen, "   ENABLE_GPGME\n");
#endif
#ifdef ENABLE_LDAP_BACKEND
       output(screen, "   ENABLE_LDAP_BACKEND\n");
#endif
#ifdef EXEC_PREFIX
...
#endif
#ifdef FOUND_SYSTEMLIB_libngtcp2_crypto_gnutls
       output(screen, "   FOUND_SYSTEMLIB_libngtcp2_crypto_gnutls\n");
#endif
#ifdef FOUND_SYSTEMLIB_libquic
       output(screen, "   FOUND_SYSTEMLIB_libquic\n");
#endif
...
#endif
#ifdef FOUND_SYSTEMLIB_pytalloc_util_cpython_314_x86_64_linux_gnu
       output(screen, "   FOUND_SYSTEMLIB_pytalloc_util_cpython_314_x86_64_linux_gnu\n");
#endif
...
#endif
#ifdef GPGME_CONFIG
       output(screen, "   GPGME_CONFIG\n");
#endif
#ifdef HEIMDAL_LEX_WNO_IMPLICIT_FALLTHROUGH_CFLAGS
       output(screen, "   HEIMDAL_LEX_WNO_IMPLICIT_FALLTHROUGH_CFLAGS\n");
#endif
#ifdef HEIMDAL_LEX_WNO_STRICT_PROTOTYPES_CFLAGS
       output(screen, "   HEIMDAL_LEX_WNO_STRICT_PROTOTYPES_CFLAGS\n");
#endif
#ifdef HEIMDAL_NO_ERROR_CFLAGS
       output(screen, "   HEIMDAL_NO_ERROR_CFLAGS\n");
#endif
#ifdef HEIMDAL_UNPICKY_WNO_FREE_NOHEAP_OBJECT_CFLAGS
       output(screen, "   HEIMDAL_UNPICKY_WNO_FREE_NOHEAP_OBJECT_CFLAGS\n");
#endif
#ifdef HEIMDAL_UNPICKY_WNO_STRICT_OVERFLOW_CFLAGS
       output(screen, "   HEIMDAL_UNPICKY_WNO_STRICT_OVERFLOW_CFLAGS\n");
#endif
#ifdef HOSTCC
...
#endif
#ifdef INCLUDES_DBUS_1
       output(screen, "   INCLUDES_DBUS_1\n");
#endif
...
#endif
#ifdef INTLCACHE_ST
       output(screen, "   INTLCACHE_ST\n");
#endif
#ifdef INTLFLAGS_DEFAULT
       output(screen, "   INTLFLAGS_DEFAULT\n");
#endif
#ifdef KRB5_CONST_PAC_GET_BUFFER
       output(screen, "   KRB5_CONST_PAC_GET_BUFFER\n");
#endif
...
#endif
#ifdef LDBMODULESDIR
       output(screen, "   LDBMODULESDIR\n");
#endif
#ifdef LDB_MODULESDIR
       output(screen, "   LDB_MODULESDIR\n");
#endif
#ifdef LDB_PACKAGE_VERSION
       output(screen, "   LDB_PACKAGE_VERSION\n");
#endif
#ifdef LDFLAGS_acl
       output(screen, "   LDFLAGS_acl\n");
#endif
#ifdef LDFLAGS_archive
       output(screen, "   LDFLAGS_archive\n");
#endif
#ifdef LDFLAGS_avahi_client
       output(screen, "   LDFLAGS_avahi_client\n");
#endif
#ifdef LDFLAGS_avahi_common
       output(screen, "   LDFLAGS_avahi_common\n");
#endif
#ifdef LDFLAGS_bsd
       output(screen, "   LDFLAGS_bsd\n");
#endif
#ifdef LDFLAGS_cap
       output(screen, "   LDFLAGS_cap\n");
#endif
#ifdef LDFLAGS_crypt
       output(screen, "   LDFLAGS_crypt\n");
#endif
#ifdef LDFLAGS_crypto
       output(screen, "   LDFLAGS_crypto\n");
#endif
#ifdef LDFLAGS_cups
       output(screen, "   LDFLAGS_cups\n");
#endif
#ifdef LDFLAGS_dbus_1
       output(screen, "   LDFLAGS_dbus_1\n");
#endif
#ifdef LDFLAGS_form
       output(screen, "   LDFLAGS_form\n");
#endif
#ifdef LDFLAGS_fuse
       output(screen, "   LDFLAGS_fuse\n");
#endif
#ifdef LDFLAGS_gpgme
       output(screen, "   LDFLAGS_gpgme\n");
#endif
#ifdef LDFLAGS_icui18n
       output(screen, "   LDFLAGS_icui18n\n");
#endif
...
#endif
#ifdef LIBNGTCP2_UNPICKY_CFLAGS
       output(screen, "   LIBNGTCP2_UNPICKY_CFLAGS\n");
#endif
#ifdef LIBPATH
...
#endif
#ifdef LIBPATH_gpgme
       output(screen, "   LIBPATH_gpgme\n");
#endif
#ifdef LIBQUIC_UNPICKY_CFLAGS
       output(screen, "   LIBQUIC_UNPICKY_CFLAGS\n");
#endif
#ifdef LIBREPLACE_NETWORK_CHECKS
       output(screen, "   LIBREPLACE_NETWORK_CHECKS\n");
#endif
#ifdef LIB_ACL
       output(screen, "   LIB_ACL\n");
#endif
#ifdef LIB_ARCHIVE
       output(screen, "   LIB_ARCHIVE\n");
#endif
#ifdef LIB_AVAHI_CLIENT
       output(screen, "   LIB_AVAHI_CLIENT\n");
#endif
#ifdef LIB_AVAHI_COMMON
       output(screen, "   LIB_AVAHI_COMMON\n");
#endif
#ifdef LIB_BSD
       output(screen, "   LIB_BSD\n");
#endif
#ifdef LIB_CAP
       output(screen, "   LIB_CAP\n");
#endif
#ifdef LIB_CMOCKA
       output(screen, "   LIB_CMOCKA\n");
#endif
#ifdef LIB_CRYPT
       output(screen, "   LIB_CRYPT\n");
#endif
#ifdef LIB_CRYPTO
       output(screen, "   LIB_CRYPTO\n");
#endif
#ifdef LIB_CUPS
       output(screen, "   LIB_CUPS\n");
#endif
#ifdef LIB_DBUS_1
       output(screen, "   LIB_DBUS_1\n");
#endif
#ifdef LIB_FORM
       output(screen, "   LIB_FORM\n");
#endif
#ifdef LIB_FUSE
       output(screen, "   LIB_FUSE\n");
#endif
#ifdef LIB_GNUTLS
       output(screen, "   LIB_GNUTLS\n");
#endif
#ifdef LIB_GPGME
       output(screen, "   LIB_GPGME\n");
#endif
#ifdef LIB_ICUI18N
       output(screen, "   LIB_ICUI18N\n");
#endif
#ifdef LIB_JANSSON
...
#endif
#ifdef SAMBA_CATALOG
       output(screen, "   SAMBA_CATALOG\n");
#endif
#ifdef SAMBA_CATALOGS
       output(screen, "   SAMBA_CATALOGS\n");
#endif
#ifdef SAMBA_DATADIR
       output(screen, "   SAMBA_DATADIR\n");
#endif
#ifdef SAMBA_EXPAND_XSL
       output(screen, "   SAMBA_EXPAND_XSL\n");
#endif
#ifdef SAMBA_GENERATOR_VARS
       output(screen, "   SAMBA_GENERATOR_VARS\n");
#endif
#ifdef SAMBA_LIBEXECDIR
       output(screen, "   SAMBA_LIBEXECDIR\n");
#endif
#ifdef SAMBA_MAN_XSL
       output(screen, "   SAMBA_MAN_XSL\n");
#endif
#ifdef SBINDIR
       ...
       output(screen, "   SOURCE_DATE_EPOCH\n");
#endif
#ifdef SRCDIR
...
#endif
#ifdef STRING_SHARED_MODULES
       output(screen, "   STRING_SHARED_MODULES\n");
#endif
       ...
       output(screen, "   USING_EMBEDDED_HEIMDAL\n");
#endif
#ifdef USING_SYSTEM_CMOCKA
       output(screen, "   USING_SYSTEM_CMOCKA\n");
#endif
...
#endif
#ifdef ldb_is_public_library
       output(screen, "   ldb_is_public_library\n");
#endif
#ifdef ldb_modules_install_dir
       output(screen, "   ldb_modules_install_dir\n");
#endif
...
#endif
#ifdef spotlight_backend_es
       output(screen, "   spotlight_backend_es\n");
#endif
#ifdef srcdir
       output(screen, "   srcdir\n");
#endif
...
#endif
#ifdef systemd_ctdb_extra
       output(screen, "   systemd_ctdb_extra\n");
#endif
...
#endif
#ifdef vfs_aio_ratelimit_init
       output(screen, "   vfs_aio_ratelimit_init\n");
#endif
...
#endif
#ifdef vfs_widelinks_init
       output(screen, "   vfs_widelinks_init\n");
#endif
#ifdef vfs_worm_init
