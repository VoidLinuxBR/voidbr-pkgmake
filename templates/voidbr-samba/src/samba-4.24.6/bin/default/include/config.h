...
#ifndef W_DEFAULT_INCLUDE_CONFIG_H_WAF
#define W_DEFAULT_INCLUDE_CONFIG_H_WAF

#define CONFIG_H_IS_FROM_SAMBA 1
#define _SAMBA_BUILD_ 4
#define HAVE_CONFIG_H 1
#define SRCDIR "/github/voidbr/voidbr-pkgmake/templates/voidbr-samba/src/samba-4.24.6"
#define HAVE_SYS_UTSNAME_H 1
#define SYSTEM_UNAME_SYSNAME "Linux"
#define SYSTEM_UNAME_MACHINE "x86_64"
#define SYSTEM_UNAME_RELEASE "7.2.2_1"
#define SYSTEM_UNAME_VERSION "#1 SMP PREEMPT_DYNAMIC Sat Aug 29 02:53:10 UTC 2026"
...
#define HAVE_FUSE_FUSE_LOWLEVEL_H 1
...
#define ALLOW_GNUTLS_AEAD_CIPHER_ENCRYPTV2_AES_CCM 1
#define HAVE_GNUTLS_CB_TLS_SERVER_END_POINT 1
#define HAVE_GNUTLS_CIPHER_ENCRYPT3 1
/* #undef HAVE_GNUTLS_FIPS_MODE_SUPPORTED */
#define HAVE_ZLIB 1
#define HAVE_LIBZ 1
/* #undef HAVE_INFLATEINIT2 */
...
#define HAVE_DECL_TLS_CIPHER_AES_GCM_256 1
#define HAVE_DECL_TLS_CIPHER_AES_CCM_128 1
#define HAVE_DECL_TLS_CIPHER_CHACHA20_POLY1305 1
#define HAVE_LIBQUIC 1
#define HAVE_LIBNGTCP2 1
...
#define HAVE_KRB5_GET_INIT_CREDS_OPT_SET_FAST_CCACHE 1
#define HAVE_KRB5_GET_INIT_CREDS_OPT_SET_FAST_FLAGS 1
#define TIME_T_SIGNED 1
#define HAVE_CLIENT_GSS_C_CHANNEL_BOUND_FLAG 1
#define HAVE_KRB5_INIT_CREDS_STEP 1
#define HAVE_GSS_KEY_VALUE_SET_DESC 1
#define HAVE_GPGME 1
...
/* #undef HAVE_WORKING_READLINE_READLINE_WITH_STRICT_PROTO */
/* #undef HAVE_READLINE_READLINE_WORKAROUND */
...
#define HAVE_UNSHARE_CLONE_FS 1
...
#define WITH_WSP 1
#define HAVE_SPOTLIGHT_BACKEND_ES 1
#define WITH_SPOTLIGHT 1
/* #undef HAVE_NSCD_FLUSH_CACHE */
#define STRING_STATIC_MODULES "vfs_default vfs_not_implemented vfs_posixacl auth_builtin auth_sam auth_winbind pdb_smbpasswd pdb_tdbsam auth_unix nss_info_template idmap_tdb idmap_passdb idmap_nss pdb_samba_dsdb auth_samba4 vfs_dfs_samba4 pdb_ldapsam idmap_ldap"
#define STRING_SHARED_MODULES "idmap_ad idmap_rfc2307 idmap_autorid idmap_rid idmap_hash vfs_recycle vfs_audit vfs_extd_audit vfs_full_audit vfs_fake_perms vfs_default_quota vfs_readonly vfs_cap vfs_expand_msdfs vfs_shadow_copy vfs_shadow_copy2 vfs_readahead vfs_xattr_tdb vfs_streams_xattr vfs_streams_depot vfs_acl_xattr vfs_acl_tdb vfs_preopen vfs_catia vfs_media_harmony vfs_unityed_media vfs_fruit vfs_shell_snap vfs_commit vfs_worm vfs_crossrename vfs_linux_xfs_sgid vfs_time_audit vfs_offline vfs_virusfilter vfs_widelinks vfs_aio_ratelimit vfs_snapper idmap_tdb2 idmap_script vfs_posix_eadb vfs_syncops vfs_dirsort vfs_fileid vfs_aio_fork vfs_aio_pthread vfs_gpfs vfs_btrfs vfs_glusterfs_fuse"
#define static_decl_vfs extern NTSTATUS vfs_default_init(TALLOC_CTX *mem_ctx);  extern NTSTATUS vfs_not_implemented_init(TALLOC_CTX *mem_ctx);  extern NTSTATUS vfs_posixacl_init(TALLOC_CTX *mem_ctx);  extern NTSTATUS vfs_dfs_samba4_init(TALLOC_CTX *mem_ctx); 
#define static_init_vfs(mem_ctx) { vfs_default_init((mem_ctx));  vfs_not_implemented_init((mem_ctx));  vfs_posixacl_init((mem_ctx));  vfs_dfs_samba4_init((mem_ctx)); }
...
#define vfs_offline_init samba_init_module
#define vfs_virusfilter_init samba_init_module
#define vfs_widelinks_init samba_init_module
#define vfs_aio_ratelimit_init samba_init_module
...
#define vfs_gpfs_init samba_init_module
#define vfs_btrfs_init samba_init_module
#define vfs_glusterfs_fuse_init samba_init_module
#define static_decl_pdb extern NTSTATUS pdb_smbpasswd_init(TALLOC_CTX *mem_ctx);  extern NTSTATUS pdb_tdbsam_init(TALLOC_CTX *mem_ctx);  extern NTSTATUS pdb_samba_dsdb_init(TALLOC_CTX *mem_ctx);  extern NTSTATUS pdb_ldapsam_init(TALLOC_CTX *mem_ctx); 
#define static_init_pdb(mem_ctx) { pdb_smbpasswd_init((mem_ctx));  pdb_tdbsam_init((mem_ctx));  pdb_samba_dsdb_init((mem_ctx));  pdb_ldapsam_init((mem_ctx)); }
#define static_decl_auth extern NTSTATUS auth_builtin_init(TALLOC_CTX *mem_ctx);  extern NTSTATUS auth_sam_init(TALLOC_CTX *mem_ctx);  extern NTSTATUS auth_winbind_init(TALLOC_CTX *mem_ctx);  extern NTSTATUS auth_unix_init(TALLOC_CTX *mem_ctx);  extern NTSTATUS auth_samba4_init(TALLOC_CTX *mem_ctx); 
#define static_init_auth(mem_ctx) { auth_builtin_init((mem_ctx));  auth_sam_init((mem_ctx));  auth_winbind_init((mem_ctx));  auth_unix_init((mem_ctx));  auth_samba4_init((mem_ctx)); }
#define static_decl_nss_info extern NTSTATUS nss_info_template_init(TALLOC_CTX *mem_ctx); 
#define static_init_nss_info(mem_ctx) { nss_info_template_init((mem_ctx)); }
#define static_decl_charset 
#define static_init_charset(mem_ctx) {}
#define static_decl_idmap extern NTSTATUS idmap_tdb_init(TALLOC_CTX *mem_ctx);  extern NTSTATUS idmap_passdb_init(TALLOC_CTX *mem_ctx);  extern NTSTATUS idmap_nss_init(TALLOC_CTX *mem_ctx);  extern NTSTATUS idmap_ldap_init(TALLOC_CTX *mem_ctx); 
#define static_init_idmap(mem_ctx) { idmap_tdb_init((mem_ctx));  idmap_passdb_init((mem_ctx));  idmap_nss_init((mem_ctx));  idmap_ldap_init((mem_ctx)); }
...
#define static_init_gpext(mem_ctx) {}
...
#define HAVE_DECL_KRB5_PAC_GET_BUFFER 1
